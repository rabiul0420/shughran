...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo 'মুলতুবি  প্রত্যাহার ' . " (" . $manpower->membercode . ")"; ?></h4>
        </div>
        
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form','id'=>'decrease_member');
        echo admin_form_open_multipart("manpower/memberpostponewithdraw/" . $info->id, $attrib); ?>
...
<div class="col-md-12">
        ...
        <div class="modal-footer">
            <?php echo form_submit('memberpostponewithdraw', 'Submit', 'class="btn btn-primary memberdecrease"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
