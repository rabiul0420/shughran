...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo 'ঘাটতি' . " (" . $manpower->membercode . ")".': '. $process->process; ?></h4>
        </div>
        
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form','id'=>'decrease_member' , 'autocomplete'=>'off');
        echo admin_form_open_multipart("manpower/memberdecrease/" . $manpower->id."/".$process->id, $attrib); ?>
