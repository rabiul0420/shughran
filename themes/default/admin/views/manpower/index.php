...
<div class="tg-wrap">
<table class="tg table table-header-rotated excel-table" id="testTable2" data-branch="<?php echo isset($branch_code) ? $branch_code.'_manpower_' : 'central_manpower'?>">
  <tr>
...
$membercandidate_target = sum_manpower($manpower_record,'member_candidate_candidate_target');
 
if($report_info['prev_record'])  echo $membercandidate_target;
	?>
	</td>
    <td class="tg-0pky type_7">
	<?php   
  ...
  <?php  $associate_candidate_prev =  $prev_manpower[0]['associate_candidate'];
	...
	$associate_candidate_postpone = sum_manpower($manpower_record,   'associate_candidate_postpone');
  ...
  echo $associate_candidate_improvement + $associate_candidate_arrival;
    ...
    <td class="tg-0pky type_4">
	<?php 
  echo $associate_candidate_improvement;
	?>
	</td>
    <td class="tg-0pky ">
	<?php 
	
	echo $associate_candidate_arrival;
	?>
	</td>
    <td class="tg-0pky type_6">
	<?php   
	 if($report_info['prev_record']) echo $associate_candidate_improvement_target;
	?>
	</td>
    <td class="tg-0pky type_7">
	<?php   
  ...
  echo $associate_candidate_improvement_d;
    ...
    <td class="tg-0pky "><?php  echo $associate_candidate_endstd; ?></td>
    <td class="tg-0pky ">
	<?php echo $associate_candidate_transfer; ?>
	</td>
    <td class="tg-0pky">
	<?php  echo $associate_candidate_cancel; ?>
	</td>
    <td class="tg-0pky ">
	<?php  echo $associate_candidate_study_abroad; ?>
	</td>
    <td class="tg-0pky ">
	<?php  echo $associate_candidate_job_abroad; 	?>
  ...
  echo $worker_improvement;
    ...
    <td class="tg-0pky  type_7">
	<?php   
	 if($report_info['prev_record']) echo  ($worker_improvement_target>0) ? round(100*$worker_improvement/$worker_improvement_target,2) : 0;;
	?>
  ...
  echo $worker_improvement_d;
    ...
    <td class="tg-0pky  type_10"><?php  echo $worker_endstd; ?></td>
    <td class="tg-0pky  type_11">
	<?php echo $worker_transfer; ?>
	</td>
    <td class="tg-0pky  type_12">
	<?php  echo $worker_cancel; ?>
	</td>
    <td class="tg-0pky  type_13">
