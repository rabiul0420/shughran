...
<script>
    ...
    $(document).ready(function() {
        oTable = $('#PRData').dataTable({
            ...
            {
                column_number: 4,
                filter_default_label: "[<?= 'শপথ'; ?>]",
                filter_type: "text",
                data: []
            },
            {
                column_number: 5,
                filter_default_label: "[<?= 'সেশন'; ?>]",
                filter_type: "text",
                data: []
            },
            {
                column_number: 6,
                filter_default_label: "[<?= 'দায়িত্ব'; ?>]",
                filter_type: "text",
                data: []
            },
            {
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i><?= 'সদস্য ঘাটতি: ' . ($process->id == 15 ? 'স্থানান্তর'  : $process->process)  . ' (' . ($branch_id ? $branch->name : 'সকল শাখা') . ')'; ?>
