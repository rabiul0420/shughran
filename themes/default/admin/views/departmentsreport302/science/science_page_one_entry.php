...
if ($report_info['is_current'] || $report_info['year'] == date('Y')) {
    if ($report_info['type'] == 'annual') {
        echo anchor('admin/departmentsreport/science-page-one' . ($branch_id ? '/' . $branch_id : '') . ('?type=half_yearly&year=' . $report_info['year']), 'ষান্মাসিক ' . $report_info['year']);
        echo  "&nbsp;|&nbsp;" . anchor('admin/departmentsreport/science-page-one' . ($branch_id ? '/' . $branch_id : ''), 'জুলাই-নভেম্বর\'' . $report_info['year']);
        echo "&nbsp;|&nbsp;";
        ...
        echo anchor('admin/departmentsreport/science-page-one' . ($branch_id ? '/' . $branch_id : ''), 'ষান্মাসিক ' . $report_info['year']);
...
<span class="dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="archive">
        ...
        for ($i = date('Y') - 1; $i >= 2019; $i--) {
            ...
            echo   ' <li>' . anchor('admin/departmentsreport/science-page-one' . ($branch_id ? '/' . $branch_id : '') . '?type=half_yearly&year=' . $i, 'ষান্মাসিক ' . $i) . ' </li>';
        }
        ?>
                ...
                <div class="table-responsive">
                    ...
                    <table class="tg table table-header-rotated" id="testTable1">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_only_science_manpower" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="mem_ssc" data-title="Enter">
                                        <?php echo $mem_ssc =  (isset($science_only_science_manpower['mem_ssc'])) ? $science_only_science_manpower['mem_ssc'] : 0; ?>
                                    </a>
                                </td>
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_only_science_manpower" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="mem_hsc" data-title="Enter">
                                        <?php echo $mem_hsc =  (isset($science_only_science_manpower['mem_hsc'])) ? $science_only_science_manpower['mem_hsc'] : 0; ?>
                                    </a>
                                </td>
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_only_science_manpower" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="mem_hons" data-title="Enter">
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_only_science_manpower" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="mem_shakha_shova" data-title="Enter">
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_only_science_manpower" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="mem_shakha_sec" data-title="Enter">
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_only_science_manpower" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="mem_thana_shova" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_only_science_manpower" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="associate_ssc" data-title="Enter">
                                        <?php echo $associate_ssc =  (isset($science_only_science_manpower['associate_ssc'])) ? $science_only_science_manpower['associate_ssc'] : 0; ?>
                                    </a>
                                </td>
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_only_science_manpower" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="associate_hsc" data-title="Enter">
                                        <?php echo $associate_hsc =  (isset($science_only_science_manpower['associate_hsc'])) ? $science_only_science_manpower['associate_hsc'] : 0; ?>
                                    </a>
                                </td>
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_only_science_manpower" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="associate_hons" data-title="Enter">
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_only_science_manpower" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="associate_shakha_shova" data-title="Enter">
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_only_science_manpower" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="associate_shakha_sec" data-title="Enter">
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_only_science_manpower" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="associate_thana_shova" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_only_science_manpower" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="worker_ssc" data-title="Enter">
                                        <?php echo $worker_ssc =  (isset($science_only_science_manpower['worker_ssc'])) ? $science_only_science_manpower['worker_ssc'] : 0; ?>
                                    </a>
                                </td>
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_only_science_manpower" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="worker_hsc" data-title="Enter">
                                        <?php echo $worker_hsc =  (isset($science_only_science_manpower['worker_hsc'])) ? $science_only_science_manpower['worker_hsc'] : 0; ?>
                                    </a>
                                </td>
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_only_science_manpower" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="worker_hons" data-title="Enter">
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_only_science_manpower" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="worker_shakha_shova" data-title="Enter">
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_only_science_manpower" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="worker_shakha_sec" data-title="Enter">
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_only_science_manpower" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="worker_thana_shova" data-title="Enter">
                        ...
                        <table class="tg table table-header-rotated" id="testTable2">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <a href="#"  class="editable editable-click"  id="shaka_shompadok" data-idname=""   data-type="select" 
                                        data-table="science_biggan_shompadok" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate2/'.$branch_id);?>" 
                                        data-name="shaka_shompadok@science_biggan_shompadok" 
                                        data-title="শাখা বিজ্ঞান সম্পাদক আছেন কিনা?">
                                    </a>
                                </td>
                                <td class="tg-pwj7" >বিজ্ঞান সম্পাদক বিজ্ঞানে অধ্যয়নরত কিনা? </td>
                                <td class="tg-0pky">
                                   
                                    <a href="#"  class="editable editable-click"  id="biggan_shompadok" data-idname=""   data-type="select" 
                                        data-table="science_biggan_shompadok" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate2/'.$branch_id);?>" 
                                        data-name="biggan_shompadok@science_biggan_shompadok" 
                                        data-title="বিজ্ঞান সম্পাদক বিজ্ঞানে অধ্যয়নরত কিনা?">
                                    </a>
                      ...
                      <tr>
                          ...
                          <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number"
                              data-table="science_training_program" data-pk="<?php echo $pk ?>"
                      ...
                      <tr>
                        ...
                        <table class="tg table table-header-rotated" id="testTable3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_manpower_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="interested_manpower_num" data-title="Enter">
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_manpower_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="interested_manpower_talika" data-title="Enter">
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_manpower_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="interested_manpower_jogajog" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_manpower_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="lekhalekhi_kore_num" data-title="Enter">
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_manpower_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="lekhalekhi_kore_talika" data-title="Enter">
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_manpower_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="lekhalekhi_kore_jogajog" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_manpower_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="jonopriyo_num" data-title="Enter">
                                        <?php echo $jonopriyo_num =  (isset($science_manpower_protibedon['jonopriyo_num'])) ? $science_manpower_protibedon['jonopriyo_num'] : '' ?>
                                    </a>
                                </td>
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_manpower_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="jonopriyo_talika" data-title="Enter">
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_manpower_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="jonopriyo_jogajog" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_manpower_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="shongothok_num" data-title="Enter">
                                        <?php echo $shongothok_num =  (isset($science_manpower_protibedon['shongothok_num'])) ? $science_manpower_protibedon['shongothok_num'] : '' ?>
                                    </a>
                                </td>
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_manpower_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="shongothok_talika" data-title="Enter">
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_manpower_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="shongothok_jogajog" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_manpower_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="quiz_ayojon_num" data-title="Enter">
                                        <?php echo $quiz_ayojon_num =  (isset($science_manpower_protibedon['quiz_ayojon_num'])) ? $science_manpower_protibedon['quiz_ayojon_num'] : '' ?>
                                    </a>
                                </td>
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_manpower_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="quiz_ayojon_talika" data-title="Enter">
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_manpower_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="quiz_ayojon_jogajog" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_manpower_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="attend_manpower_num" data-title="Enter">
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_manpower_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="attend_manpower_talika" data-title="Enter">
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_manpower_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="attend_manpower_jogajog" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_manpower_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="puroshkar_prapto_manpower_num" data-title="Enter">
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_manpower_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="puroshkar_prapto_manpower_talika" data-title="Enter">
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_manpower_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="puroshkar_prapto_manpower_jogajog" data-title="Enter">
                        ...
                        <table class="tg table table-header-rotated" id="testTable4">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_high_study_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="hs_prostuti_nicche" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_high_study_protibedon" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="hs_gomonkari" data-title="Enter">
                        ...
                        <table class="tg table table-header-rotated" id="testTable5">
                            ...
                            <tr>
                                ...
                                <td class="tg-pwj7" colspan="">
                                <a href="#"  class="editable editable-click"  id="biggan_comittee_gothon" data-idname=""   data-type="select" 
                                        data-table="science_biggan_magazine_circulation" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate2/'.$branch_id);?>" 
                                        data-name="biggan_comittee_gothon@science_biggan_magazine_circulation" 
                                        data-title="কেন্দ্র নির্দেশিত নীতিমালা অনুসারে বিজ্ঞান ম্যাগাজিন সার্কুলেশন সংক্রান্ত কমিটি গঠিত হয়েছে কিনা?">
                                    </a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <a href="#" class="editable editable-click" data-id="" data-idname="" data-type="number" data-table="science_biggan_magazine_circulation" 
                                        data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate'); ?>" data-name="comittee_member" data-title="Enter">
