        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li>
                    ...
                    <a href="#" onclick="doit('xlsx','data-excel');  return false;"><i class="icon fa fa-file-excel-o"></i> <?= lang('export_to_excel') ?> </a>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered" id="data-excel" data-branch="<?php echo isset($branch_code) ? $branch_code . '_dawat_' : 'central_dawat' ?>">
                        <tbody>
                            <tr>
                                ...
                                <td>কওমি ও হাফেজি মাদরাসা দাওয়াতি সপ্তাহ</td>
                            ...
                            <tr>
                                <td colspan="2">সমর্থক
                                    <?php $total_sup = $dawat_personal_n_group[0]['personal_dawat_supporter'] + $dawat_personal_n_group[0]['group_dawat_supporter'] + $dawatgroupsend[0]['supporter_increase'] +  $madrasha_dawat_report[0]['supporter_increase'] + $college_dawat_report[0]['supporter_increase'] + $university_dawat_report[0]['supporter_increase'] + $fortnight_dawat_report[0]['supporter_increase'] + $letgotovillage[0]['supporter_increase'] + $secondary_dawat_report[0]['supporter_increase'] + $madrasha_dawat_report[0]['supporter_increase'];
                                    ?>
                                </td>
                                ...
                                <td colspan="3">
                                    ...
                                    if ($report_info['prev_record'])
                                        echo $lastyeardawat[0]['supporter'] + $total_sup - $dawat_summary[0]['supporter_decrease'];
                                    ?>
                                </td>
                                <td colspan="2">
                                ...
                                <td colspan="2">
                                    <?php echo $dawat_personal_n_group[0]['personal_dawat_supporter']; ?>
                                </td>
                                <td colspan="2">
                                ...
                                <td><?php
                                   ...
                                   // echo $target;
                                    ?>
                                     <a href="#" class="editable editable-click " data-type="number" data-table="dawat_summary" data-pk="<?php echo $detailinfo['dawat_summaryinfo']->id; ?>" data-url="<?php echo admin_url('dawat/detailupdate'); ?>" data-name="supporter_target" data-title="Enter"><?php echo $dawat_summary[0]['supporter_target']; ?></a>
                               
                                
                                </td>
                                <td><?php echo ($target > 0) ? round(100 * $total_sup / $target, 2) : 0;
                                    ?></td>

                                <td><a href="#" class="editable editable-click" data-type="number" data-table="dawat_summary" data-pk="<?php echo $detailinfo['dawat_summaryinfo']->id; ?>" data-url="<?php echo admin_url('dawat/detailupdate'); ?>" data-name="supporter_decrease" data-title="Enter"><?php echo $dawat_summary[0]['supporter_decrease']; ?></a></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <?php
                                    if ($report_info['prev_record'])
                                        echo $lastyeardawat[0]['friend'] + $total_friend - $dawat_summary[0]['friend_decrease'];
                                    ?>
                                </td>
                                <td colspan="2">
                                    <?php
                                ...
                                <td>
                                   ...
                                   // echo $target;
                                    ?>
                                    <a href="#" class="editable editable-click " data-type="number" data-table="dawat_summary" data-pk="<?php echo $detailinfo['dawat_summaryinfo']->id; ?>" data-url="<?php echo admin_url('dawat/detailupdate'); ?>" data-name="friend_target" data-title="Enter"><?php echo $dawat_summary[0]['friend_target']; ?></a>
                                </td>
                                ...
                                <td><a href="#" class="editable editable-click" data-type="number" data-table="dawat_summary" data-pk="<?php echo $detailinfo['dawat_summaryinfo']->id; ?>" data-url="<?php echo admin_url('dawat/detailupdate'); ?>" data-name="friend_decrease" data-title="Enter"><?php echo $dawat_summary[0]['friend_decrease']; ?></a></td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    <?php
                                    if ($report_info['prev_record'])
                                        echo $lastyeardawat[0]['non_muslim_supporter'] + $total_non_sup - $dawat_summary[0]['non_sup_decrease'];
                                    ?>
                                ...
                                <td colspan="2"><a href="#" class="editable editable-click" data-type="number" data-table="dawat_summary" data-pk="<?php echo $detailinfo['dawat_summaryinfo']->id; ?>" data-url="<?php echo admin_url('dawat/detailupdate'); ?>" data-name="personal_dawat_non_sup" data-title="Enter"><?php echo $dawat_summary[0]['personal_dawat_non_sup']; ?></a></td>
                                ...
                                <td colspan="2"><a href="#" class="editable editable-click" data-type="number" data-table="dawat_summary" data-pk="<?php echo $detailinfo['dawat_summaryinfo']->id; ?>" data-url="<?php echo admin_url('dawat/detailupdate'); ?>" data-name="letvillage_non_sup" data-title="Enter"><?php echo $dawat_summary[0]['letvillage_non_sup']; ?></a></td>
                                ...
                                <td><a href="#" class="editable editable-click" data-type="number" data-table="dawat_summary" data-pk="<?php echo $detailinfo['dawat_summaryinfo']->id; ?>" data-url="<?php echo admin_url('dawat/detailupdate'); ?>" data-name="non_supporter_target" data-title="Enter"><?php echo $dawat_summary[0]['non_supporter_target']; ?></a></td>
                                ...
                                <td><a href="#" class="editable editable-click" data-type="number" data-table="dawat_summary" data-pk="<?php echo $detailinfo['dawat_summaryinfo']->id; ?>" data-url="<?php echo admin_url('dawat/detailupdate'); ?>" data-name="non_sup_decrease" data-title="Enter"><?php echo $dawat_summary[0]['non_sup_decrease']; ?></a></td>
                            </tr>
                            <tr>
                                <td colspan="2">অমুসলিম বন্ধু
                                    <?php $total_non_friend = $dawat_summary[0]['personal_dawat_non_friend'] + $dawat_summary[0]['group_dawat_non_friend'] + $dawatgroupsend[0]['nonmuslim_friend_increase']  + $madrasha_dawat_report[0]['nonmuslim_friend_increase'] + $college_dawat_report[0]['nonmuslim_friend_increase'] + $university_dawat_report[0]['nonmuslim_friend_increase'] + $fortnight_dawat_report[0]['nonmuslim_friend_increase'] + $dawat_summary[0]['letvillage_non_friend']+ $secondary_dawat_report[0]['nonmuslim_friend_increase'] + $madrasha_dawat_report[0]['nonmuslim_friend_increase'] ;
                                    ?>
                                </td>
                                ...
                                <td colspan="3">
                                    ...
                                    <?php
                                    if ($report_info['prev_record'])
                                        echo $lastyeardawat[0]['non_muslim_friend'] + $total_non_friend - $dawat_summary[0]['non_friend_decrease'];
                                    ?>
                                </td>
                                <td colspan="2">
                                    <?php
                                ...
                                <td colspan="2"><a href="#" class="editable editable-click" data-type="number" data-table="dawat_summary" data-pk="<?php echo $detailinfo['dawat_summaryinfo']->id; ?>" data-url="<?php echo admin_url('dawat/detailupdate'); ?>" data-name="personal_dawat_non_friend" data-title="Enter"><?php echo $dawat_summary[0]['personal_dawat_non_friend']; ?></a></td>
                                ...
                                <td colspan="2"><a href="#" class="editable editable-click" data-type="number" data-table="dawat_summary" data-pk="<?php echo $detailinfo['dawat_summaryinfo']->id; ?>" data-url="<?php echo admin_url('dawat/detailupdate'); ?>" data-name="letvillage_non_friend" data-title="Enter"><?php echo $dawat_summary[0]['letvillage_non_friend']; ?></a></td>
                                ...
                                <td><a href="#" class="editable editable-click" data-type="number" data-table="dawat_summary" data-pk="<?php echo $detailinfo['dawat_summaryinfo']->id; ?>" data-url="<?php echo admin_url('dawat/detailupdate'); ?>" data-name="non_friend_target" data-title="Enter"><?php echo $dawat_summary[0]['non_friend_target']; ?></a></td>
                                ...
                                <td><a href="#" class="editable editable-click" data-type="number" data-table="dawat_summary" data-pk="<?php echo $detailinfo['dawat_summaryinfo']->id; ?>" data-url="<?php echo admin_url('dawat/detailupdate'); ?>" data-name="non_friend_decrease" data-title="Enter"><?php echo $dawat_summary[0]['non_friend_decrease']; ?></a></td>
                            </tr>
                            <tr>
                                <td colspan="2">শুভাকাঙ্খী
                                    <?php $total_ww = $dawat_summary[0]['personal_dawat_ww'] + $dawat_summary[0]['group_dawat_ww'] + $dawatgroupsend[0]['ww_increase'] + $madrasha_dawat_report[0]['ww_increase'] + $college_dawat_report[0]['ww_increase'] + $university_dawat_report[0]['ww_increase'] + $fortnight_dawat_report[0]['ww_increase'] + $letgotovillage[0]['ww_increase']+$secondary_dawat_report[0]['ww_increase'] + $madrasha_dawat_report[0]['ww_increase'];
                                    ?>
                                </td>
                                <td colspan="3"><?php if ($report_info['prev_record'])  echo $lastyeardawat[0]['wellwisher']; ?></td>
                                <td colspan="3">
                                    <?php if ($report_info['prev_record'])
                                        echo $lastyeardawat[0]['wellwisher'] + $total_ww - $dawat_summary[0]['ww_decrease'];
                                    ?>
                                </td>
                                <td colspan="2">
                                    <?php
                                ...
                                <td colspan="2"><a href="#" class="editable editable-click" data-type="number" data-table="dawat_summary" data-pk="<?php echo $detailinfo['dawat_summaryinfo']->id; ?>" data-url="<?php echo admin_url('dawat/detailupdate'); ?>" data-name="personal_dawat_ww" data-title="Enter"><?php echo $dawat_summary[0]['personal_dawat_ww']; ?></a></td>
                                ...
                                <td><a href="#" class="editable editable-click " data-type="number" data-table="dawat_summary" data-pk="<?php echo $detailinfo['dawat_summaryinfo']->id; ?>" data-url="<?php echo admin_url('dawat/detailupdate'); ?>" data-name="ww_target" data-title="Enter"><?php echo $dawat_summary[0]['ww_target']; ?></a></td>
                                ...
                                <td><a href="#" class="editable editable-click" data-type="number" data-table="dawat_summary" data-pk="<?php echo $detailinfo['dawat_summaryinfo']->id; ?>" data-url="<?php echo admin_url('dawat/detailupdate'); ?>" data-name="ww_decrease" data-title="Enter"><?php echo $dawat_summary[0]['ww_decrease']; ?></a></td>
                            </tr>
                        </tbody>
                    </table>
