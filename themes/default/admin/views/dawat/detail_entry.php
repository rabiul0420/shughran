...
<tr style="height: 18px;">
<td style="height: 18px; " width="44"><a href="#"  class="editable editable-click"   data-type="number" data-table="madrasha_dawat_report" data-pk="<?php echo $detailinfo['madrasha_dawat_reportinfo']->id;?>" data-url="<?php echo admin_url('dawat/detailupdate');?>" data-name="supporter_increase" data-title="Enter"><?php echo $detailinfo['madrasha_dawat_reportinfo']->supporter_increase;?></a></td>
<td style=" height: 18px; " width="46"><a href="#"  class="editable editable-click"   data-type="number" data-table="madrasha_dawat_report" data-pk="<?php echo $detailinfo['madrasha_dawat_reportinfo']->id;?>" data-url="<?php echo admin_url('dawat/detailupdate');?>" data-name="friend_increase" data-title="Enter"><?php echo $detailinfo['madrasha_dawat_reportinfo']->friend_increase;?></a></td>
<td style=" height: 18px; " width="53"><a href="#"  class="editable editable-click"   data-type="number" data-table="madrasha_dawat_report" data-pk="<?php echo $detailinfo['madrasha_dawat_reportinfo']->id;?>" data-url="<?php echo admin_url('dawat/detailupdate');?>" data-name="number_general_gather" data-title="Enter"><?php echo $detailinfo['madrasha_dawat_reportinfo']->number_general_gather;?></a></td>
<td style=" height: 18px; " width="48"><a href="#"  class="editable editable-click"   data-type="number" data-table="madrasha_dawat_report" data-pk="<?php echo $detailinfo['madrasha_dawat_reportinfo']->id;?>" data-url="<?php echo admin_url('dawat/detailupdate');?>" data-name="avg_presence" data-title="Enter"><?php echo $detailinfo['madrasha_dawat_reportinfo']->avg_presence;?></a></td>
<td style=" height: 18px; " width="38"><a href="#"  class="editable editable-click"   data-type="number" data-table="madrasha_dawat_report" data-pk="<?php echo $detailinfo['madrasha_dawat_reportinfo']->id;?>" data-url="<?php echo admin_url('dawat/detailupdate');?>" data-name="number_other_meeting" data-title="Enter"><?php echo $detailinfo['madrasha_dawat_reportinfo']->number_other_meeting;?></a></td>
<td style=" height: 18px; " width="47"><a href="#"  class="editable editable-click"   data-type="number" data-table="madrasha_dawat_report" data-pk="<?php echo $detailinfo['madrasha_dawat_reportinfo']->id;?>" data-url="<?php echo admin_url('dawat/detailupdate');?>" data-name="other_avg" data-title="Enter"><?php echo $detailinfo['madrasha_dawat_reportinfo']->other_avg;?></a></td>
<td style=" height: 18px; " width="50"><a href="#"  class="editable editable-click"   data-type="number" data-table="madrasha_dawat_report" data-pk="<?php echo $detailinfo['madrasha_dawat_reportinfo']->id;?>" data-url="<?php echo admin_url('dawat/detailupdate');?>" data-name="card_booklet" data-title="Enter"><?php echo $detailinfo['madrasha_dawat_reportinfo']->card_booklet;?></a></td>
<td style=" height: 18px; " width="48"><a href="#"  class="editable editable-click"   data-type="number" data-table="madrasha_dawat_report" data-pk="<?php echo $detailinfo['madrasha_dawat_reportinfo']->id;?>" data-url="<?php echo admin_url('dawat/detailupdate');?>" data-name="porichiti" data-title="Enter"><?php echo $detailinfo['madrasha_dawat_reportinfo']->porichiti;?></a></td>
<td style=" height: 18px; " width="46"><a href="#"  class="editable editable-click"   data-type="number" data-table="madrasha_dawat_report" data-pk="<?php echo $detailinfo['madrasha_dawat_reportinfo']->id;?>" data-url="<?php echo admin_url('dawat/detailupdate');?>" data-name="kishore" data-title="Enter"><?php echo $detailinfo['madrasha_dawat_reportinfo']->kishore;?></a></td>
<td style="height: 18px; " width="54"><a href="#"  class="editable editable-click"   data-type="number" data-table="madrasha_dawat_report" data-pk="<?php echo $detailinfo['madrasha_dawat_reportinfo']->id;?>" data-url="<?php echo admin_url('dawat/detailupdate');?>" data-name="kishore_client_increase" data-title="Enter"><?php echo $detailinfo['madrasha_dawat_reportinfo']->kishore_client_increase;?></a></td>
<td style=" height: 18px; " width="51"><a href="#"  class="editable editable-click"   data-type="number" data-table="madrasha_dawat_report" data-pk="<?php echo $detailinfo['madrasha_dawat_reportinfo']->id;?>" data-url="<?php echo admin_url('dawat/detailupdate');?>" data-name="kishore_eng" data-title="Enter"><?php echo $detailinfo['madrasha_dawat_reportinfo']->kishore_eng;?></a></td>
<td style=" height: 18px; " width="52"><a href="#"  class="editable editable-click"   data-type="number" data-table="madrasha_dawat_report" data-pk="<?php echo $detailinfo['madrasha_dawat_reportinfo']->id;?>" data-url="<?php echo admin_url('dawat/detailupdate');?>" data-name="kishore_eng_increase" data-title="Enter"><?php echo $detailinfo['madrasha_dawat_reportinfo']->kishore_eng_increase;?></a></td>
<td style=" height: 18px; " width="40"><a href="#"  class="editable editable-click"   data-type="number" data-table="madrasha_dawat_report" data-pk="<?php echo $detailinfo['madrasha_dawat_reportinfo']->id;?>" data-url="<?php echo admin_url('dawat/detailupdate');?>" data-name="chhatrasongbad" data-title="Enter"><?php echo $detailinfo['madrasha_dawat_reportinfo']->chhatrasongbad;?></a></td>
<td style=" height: 18px; " width="45"><a href="#"  class="editable editable-click"   data-type="number" data-table="madrasha_dawat_report" data-pk="<?php echo $detailinfo['madrasha_dawat_reportinfo']->id;?>" data-url="<?php echo admin_url('dawat/detailupdate');?>" data-name="chhatrasongbad_increase" data-title="Enter"><?php echo $detailinfo['madrasha_dawat_reportinfo']->chhatrasongbad_increase;?></a></td>
<td style=" height: 18px; " width="52"><a href="#"  class="editable editable-click"   data-type="number" data-table="madrasha_dawat_report" data-pk="<?php echo $detailinfo['madrasha_dawat_reportinfo']->id;?>" data-url="<?php echo admin_url('dawat/detailupdate');?>" data-name="group_sent" data-title="Enter"><?php echo $detailinfo['madrasha_dawat_reportinfo']->group_sent;?></a></td>
<td style=" height: 18px; " width="47"><a href="#"  class="editable editable-click"   data-type="number" data-table="madrasha_dawat_report" data-pk="<?php echo $detailinfo['madrasha_dawat_reportinfo']->id;?>" data-url="<?php echo admin_url('dawat/detailupdate');?>" data-name="supporter_org_increase" data-title="Enter"><?php echo $detailinfo['madrasha_dawat_reportinfo']->supporter_org_increase;?></a></td>
<td style=" height: 18px; " width="36"><a href="#"  class="editable editable-click"   data-type="number" data-table="madrasha_dawat_report" data-pk="<?php echo $detailinfo['madrasha_dawat_reportinfo']->id;?>" data-url="<?php echo admin_url('dawat/detailupdate');?>" data-name="nonmuslim_supporter_increase" data-title="Enter"><?php echo $detailinfo['madrasha_dawat_reportinfo']->nonmuslim_supporter_increase;?></a></td>
<td style=" height: 18px; " width="42"><a href="#"  class="editable editable-click"   data-type="number" data-table="madrasha_dawat_report" data-pk="<?php echo $detailinfo['madrasha_dawat_reportinfo']->id;?>" data-url="<?php echo admin_url('dawat/detailupdate');?>" data-name="nonmuslim_friend_increase" data-title="Enter"><?php echo $detailinfo['madrasha_dawat_reportinfo']->nonmuslim_friend_increase;?></a></td>
<td style=" height: 18px; " width="44"><a href="#"  class="editable editable-click"   data-type="number" data-table="madrasha_dawat_report" data-pk="<?php echo $detailinfo['madrasha_dawat_reportinfo']->id;?>" data-url="<?php echo admin_url('dawat/detailupdate');?>" data-name="ww_increase" data-title="Enter"><?php echo $detailinfo['madrasha_dawat_reportinfo']->ww_increase;?></a></td>
</tr>
