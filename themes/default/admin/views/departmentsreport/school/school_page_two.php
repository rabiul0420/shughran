				...
				<style type="text/css">
                    ...
                    <table class="tg table table-header-rotated" id="testTable1">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $golpo_asor_num = $school_dowati_asor['golpo_asor_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $golpo_asor_pre = $school_dowati_asor['golpo_asor_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $kobita_asor_num = $school_dowati_asor['kobita_asor_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $kobita_asor_pre = $school_dowati_asor['kobita_asor_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $nobir_bani_num = $school_dowati_asor['nobir_bani_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $nobir_bani_pre = $school_dowati_asor['nobir_bani_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $sahosi_manus_num = $school_dowati_asor['sahosi_manus_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $sahosi_manus_pre = $school_dowati_asor['sahosi_manus_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $sahabi_num = $school_dowati_asor['sahabi_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $sahabi_pre = $school_dowati_asor['sahabi_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $muslim_giboni_num = $school_dowati_asor['muslim_giboni_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $muslim_giboni_pre = $school_dowati_asor['muslim_giboni_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                    ...
                    <table class="tg table table-header-rotated" id="testTable2">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $hand_writing_com_num = $school_creative_search['hand_writing_com_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $hand_writing_com_pre = $school_creative_search['hand_writing_com_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $debate_com_num = $school_creative_search['debate_com_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $debate_com_pre = $school_creative_search['debate_com_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $memory_test_num = $school_creative_search['memory_test_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $memory_test_pre = $school_creative_search['memory_test_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $word_com_num = $school_creative_search['word_com_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $word_com_pre = $school_creative_search['word_com_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $drawing_com_num = $school_creative_search['drawing_com_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $drawing_com_pre = $school_creative_search['drawing_com_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $composition_com_num = $school_creative_search['composition_com_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $composition_com_pre = $school_creative_search['composition_com_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $story_com_num = $school_creative_search['story_com_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $story_com_pre = $school_creative_search['story_com_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $quiz_com_num = $school_creative_search['quiz_com_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $quiz_com_pre = $school_creative_search['quiz_com_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $writing_com_num = $school_creative_search['writing_com_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $writing_com_pre = $school_creative_search['writing_com_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $law_com_num = $school_creative_search['law_com_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $law_com_pre = $school_creative_search['law_com_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                    ...
                    <table class="tg table table-header-rotated" id="testTable3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $jsc_num = $school_reception['jsc_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $jsc_pre = $school_reception['jsc_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $ssc_num = $school_reception['ssc_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $ssc_pre = $school_reception['ssc_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $single_digit_pre = $school_reception['single_digit_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $school_cabinet_num = $school_reception['school_cabinet_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $school_cabinet_pre = $school_reception['school_cabinet_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $scolorship_num = $school_reception['scolorship_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $scolorship_pre = $school_reception['scolorship_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $place_num = $school_reception['place_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $place_pre = $school_reception['place_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $fresher_num = $school_reception['fresher_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $fresher_pre = $school_reception['fresher_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $class_captain_num = $school_reception['class_captain_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $class_captain_pre = $school_reception['class_captain_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                    ...
                    <table class="tg table table-header-rotated" id="testTable4">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $boi_path_num = $school_compition_dawati_program['boi_path_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $boi_path_pre = $school_compition_dawati_program['boi_path_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $kishor_path_num = $school_compition_dawati_program['kishor_path_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $kishor_path_pre = $school_compition_dawati_program['kishor_path_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $sirat_path_num = $school_compition_dawati_program['sirat_path_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $sirat_path_pre = $school_compition_dawati_program['sirat_path_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $literature_path_num = $school_compition_dawati_program['literature_path_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $literature_path_pre = $school_compition_dawati_program['literature_path_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $kobita_path_pre = $school_compition_dawati_program['kobita_path_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $quiz_num = $school_compition_dawati_program['quiz_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $quiz_pre = $school_compition_dawati_program['quiz_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $quiz_online_num = $school_compition_dawati_program['quiz_online_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $quiz_online_pre = $school_compition_dawati_program['quiz_online_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $speak_num = $school_compition_dawati_program['speak_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $speak_pre = $school_compition_dawati_program['speak_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $acting_num = $school_compition_dawati_program['acting_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $acting_pre = $school_compition_dawati_program['acting_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $debate_num = $school_compition_dawati_program['debate_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $debate_pre = $school_compition_dawati_program['debate_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $hasi_num = $school_compition_dawati_program['hasi_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $hasi_pre = $school_compition_dawati_program['hasi_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                    ...
                    <table class="tg table table-header-rotated" id="testTable5">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $math_olympiad_num = $school_olympiad_camp['math_olympiad_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $math_olympiad_pre = $school_olympiad_camp['math_olympiad_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $science_olympiad_num = $school_olympiad_camp['science_olympiad_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $science_olympiad_pre = $school_olympiad_camp['science_olympiad_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $english_olympaid_num = $school_olympiad_camp['english_olympaid_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $english_olympaid_pre = $school_olympiad_camp['english_olympaid_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $somor_camp_num = $school_olympiad_camp['somor_camp_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $somor_camp_pre = $school_olympiad_camp['somor_camp_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $winter_camp_num = $school_olympiad_camp['winter_camp_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $winter_camp_pre = $school_olympiad_camp['winter_camp_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $boi_mela_num = $school_olympiad_camp['boi_mela_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $boi_mela_pre = $school_olympiad_camp['boi_mela_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $science_mela_num = $school_olympiad_camp['science_mela_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $science_mela_pre = $school_olympiad_camp['science_mela_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $drawing_show_num = $school_olympiad_camp['drawing_show_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $drawing_show_pre = $school_olympiad_camp['drawing_show_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $acting_show_num = $school_olympiad_camp['acting_show_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $acting_show_pre = $school_olympiad_camp['acting_show_pre'] ?>
                                </td>
                                <td class="tg-0pky">
