                ...
                <div class="table-responsive">
                    ...
                    <table class="tg table table-header-rotated" id="testTable1">
                            <tr>
                                ...
                                <td class="tg-pwj7">
                                    <a href="#" id='table_1' onclick="doit('xlsx','testTable1','<?php echo 'Madrasha_জেডিসি ফল পরিসংখ্যান একাডেমিক আউটপুট_'.$branch_id.'.xlsx' ?>');  return false;"><i class="icon fa fa-file-excel-o"></i> <?= lang('export_to_excel') ?> 	</a>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <?php
                            $pk = (isset($madrasah_jdc_result['id']))?$madrasah_jdc_result['id']:'';
                            ?>
                            <tr>
                                ...
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="a_total" data-title="Enter"><?php echo $a_total=  (isset( $madrasah_jdc_result['a_total']))? $madrasah_jdc_result['a_total']:0;?></a>
                                </td>
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="a_a_plus" data-title="Enter"><?php echo $a_a_plus=  (isset( $madrasah_jdc_result['a_a_plus']))? $madrasah_jdc_result['a_a_plus']:0;?></a>
                                </td>
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="a_a" data-title="Enter"><?php echo $a_a=  (isset( $madrasah_jdc_result['a_a']))? $madrasah_jdc_result['a_a']:0;?></a>
                                </td>
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="a_a_minus" data-title="Enter"><?php echo $a_a_minus=  (isset( $madrasah_jdc_result['a_a_minus']))? $madrasah_jdc_result['a_a_minus']:0;?></a>
                                </td>
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="a_b" data-title="Enter"><?php echo $a_b=  (isset( $madrasah_jdc_result['a_b']))? $madrasah_jdc_result['a_b']:0;?></a>
                                </td>
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="a_c" data-title="Enter"><?php echo $a_c=  (isset( $madrasah_jdc_result['a_c']))? $madrasah_jdc_result['a_c']:0;?></a>
                                </td>
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="a_d" data-title="Enter"><?php echo $a_d=  (isset( $madrasah_jdc_result['a_d']))? $madrasah_jdc_result['a_d']:0;?></a>
                                </td>
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="a_fail" data-title="Enter"><?php echo $a_fail=  (isset( $madrasah_jdc_result['a_fail']))? $madrasah_jdc_result['a_fail']:0;?></a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="w_total" data-title="Enter"><?php echo $w_total=  (isset( $madrasah_jdc_result['w_total']))? $madrasah_jdc_result['w_total']:0;?></a>
                                </td>
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="w_a_plus" data-title="Enter"><?php echo $w_a_plus=  (isset( $madrasah_jdc_result['w_a_plus']))? $madrasah_jdc_result['w_a_plus']:0;?></a>
                                </td>
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="w_a" data-title="Enter"><?php echo $w_a=  (isset( $madrasah_jdc_result['w_a']))? $madrasah_jdc_result['w_a']:0;?></a>
                                </td>
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="w_a_minus" data-title="Enter"><?php echo $w_a_minus=  (isset( $madrasah_jdc_result['w_a_minus']))? $madrasah_jdc_result['w_a_minus']:0;?></a>
                                </td>
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="w_b" data-title="Enter"><?php echo $w_b=  (isset( $madrasah_jdc_result['w_b']))? $madrasah_jdc_result['w_b']:0;?></a>
                                </td>
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="w_c" data-title="Enter"><?php echo $w_c=  (isset( $madrasah_jdc_result['w_c']))? $madrasah_jdc_result['w_c']:0;?></a>
                                </td>
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="w_d" data-title="Enter"><?php echo $w_d=  (isset( $madrasah_jdc_result['w_d']))? $madrasah_jdc_result['w_d']:0;?></a>
                                </td>
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="w_fail" data-title="Enter"><?php echo $w_fail=  (isset( $madrasah_jdc_result['w_fail']))? $madrasah_jdc_result['w_fail']:0;?></a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="s_total" data-title="Enter"><?php echo $s_total=  (isset( $madrasah_jdc_result['s_total']))? $madrasah_jdc_result['s_total']:0;?></a>
                                </td>
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="s_a_plus" data-title="Enter"><?php echo $s_a_plus=  (isset( $madrasah_jdc_result['s_a_plus']))? $madrasah_jdc_result['s_a_plus']:0;?></a>
                                </td>
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="s_a" data-title="Enter"><?php echo $s_a=  (isset( $madrasah_jdc_result['s_a']))? $madrasah_jdc_result['s_a']:0;?></a>
                                </td>
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="s_a_minus" data-title="Enter"><?php echo $s_a_minus=  (isset( $madrasah_jdc_result['s_a_minus']))? $madrasah_jdc_result['s_a_minus']:0;?></a>
                                </td>
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="s_b" data-title="Enter"><?php echo $s_b=  (isset( $madrasah_jdc_result['s_b']))? $madrasah_jdc_result['s_b']:0;?></a>
                                </td>
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="s_c" data-title="Enter"><?php echo $s_c=  (isset( $madrasah_jdc_result['s_c']))? $madrasah_jdc_result['s_c']:0;?></a>
                                </td>
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="s_d" data-title="Enter"><?php echo $s_d=  (isset( $madrasah_jdc_result['s_d']))? $madrasah_jdc_result['s_d']:0;?></a>
                                </td>
                                <td class="tg-0pky  type_2">
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" data-table="madrasah_jdc_result" data-pk="<?php echo $pk ?>" data-url="<?php echo admin_url('departmentsreport/detailupdate');?>" data-name="s_fail" data-title="Enter"><?php echo $s_fail=  (isset( $madrasah_jdc_result['s_fail']))? $madrasah_jdc_result['s_fail']:0;?></a>
                                </td>
                            </tr>
