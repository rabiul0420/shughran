                    ...
                    <div class="tg-wrap">
                        ...
                        <table class="tg table table-header-rotated" id="testTable1">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky" >
                                <?php echo $a_total=$madrasah_jdc_result['a_total'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $a_a_plus=$madrasah_jdc_result['a_a_plus'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $a_a=$madrasah_jdc_result['a_a'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $a_a_minus=$madrasah_jdc_result['a_a_minus'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $a_b=$madrasah_jdc_result['a_b'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $a_c=$madrasah_jdc_result['a_c'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $a_d=$madrasah_jdc_result['a_d'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $a_fail=$madrasah_jdc_result['a_fail'] ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky" >
                                <?php echo $w_total=$madrasah_jdc_result['w_total'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $w_a_plus=$madrasah_jdc_result['w_a_plus'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $w_a=$madrasah_jdc_result['w_a'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $w_a_minus=$madrasah_jdc_result['w_a_minus'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $w_b=$madrasah_jdc_result['w_b'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $w_c=$madrasah_jdc_result['w_c'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $w_d=$madrasah_jdc_result['w_d'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $w_fail=$madrasah_jdc_result['w_fail'] ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky" >
                                <?php echo $s_total=$madrasah_jdc_result['s_total'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $s_a_plus=$madrasah_jdc_result['s_a_plus'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $s_a=$madrasah_jdc_result['s_a'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $s_a_minus=$madrasah_jdc_result['s_a_minus'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $s_b=$madrasah_jdc_result['s_b'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $s_c=$madrasah_jdc_result['s_c'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $s_d=$madrasah_jdc_result['s_d'] ?>
                                </td>
                                <td class="tg-0pky" >
                                <?php echo $s_fail=$madrasah_jdc_result['s_fail'] ?>
                                </td>
                            </tr>
