...
if ($report_info['is_current'] || $report_info['year'] == date('Y')) {
    if ($report_info['type'] == 'annual') {
        echo anchor('admin/departmentsreport/others-page-four' . ($branch_id ? '/' . $branch_id : '') . ('?type=half_yearly&year=' . $report_info['year']), 'ষান্মাসিক ' . $report_info['year']);
        echo  "&nbsp;|&nbsp;" . anchor('admin/departmentsreport/others-page-four' . ($branch_id ? '/' . $branch_id : ''), 'জুলাই-নভেম্বর\'' . $report_info['year']);
        echo "&nbsp;|&nbsp;";
        ...
        echo anchor('admin/departmentsreport/others-page-four' . ($branch_id ? '/' . $branch_id : ''), 'ষান্মাসিক ' . $report_info['year']);
...
<span class="dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="archive">
        ...
        for ($i = date('Y') - 1; $i >= 2019; $i--) {
            ...
            echo   ' <li>' . anchor('admin/departmentsreport/others-page-four' . ($branch_id ? '/' . $branch_id : '') . '?type=half_yearly&year=' . $i, 'ষান্মাসিক ' . $i) . ' </li>';
        }
        ?>
                ...
                <table class="tg table table-header-rotated" id="testTable1">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky type_1">
                                    <?php echo $online_dawati_d_hoyeche = $total_other_shopta_doshok_pokkho_palon['online_dawati_d_hoyeche'] ?>
                                </td>
                                <td class="tg-0pky type_1">
                                    <?php echo ($total_row_other_shopta_doshok_pokkho_palon - $total_other_shopta_doshok_pokkho_palon['online_dawati_d_hoyeche']) ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-pwj7" colspan="">কওমি ও হাফেজি মাদরাসা দাওয়াতি সপ্তাহ</td>
                                 <td class="tg-0pky type_1">
                                    <?php echo $kawmi_hafeji_dawat_w_hoyeche = $total_other_shopta_doshok_pokkho_palon['kawmi_hafeji_dawat_w_hoyeche'] ?>
                                </td>
                                <td class="tg-0pky type_1">
                                    <?php echo ($total_row_other_shopta_doshok_pokkho_palon - $total_other_shopta_doshok_pokkho_palon['kawmi_hafeji_dawat_w_hoyeche']) ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-pwj7" colspan="">স্কুল দাওয়াতি পক্ষ</td>
                                 <td class="tg-0pky type_1">
                                    <?php echo $school_dawat_p_hoyeche = $total_other_shopta_doshok_pokkho_palon['school_dawat_p_hoyeche'] ?>
                                </td>
                                <td class="tg-0pky type_1">
                                    <?php echo ($total_row_other_shopta_doshok_pokkho_palon - $total_other_shopta_doshok_pokkho_palon['school_dawat_p_hoyeche']) ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-pwj7" colspan="">বিশ্ববিদ্যালয় ও অনার্স কলেজ  দাওয়াতি দশক</td>
                                 <td class="tg-0pky type_1">
                                    <?php echo $uni_col_dawat_d_hoyeche = $total_other_shopta_doshok_pokkho_palon['uni_col_dawat_d_hoyeche'] ?>
                                </td>
                                <td class="tg-0pky type_1">
                                    <?php echo ($total_row_other_shopta_doshok_pokkho_palon - $total_other_shopta_doshok_pokkho_palon['uni_col_dawat_d_hoyeche']) ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-pwj7" colspan="">মাদরাসা দাওয়াতি  দশক</td>
                                 <td class="tg-0pky type_1">
                                    <?php echo $madrasah_dawat_d_hoyeche = $total_other_shopta_doshok_pokkho_palon['madrasah_dawat_d_hoyeche'] ?>
                                </td>
                                <td class="tg-0pky type_1">
                                    <?php echo ($total_row_other_shopta_doshok_pokkho_palon - $total_other_shopta_doshok_pokkho_palon['madrasah_dawat_d_hoyeche']) ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-pwj7" colspan="">উচ্চমাধ্যমিক ও ডিপ্লোমা দাওয়াতি দশক</td>
                                 <td class="tg-0pky type_1">
                                    <?php echo $diploma_dawat_d_hoyeche = $total_other_shopta_doshok_pokkho_palon['diploma_dawat_d_hoyeche'] ?>
                                </td>
                                <td class="tg-0pky type_1">
                                    <?php echo ($total_row_other_shopta_doshok_pokkho_palon - $total_other_shopta_doshok_pokkho_palon['diploma_dawat_d_hoyeche']) ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-pwj7" colspan="">সাংস্কৃতিক দাওয়াতি সপ্তাহ</td>
                                 <td class="tg-0pky type_1">
                                    <?php echo $culture_dawat_w_hoyeche = $total_other_shopta_doshok_pokkho_palon['culture_dawat_w_hoyeche'] ?>
                                </td>
                                <td class="tg-0pky type_1">
                                    <?php echo ($total_row_other_shopta_doshok_pokkho_palon - $total_other_shopta_doshok_pokkho_palon['culture_dawat_w_hoyeche']) ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-pwj7" colspan="">সাধারণ দাওয়াতি পক্ষ</td>
                                 <td class="tg-0pky type_1">
                                    <?php echo $shadharon_dawat_p_hoyeche = $total_other_shopta_doshok_pokkho_palon['shadharon_dawat_p_hoyeche'] ?>
                                </td>
                                <td class="tg-0pky type_1">
                                    <?php echo ($total_row_other_shopta_doshok_pokkho_palon - $total_other_shopta_doshok_pokkho_palon['shadharon_dawat_p_hoyeche']) ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-pwj7" colspan="">অন্যান্য ধর্মাবলম্বী দাওয়াতি সপ্তাহ</td>
                                 <td class="tg-0pky type_1">
                                    <?php echo $onno_dhormo_dawat_w_hoyeche = $total_other_shopta_doshok_pokkho_palon['onno_dhormo_dawat_w_hoyeche'] ?>
                                </td>
                                <td class="tg-0pky type_1">
                                    <?php echo ($total_row_other_shopta_doshok_pokkho_palon - $total_other_shopta_doshok_pokkho_palon['onno_dhormo_dawat_w_hoyeche']) ?>
                                </td>
                        ...
                        <table class="tg table table-header-rotated" id="testTable2">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky type_1">
                                    <?php echo $academic_output_hoyeche = $total_other_output_plan['academic_output_hoyeche'] ?>
                                </td>
                                <td class="tg-0pky type_1">
                                    <?php echo ($total_row_other_output_plan - $total_other_output_plan['academic_output_hoyeche']) ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky type_1">
                                    <?php echo $pro_output_hoyeche = $total_other_output_plan['pro_output_hoyeche'] ?>
                                </td>
                                <td class="tg-0pky type_1">
                                    <?php echo ($total_row_other_output_plan - $total_other_output_plan['pro_output_hoyeche']) ?>
                                </td>
                        ...
                        <table class="tg table table-header-rotated" id="testTable3">
                            ...
                            <?php 
                                $i=0;
                            foreach($total_other_chatro_sonshod->result_array() as $row) 
                                    {
                                    $i++;
                                ?>
