				...
				<style type="text/css">
                    ...
                    <div class="tg-wrap">
                        ...
                        <table class="tg table table-header-rotated" id="testTable2">
                            ...
                            <tr>
                                <td class="tg-0pky" colspan=""> <?php echo $total_science_biggan_shompadok['shaka_shompadok']; ?>  </td>
                                <td class="tg-0pky" colspan=""> <?php echo $row_total_science_biggan_shompadok -$total_science_biggan_shompadok['shaka_shompadok']; ?> </td>
                                <td class="tg-0pky" colspan=""> <?php echo $total_science_biggan_shompadok['biggan_shompadok']; ?> </td>
                                <td class="tg-0pky" colspan=""> <?php echo $row_total_science_biggan_shompadok-$total_science_biggan_shompadok['biggan_shompadok'] ; ?> </td>
                            </tr>
                        </table>
                        ...
                        <tr>
                            ...
                            <td class="tg-0pky type_1">
                            <?php echo $shikkha_central_s=$total_science_training_program['shikkha_central_s'] ?>
                            </td>
                            <td class="tg-0pky  type_2">
                            <?php echo $shikkha_central_p=$total_science_training_program['shikkha_central_p'] ?>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="tg-0pky type_1">
                            <?php echo $shikkha_shakha_s=$total_science_training_program['shikkha_shakha_s'] ?>
                            </td>
                            <td class="tg-0pky  type_2">
                            <?php echo $shikkha_shakha_p=$total_science_training_program['shikkha_shakha_p'] ?>
                            </td>
                            <td class="tg-0pky  type_3">
                        ...
                        <tr>
                            ...
                            <td class="tg-0pky type_1">
                            <?php echo $kormoshala_central_s=$total_science_training_program['kormoshala_central_s'] ?>
                            </td>
                            <td class="tg-0pky  type_2">
                            <?php echo $kormoshala_central_p=$total_science_training_program['kormoshala_central_p'] ?>
                            </td>
                            <td class="tg-0pky  type_3">
                        ...
                        <tr>
                            ...
                            <td class="tg-0pky type_1">
                            <?php echo $kormoshala_shakha_s=$total_science_training_program['kormoshala_shakha_s'] ?>
                            </td>
                            <td class="tg-0pky  type_2">
                            <?php echo $kormoshala_shakha_p=$total_science_training_program['kormoshala_shakha_p'] ?>
                            </td>
                            <td class="tg-0pky  type_3">
                        ...
                        <table class="tg table table-header-rotated" id="testTable3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $total_science_manpower_protibedon['interested_manpower_num'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $total_science_manpower_protibedon['interested_manpower_talika'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $total_science_manpower_protibedon['interested_manpower_jogajog'] ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $total_science_manpower_protibedon['lekhalekhi_kore_num'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $total_science_manpower_protibedon['lekhalekhi_kore_talika'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $total_science_manpower_protibedon['lekhalekhi_kore_jogajog'] ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $total_science_manpower_protibedon['jonopriyo_num'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $total_science_manpower_protibedon['jonopriyo_talika'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $total_science_manpower_protibedon['jonopriyo_jogajog'] ?>
                                </td>
                            </tr>
                            <tr>
                                <td class="tg-y698 type_1" colspan='2'>বিজ্ঞান সংগঠন হিসেবে কাজ করছেন এমন জনশক্তি </td>
                                <td class="tg-0pky  type_1">
                                    <?php echo $total_science_manpower_protibedon['shongothok_num'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $total_science_manpower_protibedon['shongothok_talika'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $total_science_manpower_protibedon['shongothok_jogajog'] ?>
                                </td>
                            </tr>
                            <tr>
                                <td class="tg-y698 type_1" colspan='2'>নিজ উদ্যোগে অলিম্পিয়াড,বিজ্ঞান কুইজ,প্রতিযোগিতা আয়োজন করেছেন এমন জনশক্তি </td>
                                <td class="tg-0pky  type_1">
                                    <?php echo $total_science_manpower_protibedon['quiz_ayojon_num'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $total_science_manpower_protibedon['quiz_ayojon_talika'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $total_science_manpower_protibedon['quiz_ayojon_jogajog'] ?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $total_science_manpower_protibedon['attend_manpower_num'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $total_science_manpower_protibedon['attend_manpower_talika'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $total_science_manpower_protibedon['attend_manpower_jogajog'] ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $total_science_manpower_protibedon['puroshkar_prapto_manpower_num'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $total_science_manpower_protibedon['puroshkar_prapto_manpower_talika'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $total_science_manpower_protibedon['puroshkar_prapto_manpower_jogajog'] ?>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="tg table table-header-rotated" id="testTable4">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky" colspan=""><?php echo $total_science_high_study_protibedon['hs_prostuti_nicche'] ?></td>
                            </tr>
                            <tr>
                                <td class="tg-pwj7" colspan=''>এ বছর বিজ্ঞানে উচ্চশিক্ষায় বিদেশে গমণকারী জনশক্তি</td>
                                <td class="tg-0pky" colspan=""><?php echo $total_science_high_study_protibedon['hs_gomonkari'] ?></td>
                            </tr>
                        </table>
                        ...
                        <table class="tg table table-header-rotated" id="testTable5">
                            ...
                            <tr>
                                ...
                                <td class="tg-pwj7" colspan="">হ্যাঁ</td>
                                 <td class="tg-0pky" colspan=""><?php echo $total_science_biggan_magazine_circulation['biggan_comittee_gothon'] ?></td>
                            </tr>
                            <tr>
                                <td class="tg-pwj7" colspan=''>না</td>
                                 <td class="tg-0pky" colspan=""><?php echo $row_total_science_biggan_magazine_circulation - $total_science_biggan_magazine_circulation['biggan_comittee_gothon'] ?></td>
                            </tr>
                            <tr>
                                <td class="tg-pwj7" colspan='2'>কমিটির সদস্য সংখ্যা</td>
                                <td class="tg-0pky" colspan=""><?php echo $total_science_biggan_magazine_circulation['comittee_member'] ?></td>
                            </tr>
                        </table>
