...
if ($report_info['is_current'] || $report_info['year'] == date('Y')) {
    if ($report_info['type'] == 'annual') {
        echo anchor('admin/departmentsreport/school-page-one' . ($branch_id ? '/' . $branch_id : '') . ('?type=half_yearly&year=' . $report_info['year']), 'ষান্মাসিক ' . $report_info['year']);
        echo  "&nbsp;|&nbsp;" . anchor('admin/departmentsreport/school-page-one' . ($branch_id ? '/' . $branch_id : ''), 'জুলাই-নভেম্বর\'' . $report_info['year']);
        echo "&nbsp;|&nbsp;";
        ...
        echo anchor('admin/departmentsreport/school-page-one' . ($branch_id ? '/' . $branch_id : ''), 'ষান্মাসিক ' . $report_info['year']);
...
<span class="dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="archive">
        ...
        for ($i = date('Y') - 1; $i >= 2019; $i--) {
            ...
            echo   ' <li>' . anchor('admin/departmentsreport/school-page-one' . ($branch_id ? '/' . $branch_id : '') . '?type=half_yearly&year=' . $i, 'ষান্মাসিক ' . $i) . ' </li>';
        }
        ?>
                    ...
                    <div class="tg-wrap">
                        ...
                        <table class="tg table table-header-rotated" id="testTable3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $thana_prev = $total_school_shongothon['thana_prev'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $thana_pres = $total_school_shongothon['thana_pres'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $thana_bri = $total_school_shongothon['thana_bri'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $thana_gha = $total_school_shongothon['thana_gha'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $word_prev = $total_school_shongothon['word_prev'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $word_pres = $total_school_shongothon['word_pres'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $word_bri = $total_school_shongothon['word_bri'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $word_gha = $total_school_shongothon['word_gha'] ?>
                                </td>
                        ...
                        <table class="tg table table-header-rotated" id="testTable4">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $kormi_shobbedari_num = $total_school_proshikkhon['kormi_shobbedari_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $kormi_shobbedari_pre = $total_school_proshikkhon['kormi_shobbedari_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                        ...
                        <table class="tg table table-header-rotated" id="testTable5">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $sadaron_shova_num = $total_school_dawat_program['sadaron_shova_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $sadaron_shova_pre = $total_school_dawat_program['sadaron_shova_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $boat_travel_num = $total_school_dawat_program['boat_travel_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $boat_travel_pre = $total_school_dawat_program['boat_travel_pre'] ?>
                                </td>
                                <td class="tg-0pky">
