    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <table class="table table-bordered" id="administrativedetail" data-branch="<?=$branch_id ? $branch->name.'_City Thana Organization' : 'সকল শাখা_'.'City Thana Organization'?>">
                    <thead>
                        <tr>
                            <th colspan="12"> সিটি থানা</th>
                        </tr>
                        <tr>
