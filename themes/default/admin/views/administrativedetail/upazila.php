                ...
                <?php if (!empty($branches)) { ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?= admin_url('administrativedetail/upazila') ?>"><i class="fa fa-building-o"></i>
                                    <?= 'সকল শাখা' ?></a></li>
                            <li class="divider"></li>
                            <?php
                            foreach ($branches as $branch) {
                                echo '<li><a href="' . admin_url('administrativedetail/upazila/' . $branch->id) . '"><i class="fa fa-building"></i>' . $branch->name . '</a></li>';
                            }
                            ?>
                        </ul>
                    </li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <table class="table table-bordered" id="administrativedetail"
                    ...
                    <thead>
                        <tr>
                            <th colspan="12"> উপজেলা তালিকা</th>
                        </tr>
                        <tr>
