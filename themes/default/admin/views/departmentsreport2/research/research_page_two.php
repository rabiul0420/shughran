...
if ($report_info['is_current'] || $report_info['year'] == date('Y')) {
    if ($report_info['type'] == 'annual') {
        echo anchor('admin/departmentsreport/research-page-two' . ($branch_id ? '/' . $branch_id : '') . ('?type=half_yearly&year=' . $report_info['year']), 'ষান্মাসিক ' . $report_info['year']);
        echo  "&nbsp;|&nbsp;" . anchor('admin/departmentsreport/research-page-two' . ($branch_id ? '/' . $branch_id : ''), 'জুলাই-নভেম্বর\'' . $report_info['year']);
        echo "&nbsp;|&nbsp;";
        ...
        echo anchor('admin/departmentsreport/research-page-two' . ($branch_id ? '/' . $branch_id : ''), 'ষান্মাসিক ' . $report_info['year']);
...
<span class="dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="archive">
        ...
        for ($i = date('Y') - 1; $i >= 2019; $i--) {
            ...
            echo   ' <li>' . anchor('admin/departmentsreport/research-page-two' . ($branch_id ? '/' . $branch_id : '') . '?type=half_yearly&year=' . $i, 'ষান্মাসিক ' . $i) . ' </li>';
        }
        ?>
	...
	border: 1px solid #ccc;
                    ...
                    <table class="tg table table-header-rotated" id="testTable4">
                            ...
                            <tr>
                                ...
                                <?php echo $shikkha_central_s=$total_gobeshona_training_program['shikkha_central_s'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $shikkha_central_p=$total_gobeshona_training_program['shikkha_central_p'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky type_1">
                                <?php echo $shikkha_shakha_s=$total_gobeshona_training_program['shikkha_shakha_s'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $shikkha_shakha_p=$total_gobeshona_training_program['shikkha_shakha_p'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky type_1">
                                <?php echo $kormoshala_central_s=$total_gobeshona_training_program['kormoshala_central_s'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $kormoshala_central_p=$total_gobeshona_training_program['kormoshala_central_p'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky type_1">
                                <?php echo $kormoshala_shakha_s=$total_gobeshona_training_program['kormoshala_shakha_s'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $kormoshala_shakha_p=$total_gobeshona_training_program['kormoshala_shakha_p'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
            ...
            <table class="tg table table-header-rotated" id="testTable1">
                    ...
                    <td class="tg-pwj7">
                       ...
                       <td class="tg-0pky  type_2">
                       <?php echo $probondho_lekha = $total_gobeshona_lekhalekhi['probondho_lekha'] ?>
                       </td>
                         <td class="tg-0pky  type_2">
                       <?php echo $probondho_prokash = $total_gobeshona_lekhalekhi['probondho_prokash'] ?>
                       </td>
                    </tr>  
                    <tr>
                       <td class="tg-pwj7">
                       ...
                       <td class="tg-0pky  type_2">
                       <?php echo $nibondhon_lekha = $total_gobeshona_lekhalekhi['nibondhon_lekha'] ?>
                       </td>
                         <td class="tg-0pky  type_2">
                       <?php echo $nibondhon_prokash = $total_gobeshona_lekhalekhi['nibondhon_prokash'] ?>
                       </td>
                    </tr>
                    <tr>
                       <td class="tg-pwj7">
                       বই 
                         ...
                         <td class="tg-0pky  type_2">
                       <?php echo $boi_lekha = $total_gobeshona_lekhalekhi['boi_lekha'] ?>
                       </td>
                         <td class="tg-0pky  type_2">
                       <?php echo $boi_prokash = $total_gobeshona_lekhalekhi['boi_prokash'] ?>
                       </td>
                    </tr>  
                    <tr>
                       <td class="tg-pwj7">
                       বুক রিভিউ
                         ...
                         <td class="tg-0pky  type_2">
                       <?php echo $boi_review_lekha = $total_gobeshona_lekhalekhi['boi_review_lekha'] ?>
                       </td>
                         <td class="tg-0pky  type_2">
                       <?php echo $boi_review_prokash = $total_gobeshona_lekhalekhi['boi_review_prokash'] ?>
                       </td>
                    </tr> 
                    ...
                    <tr>
                       ...
                       প্রবন্ধ রিভিউ
                         ...
                         <td class="tg-0pky  type_2">
                       <?php echo $review_lekha = $total_gobeshona_lekhalekhi['review_lekha'] ?>
                       </td>
                         <td class="tg-0pky  type_2">
                       <?php echo $review_prokash = $total_gobeshona_lekhalekhi['review_prokash'] ?>
                       </td>
                    </tr> 
                    <tr>
                       <td class="tg-pwj7">
                       প্রেজেন্টেশন
                         ...
                         <td class="tg-0pky  type_2">
                       <?php echo $presentation_lekha = $total_gobeshona_lekhalekhi['presentation_lekha'] ?>
                       </td>
                         <td class="tg-0pky  type_2">
                       <?php echo $presentation_prokash = $total_gobeshona_lekhalekhi['presentation_prokash'] ?>
                       </td>
                    </tr> 
                    <tr>
                       <td class="tg-pwj7">
                       ডকুমেন্টারি
                         ...
                         <td class="tg-0pky  type_2">
                       <?php echo $document_lekha = $total_gobeshona_lekhalekhi['document_lekha'] ?>
                       </td>
                         <td class="tg-0pky  type_2">
                       <?php echo $document_prokash = $total_gobeshona_lekhalekhi['document_prokash'] ?>
                       </td>
                    </tr> 
                    <tr>
                       <td class="tg-pwj7">
                       স্ক্রিপ্টিং রাইটিং 
                         ...
                         <td class="tg-0pky  type_2">
                       <?php echo $script_lekha = $total_gobeshona_lekhalekhi['script_lekha'] ?>
                       </td>
                         <td class="tg-0pky  type_2">
                       <?php echo $script_prokash = $total_gobeshona_lekhalekhi['script_prokash'] ?>
                       </td>
                    </tr> 
                    <tr>
                       <td class="tg-pwj7">
                       বাংলা ব্লগ 
                         ...
                         <td class="tg-0pky  type_2">
                       <?php echo $bangla_lekha = $total_gobeshona_lekhalekhi['bangla_lekha'] ?>
                       </td>
                         <td class="tg-0pky  type_2">
                       <?php echo $bangla_prokash = $total_gobeshona_lekhalekhi['bangla_prokash'] ?>
                       </td>
                    </tr> 
                    <tr>
                       <td class="tg-pwj7">
                       ইংরেজি ব্লগ 
                         ...
                         <td class="tg-0pky  type_2">
                       <?php echo $english_lekha = $total_gobeshona_lekhalekhi['english_lekha'] ?>
                       </td>
                         <td class="tg-0pky  type_2">
                       <?php echo $english_prokash = $total_gobeshona_lekhalekhi['english_prokash'] ?>
                       </td>
                    </tr> 
                </table>
