...
if ($report_info['is_current'] || $report_info['year'] == date('Y')) {
    if ($report_info['type'] == 'annual') {
        echo anchor('admin/departmentsreport/research-page-one' . ($branch_id ? '/' . $branch_id : '') . ('?type=half_yearly&year=' . $report_info['year']), 'ষান্মাসিক ' . $report_info['year']);
        echo  "&nbsp;|&nbsp;" . anchor('admin/departmentsreport/research-page-one' . ($branch_id ? '/' . $branch_id : ''), 'জুলাই-নভেম্বর\'' . $report_info['year']);
        echo "&nbsp;|&nbsp;";
        ...
        echo anchor('admin/departmentsreport/research-page-one' . ($branch_id ? '/' . $branch_id : ''), 'ষান্মাসিক ' . $report_info['year']);
...
<span class="dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="archive">
        ...
        for ($i = date('Y') - 1; $i >= 2019; $i--) {
            ...
            echo   ' <li>' . anchor('admin/departmentsreport/research-page-one' . ($branch_id ? '/' . $branch_id : '') . '?type=half_yearly&year=' . $i, 'ষান্মাসিক ' . $i) . ' </li>';
        }
        ?>
                    ...
                    <div class="tg-wrap">
                        <table class="tg table table-header-rotated" id="testTable1">
                            ...
                            <tr>
                               ...
                               <td class="tg-0pky"><?php echo $total_gobeshona_shikkha_kathamo['ghobeshona_shompond'] ?> </td>
                            </tr>
                            <tr>
                               <td class="tg-pwj7">না </td>
                               <td class="tg-0pky"><?php echo  $total_gobeshona_shikkha_kathamo_row - $total_gobeshona_shikkha_kathamo['ghobeshona_shompond'] ?> </td>
                            </tr>
                            <tr>
                               <td class="tg-0pky tg-pwj7" colspan="2"> বিভাগের  অধীনে কতটি গবেষণা স্কুল প্রতিষ্ঠিত আছে? (যদি থাকে) </td>
                               <td class="tg-0pky"><?php echo $total_gobeshona_shikkha_kathamo['school'] ?> </td>
                            </tr>  
                            <tr>
                               <td class="tg-0pky tg-pwj7" colspan="2"> এ বছর বৃদ্ধি হয়েছে কতটি স্কুল? </td>
                               <td class="tg-0pky"><?php echo $total_gobeshona_shikkha_kathamo['school_bri'] ?> </td>
                            </tr>
                            <tr>
                               <td class="tg-0pky tg-pwj7" colspan="2"> নলেজ মুভমেন্ট প্রজেক্টে সম্পৃক্ত জনশক্তি সংখ্যা </td>
                               <td class="tg-0pky"><?php echo $total_gobeshona_shikkha_kathamo['knowledge_movement'] ?> </td>
                            </tr>  
                        </table>
                        ...
                        <table class="tg table table-header-rotated" id="testTable2">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky"><?php echo $shodossho = $total_gobeshona_shomprikto_jonoshokti['shodossho'] ?> </td>
                                <td class="tg-pwj7">সাথী  </td>
                                <td class="tg-0pky"><?php echo $sathi = $total_gobeshona_shomprikto_jonoshokti['sathi'] ?> </td> </td>
                                <td class="tg-pwj7">কর্মী </td>
                                <td class="tg-0pky"><?php echo $kormi = $total_gobeshona_shomprikto_jonoshokti['kormi'] ?> </td> </td>
                            </tr> 
                        ...
                        <table class="tg table table-header-rotated" id="testTable3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $week_class_n = $total_gobeshona_regular_program['week_class_n'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $week_class_p = $total_gobeshona_regular_program['week_class_p'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $dars_quran_n = $total_gobeshona_regular_program['dars_quran_n'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $dars_quran_p = $total_gobeshona_regular_program['dars_quran_p'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $open_class_n = $total_gobeshona_regular_program['open_class_n'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $open_class_p = $total_gobeshona_regular_program['open_class_p'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $motobinimoy_n = $total_gobeshona_regular_program['motobinimoy_n'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $motobinimoy_p = $total_gobeshona_regular_program['motobinimoy_p'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                              ...
                              <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $dayittoshil_n = $total_gobeshona_regular_program['dayittoshil_n'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $dayittoshil_p = $total_gobeshona_regular_program['dayittoshil_p'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $indoor_n = $total_gobeshona_regular_program['indoor_n'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $indoor_p = $total_gobeshona_regular_program['indoor_p'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $beboharik_n = $total_gobeshona_regular_program['beboharik_n'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $beboharik_p = $total_gobeshona_regular_program['beboharik_p'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $visual_n = $total_gobeshona_regular_program['visual_n'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $visual_p = $total_gobeshona_regular_program['visual_p'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $milonmela_n = $total_gobeshona_regular_program['milonmela_n'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $milonmela_p = $total_gobeshona_regular_program['milonmela_p'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                              ...
                              <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $shongbad_n = $total_gobeshona_regular_program['shongbad_n'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $shongbad_p = $total_gobeshona_regular_program['shongbad_p'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $puroshkar_n = $total_gobeshona_regular_program['puroshkar_n'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $puroshkar_p = $total_gobeshona_regular_program['puroshkar_p'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $cha_n = $total_gobeshona_regular_program['cha_n'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $cha_p = $total_gobeshona_regular_program['cha_p'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $other_n = $total_gobeshona_regular_program['other_n'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $other_p = $total_gobeshona_regular_program['other_p'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                        ...
                        <table class="tg table table-header-rotated" id="testTable4">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $workshop_n = $total_gobeshona_bishesh_program['workshop_n'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $workshop_attendence = $total_gobeshona_bishesh_program['workshop_attendence'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $seminer_n = $total_gobeshona_bishesh_program['seminer_n'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $seminer_attendence = $total_gobeshona_bishesh_program['seminer_attendence'] ?>
                                </td>                     
                            </tr>
                            <tr>
                                <td class="tg-y698">শিক্ষাসফর   </td>
                                <td class="tg-0pky  type_1">
                                    <?php echo $tour_n = $total_gobeshona_bishesh_program['tour_n'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $tour_attendence = $total_gobeshona_bishesh_program['tour_attendence'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $bideshe_n = $total_gobeshona_bishesh_program['bideshe_n'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $bideshe_attendence = $total_gobeshona_bishesh_program['bideshe_attendence'] ?>
                                </td>
                        ...
                        <table class="tg table table-header-rotated" id="testTable5">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_2">
                                <?php echo $emil_upb = $total_gobeshona_bivag_jogajog['emil_s'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                                <?php echo $emil_upb = $total_gobeshona_bivag_jogajog['emil_tg'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_2">
                                <?php echo $sms_upb = $total_gobeshona_bivag_jogajog['sms_s'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                                <?php echo $sms_upb = $total_gobeshona_bivag_jogajog['sms_tg'] ?>
                                </td>
                            </tr>
                        </table>
                    </div>
