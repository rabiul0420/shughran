	...
	border: 1px solid #ccc;
                    ...
                    <table class="tg table table-header-rotated" id="testTable10">
                        ...
                        <tr>
                            ...
                            <?php echo $shikkha_central_s=$total_debate_training_program['shikkha_central_s'] ?>
                            </td>
                            <td class="tg-0pky  type_2">
                            <?php echo $shikkha_central_p=$total_debate_training_program['shikkha_central_p'] ?>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="tg-0pky type_1">
                            <?php echo $shikkha_shakha_s=$total_debate_training_program['shikkha_shakha_s'] ?>
                            </td>
                            <td class="tg-0pky  type_2">
                            <?php echo $shikkha_shakha_p=$total_debate_training_program['shikkha_shakha_p'] ?>
                            </td>
                            <td class="tg-0pky  type_3">
                        ...
                        <tr>
                            ...
                            <td class="tg-0pky type_1">
                            <?php echo $kormoshala_central_s=$total_debate_training_program['kormoshala_central_s'] ?>
                            </td>
                            <td class="tg-0pky  type_2">
                            <?php echo $kormoshala_central_p=$total_debate_training_program['kormoshala_central_p'] ?>
                            </td>
                            <td class="tg-0pky  type_3">
                        ...
                        <tr>
                            ...
                            <td class="tg-0pky type_1">
                            <?php echo $kormoshala_shakha_s=$total_debate_training_program['kormoshala_shakha_s'] ?>
                            </td>
                            <td class="tg-0pky  type_2">
                            <?php echo $kormoshala_shakha_p=$total_debate_training_program['kormoshala_shakha_p'] ?>
                            </td>
                            <td class="tg-0pky  type_3">
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <?php echo $bangla_shang_num = $total_debate_program['bangla_shang_num'] ?>
                                </td>
                                <td class="tg-0pky" colspan=""> 
                                <?php echo $bangla_shang_pre = $total_debate_program['bangla_shang_pre'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky" colspan=""> 
                                <?php echo $bangla_shadha_num = $total_debate_program['bangla_shadha_num'] ?>
                                </td>
                                <td class="tg-0pky" colspan=""> 
                                <?php echo $bangla_shadha_pre = $total_debate_program['bangla_shadha_pre'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                সাংগঠনিক
                                 ...
                                 <td class="tg-0pky" colspan=""> 
                                <?php echo $eng_shang_num = $total_debate_program['eng_shang_num'] ?>
                                </td>
                                <td class="tg-0pky" colspan=""> 
                                <?php echo $eng_shang_pre = $total_debate_program['eng_shang_pre'] ?>
                                </td>
                            ...
                            <tr>
                                <td class="tg-pwj7 ">সাধারণ</td>
                                 <td class="tg-0pky" colspan=""> 
                                <?php echo $eng_shadha_num = $total_debate_program['eng_shadha_num'] ?>
                                </td>
                                <td class="tg-0pky" colspan=""> 
                                <?php echo $eng_shadha_pre = $total_debate_program['eng_shadha_pre'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-pwj7" colspan=""> 
                                 ...
                                 <td class="tg-0pky" colspan=""> 
                                <?php echo $university_shang_num = $total_debate_program['university_shang_num'] ?>
                                </td>
                                <td class="tg-0pky" colspan=""> 
                                <?php echo $university_shang_pre = $total_debate_program['university_shang_pre'] ?>
                                </td>
                                ...
                                <td class="tg-y698">সাধারণ </td>
                                 ...
                                 <td class="tg-0pky" colspan=""> 
                                <?php echo $university_shadha_num = $total_debate_program['university_shadha_num'] ?>
                                </td>
                                <td class="tg-0pky" colspan=""> 
                                <?php echo $university_shadha_pre = $total_debate_program['university_shadha_pre'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-pwj7" colspan=""> 
                                 ...
                                 <td class="tg-0pky" colspan=""> 
                                <?php echo $college_shang_num = $total_debate_program['college_shang_num'] ?>
                                </td>
                                <td class="tg-0pky" colspan=""> 
                                <?php echo $college_shang_pre = $total_debate_program['college_shang_pre'] ?>
                                </td>
                                ...
                                <td class="tg-y698">সাধারণ </td>
                                 ...
                                 <td class="tg-0pky" colspan=""> 
                                <?php echo $college_shadha_num = $total_debate_program['college_shadha_num'] ?>
                                </td>
                                <td class="tg-0pky" colspan=""> 
                                <?php echo $college_shadha_pre = $total_debate_program['college_shadha_pre'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-pwj7" colspan=""> 
                                 ...
                                 <td class="tg-0pky" colspan=""> 
                                <?php echo $school_shang_num = $total_debate_program['school_shang_num'] ?>
                                </td>
                                <td class="tg-0pky" colspan=""> 
                                <?php echo $school_shang_pre = $total_debate_program['school_shang_pre'] ?>
                                </td>
                                ...
                                <td class="tg-y698">সাধারণ </td>
                                 ...
                                 <td class="tg-0pky" colspan=""> 
                                <?php echo $school_shadha_num = $total_debate_program['school_shadha_num'] ?>
                                </td>
                                <td class="tg-0pky" colspan=""> 
                                <?php echo $school_shadha_pre = $total_debate_program['school_shadha_pre'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-pwj7" colspan=""> 
                                 ...
                                 <td class="tg-0pky" colspan=""> 
                                <?php echo $madrasah_shang_num = $total_debate_program['madrasah_shang_num'] ?>
                                </td>
                                <td class="tg-0pky" colspan=""> 
                                <?php echo $madrasah_shang_pre = $total_debate_program['madrasah_shang_pre'] ?>
                                </td>
                                ...
                                <td class="tg-y698">সাধারণ </td>
                                 ...
                                 <td class="tg-0pky" colspan=""> 
                                <?php echo $madrasah_shadha_num = $total_debate_program['madrasah_shadha_num'] ?>
                                </td>
                                <td class="tg-0pky" colspan=""> 
                                <?php echo $madrasah_shadha_pre = $total_debate_program['madrasah_shadha_pre'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky" colspan=""> 
                                <?php echo $exec_meeting_num = $total_debate_program['exec_meeting_num'] ?>
                                </td>
                                <td class="tg-0pky" colspan=""> 
                                <?php echo $exec_meeting_pre = $total_debate_program['exec_meeting_pre'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky" colspan=""> 
                                <?php echo $other_num = $total_debate_program['other_num'] ?>
                                </td>
                                <td class="tg-0pky" colspan=""> 
                                <?php echo $other_pre = $total_debate_program['other_pre'] ?>
                                </td>
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky" colspan=""> 
                                    <?php echo $anto_s_s = $total_debate_protijogita['anto_s_s'] ?>
                                    </td>
                                
                                <td class="tg-0pky" colspan=""> 
                                    <?php echo $anto_s_p = $total_debate_protijogita['anto_s_p'] ?>
                                    </td>
                                <td class="tg-0pky" colspan="">  
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky" colspan=""> 
                                    <?php echo $anto_g_s = $total_debate_protijogita['anto_g_s'] ?>
                                    </td>
                                
                                <td class="tg-0pky" colspan=""> 
                                    <?php echo $anto_g_p = $total_debate_protijogita['anto_g_p'] ?>
                                    </td>
                                <td class="tg-0pky" colspan="">  
                            ...
                            <tr>
                                <td class="tg-pwj7" rowspan="2">বক্তৃতা/ উপস্থিত বক্তৃতা প্রতিযোগিতা</td>
                                                               <td class="tg-pwj7" >সাংগঠনিক</td>
                                <td class="tg-0pky" colspan=""> 
                                    <?php echo $speak_s_s = $total_debate_protijogita['speak_s_s'] ?>
                                    </td>
                                
                                <td class="tg-0pky" colspan=""> 
                                    <?php echo $speak_s_p = $total_debate_protijogita['speak_s_p'] ?>
                                    </td>
                                    <td class="tg-0pky" colspan="">  
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky" colspan=""> 
                                    <?php echo $speak_g_s = $total_debate_protijogita['speak_g_s'] ?>
                                    </td>
                                
                                <td class="tg-0pky" colspan=""> 
                                    <?php echo $speak_g_p = $total_debate_protijogita['speak_g_p'] ?>
                                    </td>
                                    <td class="tg-0pky" colspan="">  
                            ...
                            <tr>
                                ...
                                <td class="tg-pwj7" >সাংগঠনিক</td>
                                <td class="tg-0pky" colspan=""> 
                                    <?php echo $priti_s_s = $total_debate_protijogita['priti_s_s'] ?>
                                    </td>
                                
                                <td class="tg-0pky" colspan=""> 
                                    <?php echo $priti_s_p = $total_debate_protijogita['priti_s_p'] ?>
                                    </td>
                                    <td class="tg-0pky" colspan="">  
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky" colspan=""> 
                                    <?php echo $priti_g_s = $total_debate_protijogita['priti_g_s'] ?>
                                    </td>
                                
                                <td class="tg-0pky" colspan=""> 
                                    <?php echo $priti_g_p = $total_debate_protijogita['priti_g_p'] ?>
                                    </td>
                                    <td class="tg-0pky" colspan="">  
                            ...
                            <tr>
                                ...
                                <td class="tg-pwj7" >সাংগঠনিক</td>
                                <td class="tg-0pky" colspan=""> 
                                    <?php echo $quiz_s_s = $total_debate_protijogita['quiz_s_s'] ?>
                                    </td>
                                
                                <td class="tg-0pky" colspan=""> 
                                    <?php echo $quiz_s_p = $total_debate_protijogita['quiz_s_p'] ?>
                                    </td>
                                    <td class="tg-0pky" colspan="">  
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky" colspan=""> 
                                    <?php echo $quiz_g_s = $total_debate_protijogita['quiz_g_s'] ?>
                                    </td>
                                
                                <td class="tg-0pky" colspan=""> 
                                    <?php echo $quiz_g_p = $total_debate_protijogita['quiz_g_p'] ?>
                                    </td>
                                    <td class="tg-0pky" colspan="">  
                            ...
                            <tr>
                                ...
                                <td class="tg-pwj7" >সাংগঠনিক</td>
                                <td class="tg-0pky" colspan=""> 
                                    <?php echo $other_s_s = $total_debate_protijogita['other_s_s'] ?>
                                    </td>
                                
                                <td class="tg-0pky" colspan=""> 
                                    <?php echo $other_s_p = $total_debate_protijogita['other_s_p'] ?>
                                    </td>
                                    <td class="tg-0pky" colspan="">  
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky" colspan=""> 
                                    <?php echo $other_g_s = $total_debate_protijogita['other_g_s'] ?>
                                    </td>
                                
                                <td class="tg-0pky" colspan=""> 
                                    <?php echo $other_g_p = $total_debate_protijogita['other_g_p'] ?>
                                    </td>
                                    <td class="tg-0pky" colspan="">  
