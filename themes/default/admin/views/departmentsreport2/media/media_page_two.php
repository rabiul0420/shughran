...
if ($report_info['is_current'] || $report_info['year'] == date('Y')) {
    if ($report_info['type'] == 'annual') {
        echo anchor('admin/departmentsreport/media-page-two' . ($branch_id ? '/' . $branch_id : '') . ('?type=half_yearly&year=' . $report_info['year']), 'ষান্মাসিক ' . $report_info['year']);
        echo  "&nbsp;|&nbsp;" . anchor('admin/departmentsreport/media-page-two' . ($branch_id ? '/' . $branch_id : ''), 'জুলাই-নভেম্বর\'' . $report_info['year']);
        echo "&nbsp;|&nbsp;";
        ...
        echo anchor('admin/departmentsreport/media-page-two' . ($branch_id ? '/' . $branch_id : ''), 'ষান্মাসিক ' . $report_info['year']);
...
<span class="dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="archive">
        ...
        for ($i = date('Y') - 1; $i >= 2019; $i--) {
            ...
            echo   ' <li>' . anchor('admin/departmentsreport/media-page-two' . ($branch_id ? '/' . $branch_id : '') . '?type=half_yearly&year=' . $i, 'ষান্মাসিক ' . $i) . ' </li>';
        }
        ?>
	...
	border: 1px solid #ccc;
                    ...
                    <table class="tg table table-header-rotated" id="testTable2">
                        ...
                        <tr>
                            ...
                            <?php echo $shikkha_central_s=$total_media_training_program['shikkha_central_s'] ?>
                            </td>
                            <td class="tg-0pky  type_2">
                            <?php echo $shikkha_central_p=$total_media_training_program['shikkha_central_p'] ?>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="tg-0pky type_1">
                            <?php echo $shikkha_shakha_s=$total_media_training_program['shikkha_shakha_s'] ?>
                            </td>
                            <td class="tg-0pky  type_2">
                            <?php echo $shikkha_shakha_p=$total_media_training_program['shikkha_shakha_p'] ?>
                            </td>
                            <td class="tg-0pky  type_3">
                        ...
                        <tr>
                            ...
                            <td class="tg-0pky type_1">
                            <?php echo $kormoshala_central_s=$total_media_training_program['kormoshala_central_s'] ?>
                            </td>
                            <td class="tg-0pky  type_2">
                            <?php echo $kormoshala_central_p=$total_media_training_program['kormoshala_central_p'] ?>
                            </td>
                            <td class="tg-0pky  type_3">
                        ...
                        <tr>
                            ...
                            <td class="tg-0pky type_1">
                            <?php echo $kormoshala_shakha_s=$total_media_training_program['kormoshala_shakha_s'] ?>
                            </td>
                            <td class="tg-0pky  type_2">
                            <?php echo $kormoshala_shakha_p=$total_media_training_program['kormoshala_shakha_p'] ?>
                            </td>
                            <td class="tg-0pky  type_3">
