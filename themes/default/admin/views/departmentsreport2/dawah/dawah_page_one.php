...
if ($report_info['is_current'] || $report_info['year'] == date('Y')) {
    if ($report_info['type'] == 'annual') {
        echo anchor('admin/departmentsreport/dawah-page-one' . ($branch_id ? '/' . $branch_id : '') . ('?type=half_yearly&year=' . $report_info['year']), 'ষান্মাসিক ' . $report_info['year']);
        echo  "&nbsp;|&nbsp;" . anchor('admin/departmentsreport/dawah-page-one' . ($branch_id ? '/' . $branch_id : ''), 'জুলাই-নভেম্বর\'' . $report_info['year']);
        echo "&nbsp;|&nbsp;";
        ...
        echo anchor('admin/departmentsreport/dawah-page-one' . ($branch_id ? '/' . $branch_id : ''), 'ষান্মাসিক ' . $report_info['year']);
...
<span class="dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="archive">
        ...
        for ($i = date('Y') - 1; $i >= 2019; $i--) {
            ...
            echo   ' <li>' . anchor('admin/departmentsreport/dawah-page-one' . ($branch_id ? '/' . $branch_id : '') . '?type=half_yearly&year=' . $i, 'ষান্মাসিক ' . $i) . ' </li>';
        }
        ?>
					...
					<div class="tg-wrap">
						<table class="tg table table-header-rotated" id="testTable1">
							...
							<tr>
								<td class="tg-0pky  type_1">
									<?php echo $prev = $total_dawah_moktob['prev'] ?>
								</td>
								<td class="tg-0pky  type_2">
									<?php echo $present = $total_dawah_moktob['present'] ?>
								</td>
								<td class="tg-0pky  type_3">
									<?php echo $bri = $total_dawah_moktob['bri'] ?>
								</td>
								<td class="tg-0pky  type_4">
									<?php echo $ghat = $total_dawah_moktob['ghat'] ?>
								</td>
								<td class="tg-0pky  type_5">
									<?php echo $student = $total_dawah_moktob['student'] ?>
								</td>
							</tr>
						</table>
						...
						<table class="tg table table-header-rotated" id="testTable2">
							...
							<tr>
								...
								<td class="tg-0pky  type_2">
									<?php $total_own = 0;
									echo $member_for_own = $total_dawah_jonoshokti_byktigoto_procheshta['member_for_own'];
									$total_own += $member_for_own ?>
								</td>
								<td class="tg-0pky  type_3">
									<?php $total_jonosokti = 0;
									echo $member_for_jonoshokti = $total_dawah_jonoshokti_byktigoto_procheshta['member_for_jonoshokti'];
									$total_jonosokti += $member_for_jonoshokti; ?>
								</td>
								<td class="tg-0pky  type_4">
									<?php $total_general = 0;
									echo $member_for_general = $total_dawah_jonoshokti_byktigoto_procheshta['member_for_general'];
							...
							<tr>
								...
								<td class="tg-0pky  type_2">
									<?php echo $asso_for_own = $total_dawah_jonoshokti_byktigoto_procheshta['asso_for_own'];
									$total_own += $asso_for_own ?>
								</td>
								<td class="tg-0pky  type_3">
									<?php echo $asso_for_jonoshokti = $total_dawah_jonoshokti_byktigoto_procheshta['asso_for_jonoshokti'];
									$total_jonosokti += $asso_for_jonoshokti; ?>
								</td>
								<td class="tg-0pky  type_4">
									<?php echo $asso_for_general = $total_dawah_jonoshokti_byktigoto_procheshta['asso_for_general'];
							...
							<tr>
								...
								<td class="tg-0pky  type_2">
									<?php echo $worker_for_own = $total_dawah_jonoshokti_byktigoto_procheshta['worker_for_own'];
									$total_own += $worker_for_own ?>
								</td>
								<td class="tg-0pky  type_3">
									<?php echo $worker_for_jonoshokti = $total_dawah_jonoshokti_byktigoto_procheshta['worker_for_jonoshokti'];
									$total_jonosokti += $worker_for_jonoshokti; ?>
								</td>
								<td class="tg-0pky  type_4">
									<?php echo $worker_for_general = $total_dawah_jonoshokti_byktigoto_procheshta['worker_for_general'];
						...
						<table class="tg table table-header-rotated" id="testTable3">
							...
							<tr>
								...
								<td class="tg-0pky  type_2">
									<?php echo $upodeshta_number = $total_dawah_shovashomuho['upodeshta_number'] ?>
								</td>
								<td class="tg-0pky  type_3">
									<?php echo $upodeshta_present = $total_dawah_shovashomuho['upodeshta_present'] ?>
								</td>
								<td class="tg-0pky  type_4">
							...
							<tr>
								...
								<td class="tg-0pky  type_2">
									<?php echo $karjonirbahi_number = $total_dawah_shovashomuho['karjonirbahi_number'] ?>

								</td>
								<td class="tg-0pky  type_3">
									<?php echo $karjonirbahi_present = $total_dawah_shovashomuho['karjonirbahi_present'] ?>
							...
							<tr>
								...
								<td class="tg-0pky  type_2">
									<?php echo $kendrio_number = $total_dawah_shovashomuho['kendrio_number'] ?>

								</td>
								<td class="tg-0pky  type_3">
									<?php echo $kendrio_present = $total_dawah_shovashomuho['kendrio_present'] ?>
							...
							<tr>
								...
								<td class="tg-0pky  type_2">
									<?php echo $iftar_number = $total_dawah_shovashomuho['iftar_number'] ?>

								</td>
								<td class="tg-0pky  type_3">
									<?php echo $iftar_present = $total_dawah_shovashomuho['iftar_present'] ?>
								</td>
								<td class="tg-0pky  type_4">
							...
							<tr>
								...
								<td class="tg-0pky  type_2">
									<?php echo $dars_number = $total_dawah_shovashomuho['dars_number'] ?>
								</td>
								<td class="tg-0pky  type_3">
									<?php echo $dars_present = $total_dawah_shovashomuho['dars_present'] ?>
							...
							<tr>
								...
								<td class="tg-0pky  type_2">
									<?php echo $dawat_number = $total_dawah_shovashomuho['dawat_number'] ?>
								</td>
								<td class="tg-0pky  type_3">
									<?php echo $dawat_present = $total_dawah_shovashomuho['dawat_present'] ?>
								</td>
								<td class="tg-0pky  type_4">
