				...
				<style type="text/css">
                    ...
                    <table class="tg table table-header-rotated" id="testTable1">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $new_kishor_potrika_bn_prev = $total_school_bitoron['new_kishor_potrika_bn_prev'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $new_kishor_potrika_bn_pres = $total_school_bitoron['new_kishor_potrika_bn_pres'] ?>
                                </td>
                            </tr>    
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $calendar_prev = $total_school_bitoron['calendar_prev'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $calendar_pres = $total_school_bitoron['calendar_pres'] ?>
                                </td>
                            </tr>
                        ...
                        <table class="tg table table-header-rotated" id="testTable3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $central_sompadok = $total_school_sofor['central_sompadok'] ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $central_member = $total_school_sofor['central_member'] ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $shakha_p_s = $total_school_sofor['shakha_p_s'] ?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $shakha_sec = $total_school_sofor['shakha_sec'] ?>
                                </td>
