...
if ($report_info['is_current'] || $report_info['year'] == date('Y')) {
    if ($report_info['type'] == 'annual') {
        echo anchor('admin/departmentsreport/school-page-three' . ($branch_id ? '/' . $branch_id : '') . ('?type=half_yearly&year=' . $report_info['year']), 'ষান্মাসিক ' . $report_info['year']);
        echo  "&nbsp;|&nbsp;" . anchor('admin/departmentsreport/school-page-three' . ($branch_id ? '/' . $branch_id : ''), 'জুলাই-নভেম্বর\'' . $report_info['year']);
        echo "&nbsp;|&nbsp;";
        ...
        echo anchor('admin/departmentsreport/school-page-three' . ($branch_id ? '/' . $branch_id : ''), 'ষান্মাসিক ' . $report_info['year']);
...
<span class="dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="archive">
        ...
        for ($i = date('Y') - 1; $i >= 2019; $i--) {
            ...
            echo   ' <li>' . anchor('admin/departmentsreport/school-page-three' . ($branch_id ? '/' . $branch_id : '') . '?type=half_yearly&year=' . $i, 'ষান্মাসিক ' . $i) . ' </li>';
        }
        ?>
				...
				<style type="text/css">
                    ...
                    <table class="tg table table-header-rotated" id="testTable1">
                        ...
                        <table class="tg table table-header-rotated" id="testTable2">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $akash_sowa_num = $total_school_career_design['akash_sowa_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $akash_sowa_pre = $total_school_career_design['akash_sowa_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $free_test_num = $total_school_career_design['free_test_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $free_test_pre = $total_school_career_design['free_test_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $complex_tropice_num = $total_school_career_design['complex_tropice_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $complex_tropice_pre = $total_school_career_design['complex_tropice_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $a_plus_num = $total_school_career_design['a_plus_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $a_plus_pre = $total_school_career_design['a_plus_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $doctor_num = $total_school_career_design['doctor_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $doctor_pre = $total_school_career_design['doctor_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $enginner_num = $total_school_career_design['enginner_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $enginner_pre = $total_school_career_design['enginner_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                    ...
                    <table class="tg table table-header-rotated" id="testTable3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $health_camp_num = $total_school_samajik_kaj['health_camp_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $health_camp_pre = $total_school_samajik_kaj['health_camp_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $cleaning_num = $total_school_samajik_kaj['cleaning_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $cleaning_pre = $total_school_samajik_kaj['cleaning_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $winter_num = $total_school_samajik_kaj['winter_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $winter_pre = $total_school_samajik_kaj['winter_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $day_num = $total_school_samajik_kaj['day_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $day_pre = $total_school_samajik_kaj['day_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $tree_plant_num = $total_school_samajik_kaj['tree_plant_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $tree_plant_pre = $total_school_samajik_kaj['tree_plant_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $blood_group_num = $total_school_samajik_kaj['blood_group_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $blood_group_pre = $total_school_samajik_kaj['blood_group_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $other_num = $total_school_samajik_kaj['other_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $other_pre = $total_school_samajik_kaj['other_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo ($other_pre!=0 && $other_num!=0 )? $other_pre / $other_num:0 ?>
                                </td>
                        ...
                        <table class="tg table table-header-rotated" id="testTable6">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $eight_stu_center_manpower_num = $total_school_summit['eight_stu_center_manpower_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $eight_stu_center_manpower_pre = $total_school_summit['eight_stu_center_manpower_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $eight_stu_center_general_num = $total_school_summit['eight_stu_center_general_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $eight_stu_center_general_pre = $total_school_summit['eight_stu_center_general_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $eight_stu_shakha_manpower_num = $total_school_summit['eight_stu_shakha_manpower_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $eight_stu_shakha_manpower_pre = $total_school_summit['eight_stu_shakha_manpower_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $eight_stu_shakha_general_num = $total_school_summit['eight_stu_shakha_general_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $eight_stu_shakha_general_pre = $total_school_summit['eight_stu_shakha_general_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $nine_stu_center_manpower_num = $total_school_summit['nine_stu_center_manpower_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $nine_stu_center_manpower_pre = $total_school_summit['nine_stu_center_manpower_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $nine_stu_center_general_num = $total_school_summit['nine_stu_center_general_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $nine_stu_center_general_pre = $total_school_summit['nine_stu_center_general_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $nine_stu_shakha_manpower_num = $total_school_summit['nine_stu_shakha_manpower_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $nine_stu_shakha_manpower_pre = $total_school_summit['nine_stu_shakha_manpower_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $nine_stu_shakha_general_num = $total_school_summit['nine_stu_shakha_general_num'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $nine_stu_shakha_general_pre = $total_school_summit['nine_stu_shakha_general_pre'] ?>
                                </td>
                                <td class="tg-0pky">
                    ...
                    <table class="tg table table-header-rotated" id="testTable7">
                        ...
                        <tr>
                            ...
                            <?php echo $shikkha_central_s=$total_school_training_program['shikkha_central_s'] ?>
                            </td>
                            <td class="tg-0pky  type_2">
                            <?php echo $shikkha_central_p=$total_school_training_program['shikkha_central_p'] ?>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="tg-0pky type_1">
                            <?php echo $shikkha_shakha_s=$total_school_training_program['shikkha_shakha_s'] ?>
                            </td>
                            <td class="tg-0pky  type_2">
                            <?php echo $shikkha_shakha_p=$total_school_training_program['shikkha_shakha_p'] ?>
                            </td>
                            <td class="tg-0pky  type_3">
                        ...
                        <tr>
                            ...
                            <td class="tg-0pky type_1">
                            <?php echo $kormoshala_central_s=$total_school_training_program['kormoshala_central_s'] ?>
                            </td>
                            <td class="tg-0pky  type_2">
                            <?php echo $kormoshala_central_p=$total_school_training_program['kormoshala_central_p'] ?>
                            </td>
                            <td class="tg-0pky  type_3">
                        ...
                        <tr>
                            ...
                            <td class="tg-0pky type_1">
                            <?php echo $kormoshala_shakha_s=$total_school_training_program['kormoshala_shakha_s'] ?>
                            </td>
                            <td class="tg-0pky  type_2">
                            <?php echo $kormoshala_shakha_p=$total_school_training_program['kormoshala_shakha_p'] ?>
                            </td>
                            <td class="tg-0pky  type_3">
