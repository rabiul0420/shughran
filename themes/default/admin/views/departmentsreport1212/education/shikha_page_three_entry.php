                ...
                <div class="table-responsive">
                    ...
                    <table class="tg table table-header-rotated" id="testTable1">
                            <tr>
                                ...
                                <a href="#" id='table_1' onclick="doit('xlsx','testTable1','<?php echo 'Education_প্রফেশনাল আউটপুট-০১ (জনসেবা)_'.$branch_id.'.xlsx' ?>');  return false;"><i class="icon fa fa-file-excel-o"></i> <?= lang('export_to_excel') ?> 	</a>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table class="tg table table-header-rotated" id="testTable2">
                            <tr>
                                ...
                                <a href="#" id='table_2' onclick="doit('xlsx','testTable2','<?php echo 'Education_প্রফেশনাল আউটপুট-০২ (মানবসেবা)_'.$branch_id.'.xlsx' ?>');  return false;"><i class="icon fa fa-file-excel-o"></i> <?= lang('export_to_excel') ?> 	</a>
                                </td>
                            </tr>
                            <tr>
                                <td class="tg-pwj7" rowspan="2">মান</td>
...
<tr>
                        ...
                        <table class="tg table table-header-rotated" id="testTable4">
                            <tr>
                                ...
                                <td class="tg-pwj7" colspan="4">
                                <a href="#" id='table_4' onclick="doit('xlsx','testTable4','<?php echo 'Education_প্রফেশনাল আউটপুট-০৪ (অন্যান্য)_'.$branch_id.'.xlsx' ?>');  return false;"><i class="icon fa fa-file-excel-o"></i> <?= lang('export_to_excel') ?> 	</a>
                                </td>
                            </tr>
                            <tr>
