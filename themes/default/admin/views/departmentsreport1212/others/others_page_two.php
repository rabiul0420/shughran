        ...
        for(let i=1; i<=12;i++)
        {
            $("#table_"+i).click();
                ...
                <table class="tg table table-header-rotated" id="testTable1">
                            ...
                            <?php 
                                $i=0;
                            foreach($total_other_e_sathi_shakha_briddhi->result_array() as $row) 
                                    {
                                    $i++;
                                ?>
                        ...
                        <table class="tg table table-header-rotated" id="testTable2">
                            ...
                            <?php 
                                $i=0;
                            foreach($total_other_e_sathi_shakha_ghatti->result_array() as $row) 
                                    {
                                    $i++;
                                ?>
                        ...
                        <table class="tg table table-header-rotated" id="testTable3">
                            ...
                            <?php 
                                $i=0;
                            foreach($total_other_s_protishthan_shong_ghatti->result_array() as $row) 
                                    {
                                    $i++;
                                ?>
