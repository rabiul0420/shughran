                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        foreach ($thanas as $thana)
                            $dt_org[$thana->id] = $thana->thana_name;

                        echo form_dropdown('thana_id', $dt_org, '', 'id="thana_id"  class="form-control select" style="width:100%;" required="required" ');
                        ?>
                    </div>
