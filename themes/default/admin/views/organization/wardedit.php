...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("organization/editward/" . $thana->id . '/2', $attrib); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="form-group is_attached_section"
                        style="<?= $thana->is_attached == 1 || $thana->is_attached == 2 ? '' : 'display:none;' ?>">
                        <?= lang('শিক্ষাপ্রতিষ্ঠানের সাথে সংযুক্ত', 'is_attached'); ?>

                        <div class="radio">
                            <input type="radio" class="checkbox" name="is_attached" value="1" <?= $thana->is_attached == 1 ? 'checked' : '' ?> />
                            <label class="padding05"><?= 'হ্যাঁ' ?></label>
                        </div>

                        <div class="radio">
                            <input type="radio" class="checkbox" name="is_attached" value="2" <?= $thana->is_attached == 2 ? 'checked' : '' ?>>
                    ...
                    <div class="form-group">
                        ...
                        <?= form_input('supporter_organization', set_value('supporter_organization', $thana->supporter_organization), 'class="form-control tip" id="supporter_organization" required="required" '); ?>
                    </div>
