...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#PRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('associate/getAssociate'.($branch_id ? '/'.$branch_id : '')) ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-barcode"></i><?= 'সাথী' . ' (' . ($branch_id ? $branch->name : 'সকল শাখা') . ')'; ?>
        </h2>
        ...
        <div class="box-icon">
			...
			<li class="dropdown">
                    <a href="<?= admin_url('associate/add') ?>">
                        <i class="icon fa fa-tasks" data-placement="left" title="<?= lang("actions") ?>"><?= ' সাথী বৃদ্ধি করুন' ?></i>
                    </a>
			          ...
			          <li>	
                            <a href="<?= admin_url('associate/export'.($branch_id ? '/'.$branch_id : '')) ?>" id="excel_export" data-action="export_excel">	
                                <i class="icon fa fa-file-excel-o"></i> <?= lang('export') ?>	
                            </a>	
                        </li>
                        ...
                        <li>	
                            <a href="<?= admin_url('manpower/update_info'.($branch_id ? '/'.$branch_id : '').'/2') ?>" data-toggle="modal" data-target="#myModal">	
                ...
                <?php if (!empty($branches)) { ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?= admin_url('associate') ?>"><i class="fa fa-building-o"></i> <?= 'সকল শাখা' ?></a></li>
                            <li class="divider"></li>
                            <?php
                            foreach ($branches as $branch) {
                                echo '<li><a href="' . admin_url('associate/' . $branch->id) . '"><i class="fa fa-building"></i>' . $branch->name . '</a></li>';
                            }
                            ?>
                        </ul>
                    </li>
                ...
                <div class="table-responsive">
                    <table id="PRData" class="table table-bordered table-condensed table-hover table-striped">
                        ...
                        <tr class="active">
							...
							<th style="width:65px; text-align:center;"><?= "Postpone" ?></th> 
