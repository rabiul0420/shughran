...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo 'ঘাটতি ' . " (" . $manpower->associatecode . ")".': '. $process->process; ?></h4>
        </div>
        
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form','id'=>'decrease_associate','autocomplete'=>'off');
        echo admin_form_open_multipart("associate/associatedecrease/" . $manpower->id."/".$process->id, $attrib); ?>
...
<div class="col-md-6">
	...
	<?php if(in_array($process->id,array(1,12,18))){ ?> 
...
<div class="col-md-12">
	...
	<?php }?>	
        ...
        <div class="modal-footer">
            <?php echo form_submit('associatedecrease', 'Submit', 'class="btn btn-primary associatedecrease"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
...
<script>
 ...
 $("#decrease_associate2").submit(function(e) {
