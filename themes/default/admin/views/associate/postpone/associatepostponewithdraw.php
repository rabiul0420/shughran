...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("associate/associatepostponewithdraw/" . $info->id, $attrib); ?>
...
<div class="col-md-12">
        ...
        <div class="modal-footer">
            <?php echo form_submit('associatepostponewithdraw', 'Submit', 'class="btn btn-primary memberdecrease"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
