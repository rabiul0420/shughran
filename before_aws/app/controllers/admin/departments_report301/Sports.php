...
class Sports extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        if ($this->session->userdata('group_id') == 8 && $this->session->userdata('department_id') == 28) { //literature
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_sports_tournament'] = $this->db->get('sports_tournament')->first_row('array');
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_sports_program'] = $this->db->get('sports_program')->first_row('array');
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_sports_bektigoto_dokkhota'] = $this->db->get('sports_bektigoto_dokkhota')->first_row('array');
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_sports_kria_jonoshoktir_porishokngkhan'] = $this->db->get('sports_kria_jonoshoktir_porishokngkhan')->first_row('array');
        }
        else{
            $this->db->select('*');
            if ($branch_id)
    ...
    public function sports_page_two($branch_id = null)
    {
        ...
        if ((!$branch_id)  || ($branch_id && $report_type['is_current'] == false)) {
            ...
            if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            $this->data['total_sports_club'] = $this->db->get('sports_club')->first_row('array');
            ...
            if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            $this->data['total_sports_team_number'] = $this->db->get('sports_team_number')->first_row('array');
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_sports_contact'] = $this->db->get('sports_contact');
            ...
            if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            $this->data['total_sports_sastho_shochetonota'] = $this->db->get('sports_sastho_shochetonota')->first_row('array');
            ...
            if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            $this->data['total_sports_training_program'] = $this->db->get('sports_training_program')->first_row('array');
