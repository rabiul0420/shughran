...
class Manpower extends MY_Controller
{
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_human_management_songothon'] = $this->db->get('human_management_songothon')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_human_management_songothon_row'] = $query->num_rows();
        ...
        $this->data['total_human_managemant_jonobol_shorboraho'] = $this->db->get('human_managemant_jonobol_shorboraho')->first_row('array');
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_human_management_training_program'] = $this->db->get('human_management_training_program')->first_row('array');
