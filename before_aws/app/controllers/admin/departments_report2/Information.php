...
class Information extends MY_Controller
{
    ...
    function __construct()
    {
		...
		if(   $this->session->userdata('group_id')== 8 && $this->session->userdata('department_id')!=27) {
		 ...
		 if(  $this->session->userdata('group_id')== 8 && $this->session->userdata('department_id') ==27) {  //literature
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_information_nij_shakha_theke_prokashito_prokashona'] = $this->db->get('information_nij_shakha_theke_prokashito_prokashona')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"'); 
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');  
        $this->data['total_information_chobi_songroho'] = $this->db->get('information_chobi_songroho')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"'); 
        ...
        $this->data['total_information_vedio_sonrokkhon'] = $this->db->get('information_vedio_sonrokkhon')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');  
        ...
        $this->data['total_information_potrika_online_tv_kating_songroho'] = $this->db->get('information_potrika_online_tv_kating_songroho')->first_row('array');
