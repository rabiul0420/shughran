...
class Publicity extends MY_Controller
{
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_publicity_manpower'] = $this->db->get('publicity_manpower')->first_row('array');
       
        if ($branch_id)
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');

        $this->data['total_publicity_manpower_row'] = $this->db->get('publicity_manpower')->num_rows();
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_publicity_online_activity'] = $this->db->get('publicity_online_activity')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_publicity_shakhar_online_news_media'] = $this->db->get('publicity_shakhar_online_news_media')->first_row('array');
       
        if ($branch_id)
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');

        $this->data['total_publicity_shakhar_row'] = $this->db->get('publicity_shakhar_online_news_media')->num_rows();
        ...
        $this->data['total_publicity_shova_shomuho'] = $this->db->get('publicity_shova_shomuho')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_publicity_training_program'] = $this->db->get('publicity_training_program')->first_row('array');
    ...
    $this->data['total_publicity_contact'] = $this->db->get('publicity_contact')->first_row('array');
...
$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
    ...
    $this->data['total_publicity_amader_collection'] = $this->db->get('publicity_amader_collection')->first_row('array');
    ...
    $this->data['total_publicity_shoujonno'] = $this->db->get('publicity_shoujonno')->first_row('array');
