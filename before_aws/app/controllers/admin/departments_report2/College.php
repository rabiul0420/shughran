...
class College extends MY_Controller
{
    ...
    function __construct()
    {
		...
		if(   $this->session->userdata('group_id')== 8 && $this->session->userdata('department_id')!=21) {
		 ...
		 if(  $this->session->userdata('group_id')== 8 && $this->session->userdata('department_id') ==21) {  //literature
    ...
    {  
        ...
        $this->data['total_college_shongothon'] = $this->db->get('college_shongothon')->first_row('array');
        }
        else{
            $this->db->select('*');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_college_manpower_dawat'] = $this->db->get('college_manpower_dawat')->first_row('array');
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_college_akorshon_program'] = $this->db->get('college_akorshon_program')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_college_hsc_result'] = $this->db->get('college_hsc_result')->first_row('array');
    ...
    { 
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_college_vorti_supervision'] = $this->db->get('college_vorti_supervision')->first_row('array');
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_college_ideal_home'] = $this->db->get('college_ideal_home')->first_row('array');
        ...
        if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_college_bridging_1'] = $this->db->get('college_bridging_1')->first_row('array');
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_college_bridging_2'] = $this->db->get('college_bridging_2')->first_row('array');
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_college_summit'] = $this->db->get('college_summit')->first_row('array');
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_college_training_program'] = $this->db->get('college_training_program')->first_row('array');
    }
    else{
        $this->db->select('*');
        $this->db->where('branch_id',$branch_id);
