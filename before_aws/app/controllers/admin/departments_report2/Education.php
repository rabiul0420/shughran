...
class Education extends MY_Controller
{
    ...
    function shikha_page_one($branch_id = NULL)
    {
        ...
        if ((!$branch_id)  || ($branch_id && $report_type['is_current'] == false)) {
            ...
            $this->data['total_education_edu_committee'] = $this->db->get('education_edu_committee')->first_row('array');
            ...
            $this->data['total_education_ideal_home'] = $this->db->get('education_ideal_home')->first_row('array');
            ...
            $this->data['total_education_scholarship'] = $this->db->get('education_scholarship')->first_row('array');
        } else {
            $this->db->select('*');
            $this->db->where('branch_id', $branch_id);
    ...
    function shikha_page_three($branch_id = NULL)
    {
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_education_pro_output_1'] = $this->db->get('education_pro_output_1')->first_row('array');
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_education_pro_output_2'] = $this->db->get('education_pro_output_2')->first_row('array');
            ...
            $this->data['total_education_pro_output_3'] = $this->db->get('education_pro_output_3')->first_row('array');
            ...
            $this->data['total_education_pro_output_4'] = $this->db->get('education_pro_output_4')->first_row('array');
        } else {
    ...
    function shikha_page_two($branch_id = NULL)
    {
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_education_motivational_program'] = $this->db->get('education_motivational_program')->first_row('array');
            ...
            if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            $this->data['total_education_coaching'] = $this->db->get('education_coaching')->first_row('array');
            ...
            if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            $this->data['total_education_summit'] = $this->db->get('education_summit')->first_row('array');
            ...
            if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            $this->data['total_education_training_program'] = $this->db->get('education_training_program')->first_row('array');
        } else {
            $this->db->select('*');
            $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
