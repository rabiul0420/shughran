...
class International extends MY_Controller
{
    ...
    {  
        ...
        $this->data['total_international_higher_study_program'] = $this->db->get('international_higher_study_program')->first_row('array');
        ...
        $this->data['total_international_language_learn'] = $this->db->get('international_language_learn')->first_row('array');
        ...
        if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_international_training_program'] = $this->db->get('international_training_program')->first_row('array');
    ...
    function international_page_two($branch_id = NULL)
    {
        ...
        if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_international_others'] = $this->db->get('international_others')->first_row('array');
        ...
        if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_international_pro_outuput'] = $this->db->get('international_pro_outuput')->first_row('array');
