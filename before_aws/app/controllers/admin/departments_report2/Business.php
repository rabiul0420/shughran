...
class Business extends MY_Controller
{
    ...
    public function business_page_one($branch_id = null)
    {
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_business_studies'] = $this->db->get('business_studies')->first_row('array');
            
            if ($branch_id)
            $this->db->where('branch_id', $branch_id);
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');

            $this->data['total_business_studies_row'] = $this->db->get('business_studies')->num_rows();
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_business_studies_manpower'] = $this->db->get('business_studies_manpower')->first_row('array');
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_business_studies_talika'] = $this->db->get('business_studies_talika')->first_row('array');
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_business_studies_high_study_shomporkito'] = $this->db->get('business_studies_high_study_shomporkito')->first_row('array');
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_business_studies_business_club'] = $this->db->get('business_studies_business_club')->first_row('array');
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_business_studies_bishesh_program'] = $this->db->get('business_studies_bishesh_program')->first_row('array');
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_business_studies_training_program'] = $this->db->get('business_studies_training_program')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_business_studies_academic_output'] = $this->db->get('business_studies_academic_output')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_business_studies_pro_outpur_degree'] = $this->db->get('business_studies_pro_outpur_degree')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_business_studies_pro_output_pro_degree'] = $this->db->get('business_studies_pro_output_pro_degree')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_business_studies_pro_output_business'] = $this->db->get('business_studies_pro_output_business')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_business_studies_summit'] = $this->db->get('business_studies_summit')->first_row('array');
