...
class Library extends MY_Controller
{
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_pathagar_birdhi_garthi'] = $this->db->get('pathagar_birdhi_garthi')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_pathagar_register'] = $this->db->get('pathagar_register')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_pathagar_mosque'] = $this->db->get('pathagar_mosque')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_pathagar_training_program'] = $this->db->get('pathagar_training_program')->first_row('array');
