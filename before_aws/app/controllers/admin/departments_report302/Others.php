...
class Others extends MY_Controller
{
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_other_shang_sofor'] = $this->db->get('other_shang_sofor')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_other_e_briddhi_ward'] = $this->db->get('other_e_briddhi_ward');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->db->order_by('branch_id');
        $this->data['total_other_e_ghatti_ward'] = $this->db->get('other_e_ghatti_ward');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->db->order_by('branch_id');
        $this->data['total_other_e_briddhi_thana'] = $this->db->get('other_e_briddhi_thana');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->db->order_by('branch_id');
        $this->data['total_other_e_ghatti_thana'] = $this->db->get('other_e_ghatti_thana');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->db->order_by('branch_id');
        $this->data['total_other_e_sathi_shakha_briddhi'] = $this->db->get('other_e_sathi_shakha_briddhi');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->db->order_by('branch_id');
        $this->data['total_other_e_sathi_shakha_ghatti'] = $this->db->get('other_e_sathi_shakha_ghatti');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->db->order_by('branch_id');
        $this->data['total_other_s_protishthan_shong_ghatti'] = $this->db->get('other_s_protishthan_shong_ghatti');
    ...
    {  
        ...
        $this->data['total_other_uposhakha_mojbuti'] = $this->db->get('other_uposhakha_mojbuti')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_other_e_uposhakha_briddhi'] = $query;
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_other_e_uposhakha_ghatti'] = $query;
    ...
    {  
        ...
        if ((!$branch_id)  || ($branch_id && $report_type['is_current'] == false)) {
         ...
         $this->db->where('branch_id', $branch_id);
     $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
         $this->data['total_other_shopta_doshok_pokkho_palon'] = $this->db->get('other_shopta_doshok_pokkho_palon')->first_row('array');
        
         if ($branch_id)
         $this->db->where('branch_id', $branch_id);
     $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
         $this->data['total_row_other_shopta_doshok_pokkho_palon'] = $this->db->get('other_shopta_doshok_pokkho_palon')->num_rows();
         ...
         $this->db->where('branch_id', $branch_id);
     $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
         $this->data['total_other_output_plan'] = $this->db->get('other_output_plan')->first_row('array');
        
         if ($branch_id)
         $this->db->where('branch_id', $branch_id);
     $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
         $this->data['total_row_other_output_plan'] = $this->db->get('other_output_plan')->num_rows();
         ...
         $this->data['total_other_chatro_sonshod'] = $query;
    ...
    {  
        ...
        if ((!$branch_id)  || ($branch_id && $report_type['is_current'] == false)) {
            ...
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
                ...
                $this->data['total_other_sofor_report'] = $query;
            ...
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
                ...
                $this->data['total_other_sofor_nayebe_amir'] = $query; 
                
                $this->db->select('*');
                $this->data['total_other_sofor_list_1'] = $this->db->get('other_sofor_list_1');
            
                $this->db->select('*');
                $this->data['total_other_sofor_list_2'] = $this->db->get('other_sofor_list_2');
...
{  
    ...
    if ((!$branch_id)  || ($branch_id && $report_type['is_current'] == false)) {
        ...
        $this->data['other_others_songothon'] = $this->db->get('other_others_songothon');
           ...
           $this->data['total_other_others_songothon'] = $this->db->get('other_others_songothon');
...
{  
    ...
    if ((!$branch_id)  || ($branch_id && $report_type['is_current'] == false)) {
            ...
            $this->data['total_other_comments'] = $this->db->get('other_comments');
