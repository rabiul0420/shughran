...
class Culture extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        if ($this->session->userdata('group_id') == 8 && $this->session->userdata('department_id') == 16) { //literature
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_culture_manpower'] = $this->db->get('culture_manpower')->first_row('array');
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_culture_dawat'] = $this->db->get('culture_dawat')->first_row('array');
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_culture_shova'] = $this->db->get('culture_shova')->first_row('array');
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_culture_shongothon'] = $this->db->get('culture_shongothon')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_culture_name'] = $this->db->get('culture_name');
		}
		else{
    ...
    public function culture_page_two($branch_id = null)
    {
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_culture_contact'] = $this->db->get('culture_contact')->first_row('array');
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_culture_prokashona'] = $this->db->get('culture_prokashona')->first_row('array');
       ...
       $this->db->select_sum('shobbedari_pre');
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_culture_regular_training'] = $this->db->get('culture_regular_training')->first_row('array');
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_culture_workshop'] = $this->db->get('culture_workshop')->first_row('array');
        }
        else{  $this->db->select('*');
            if ($branch_id)
            $this->db->where('branch_id', $branch_id);
    ...
    public function culture_page_three($branch_id = null)
    {
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_culture_poribeshona'] = $this->db->get('culture_poribeshona')->first_row('array');
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_culture_it_prochar_media_upload'] = $this->db->get('culture_it_prochar_media_upload')->first_row('array');
        ...
        if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_culture_it_prochar_media_news_prokash'] = $this->db->get('culture_it_prochar_media_news_prokash')->first_row('array');
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_culture_bishes_karjokrom'] = $this->db->get('culture_bishes_karjokrom')->first_row('array');
        ...
        if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_culture_output_report'] = $this->db->get('culture_output_report')->first_row('array');
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_culture_summit'] = $this->db->get('culture_summit')->first_row('array');
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_culture_training_program'] = $this->db->get('culture_training_program')->first_row('array');
