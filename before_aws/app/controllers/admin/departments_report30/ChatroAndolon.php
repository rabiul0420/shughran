...
class ChatroAndolon extends MY_Controller
{
    ...
    function __construct()
    {
		...
		if(   $this->session->userdata('group_id')== 8 && $this->session->userdata('department_id')!=14) {
		 ...
		 if(  $this->session->userdata('group_id')== 8 && $this->session->userdata('department_id') ==14) {  //literature
    ...
    {  
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_chatroandolon_songothon'] = $this->db->get('chatroandolon_songothon')->first_row('array');
            ...
            $this->data['total_chatroandolon_bivag_jogajog'] = $this->db->get('chatroandolon_bivag_jogajog')->first_row('array');
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
			...
			$this->data['total_chatroandolon_training_program'] = $this->db->get('chatroandolon_training_program')->first_row('array');
