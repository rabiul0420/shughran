...
class Research extends MY_Controller
{
    ...
    function __construct()
    {
		...
		if(   $this->session->userdata('group_id')== 8 && $this->session->userdata('department_id')!=22) {
		 ...
		 if(  $this->session->userdata('group_id')== 8 && $this->session->userdata('department_id') ==22) {  //literature
    ...
    function research_page_one($branch_id = NULL)
    {
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_gobeshona_shikkha_kathamo'] = $this->db->get('gobeshona_shikkha_kathamo')->first_row('array');

            if ($branch_id)
            $this->db->where('branch_id', $branch_id);
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');

            $this->data['total_gobeshona_shikkha_kathamo_row'] = $this->db->get('gobeshona_shikkha_kathamo')->num_rows();
            ...
            $this->data['total_gobeshona_shomprikto_jonoshokti'] = $this->db->get('gobeshona_shomprikto_jonoshokti')->first_row('array');
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_gobeshona_regular_program'] = $this->db->get('gobeshona_regular_program')->first_row('array');
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_gobeshona_bishesh_program'] = $this->db->get('gobeshona_bishesh_program')->first_row('array');
            ...
            $this->data['total_gobeshona_bivag_jogajog'] = $this->db->get('gobeshona_bivag_jogajog')->first_row('array');
        }
        else{
            $this->db->select('*');
            $this->db->where('branch_id',$branch_id);
    ...
    {  
        ...
        if ((!$branch_id)  || ($branch_id && $report_type['is_current'] == false)) {
            ...
            $this->data['total_gobeshona_lekhalekhi'] = $this->db->get('gobeshona_lekhalekhi')->first_row('array');
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_gobeshona_training_program'] = $this->db->get('gobeshona_training_program')->first_row('array');
