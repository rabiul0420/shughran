...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#PRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('manpower/getPostpone'.($branch_id ? '/'.$branch_id : '')) ?>',
...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                 <li>	
                             <a href="<?= admin_url('manpower/exportpostpone'.($branch_id ? '/'.$branch_id : '')) ?>" id="excel_export" data-action="export_excel">	
                ...
                <div class="table-responsive">
                    <table id="PRData" class="table table-bordered table-condensed table-hover table-striped">
                        ...
                        <tr class="active">
                            ...
                            <th></th>
                            <th></th>
                             <th style="width:65px; text-align:center;"><?= "প্রত্যাহার " ?></th> 
