                    ...
                    <div class="tg-wrap">
                        <table class="tg table table-header-rotated" id="testTable1">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $sod_s = $it_jonoshoktiorisors['sod_s'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $sod_pltpa = $it_jonoshoktiorisors['sod_pltpa'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                                <?php echo $sod_adphna = $it_jonoshoktiorisors['sod_adphna'] ?>
                                </td>
                                <td class="tg-0pky  type_4">
                                 <?php echo $sod_ena = $it_jonoshoktiorisors['sod_ena'] ?>
                                </td>
                                <td class="tg-0pky  type_5">
                                 <?php echo $sod_nmble_enrj = $it_jonoshoktiorisors['sod_nmble_enrj'] ?>
                                </td>
                                <td class="tg-0pky  type_6">
                                  <?php echo $sod_nmble_bnl = $it_jonoshoktiorisors['sod_nmble_bnl'] ?>
                                </td>
                                <td class="tg-0pky  type_7">
                                 <?php echo $sod_fbkpk = $it_jonoshoktiorisors['sod_fbkpk'] ?>
                                </td>
                                <td class="tg-0pky  type_8">
                                <?php echo $sod_tutkpk = $it_jonoshoktiorisors['sod_tutkpk'] ?>
                                </td>
                                <td class="tg-0pky  type_9">
                                 <?php echo $sod_itap = $it_jonoshoktiorisors['sod_itap'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                 <?php echo $sat_s = $it_jonoshoktiorisors['sat_s'] ?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $sat_pltpa = $it_jonoshoktiorisors['sat_pltpa'] ?>
                                </td>
                                <td class="tg-0pky">
                               <?php echo $sat_adphna = $it_jonoshoktiorisors['sat_adphna'] ?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $sat_ena = $it_jonoshoktiorisors['sat_ena'] ?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $sat_nmble_enrj = $it_jonoshoktiorisors['sat_nmble_enrj'] ?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $sat_nmble_bnl = $it_jonoshoktiorisors['sat_nmble_bnl'] ?>
                                </td>
                                <td class="tg-0pky">
                                 <?php echo $sat_fbkpk = $it_jonoshoktiorisors['sat_fbkpk'] ?>
                                </td>
                                <td class="tg-0pky">
                                 <?php echo $sat_tutkpk = $it_jonoshoktiorisors['sat_tutkpk'] ?>
                                </td>
                                <td class="tg-0pky  type_9">
                                <?php echo $sat_itap = $it_jonoshoktiorisors['sat_itap'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                  <?php echo $kor_s = $it_jonoshoktiorisors['kor_s'] ?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $kor_pltpa = $it_jonoshoktiorisors['kor_pltpa'] ?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $kor_adphna = $it_jonoshoktiorisors['kor_adphna'] ?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $kor_ena = $it_jonoshoktiorisors['kor_ena'] ?>
                                </td>
                                <td class="tg-0pky">
                                 <?php echo $kor_ena = $it_jonoshoktiorisors['kor_nmble_enrj'] ??0?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $kor_nmble_bnl = $it_jonoshoktiorisors['kor_nmble_bnl'] ?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $kor_fbkpk = $it_jonoshoktiorisors['kor_fbkpk'] ?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $kor_tutkpk = $it_jonoshoktiorisors['kor_tutkpk'] ?>
                                </td>
                                <td class="tg-0pky  type_9">
                                <?php echo $kor_itap = $it_jonoshoktiorisors['kor_itap'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                <?php echo ($sod_nmble_enrj+$sat_nmble_enrj+($kor_nmble_enrj ?? 0))?>
                                </td>
                                <td class="tg-0pky">
                        ...
                        <table class="tg table table-header-rotated" id="testTable2">
                            ...
                            <tr>
                                <td class="tg-y698 type_1"> সদস্য	</td>
                                <td class="tg-0pky  type_1">
                                    <?php echo $sod_mio = $it_dept_jonoshoktir_dokkhota['sod_mio'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $sod_miax = $it_dept_jonoshoktir_dokkhota['sod_miax'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                                <?php echo $sod_mipp = $it_dept_jonoshoktir_dokkhota['sod_mipp'] ?>
                                </td>
                                <td class="tg-0pky  type_4">
                                 <?php echo $sod_vdoe = $it_dept_jonoshoktir_dokkhota['sod_vdoe'] ?>
                                </td>
                                <td class="tg-0pky  type_5">
                                 <?php echo $sod_gdp = $it_dept_jonoshoktir_dokkhota['sod_gdp'] ?>
                                </td>
                                <td class="tg-0pky  type_6">
                                  <?php echo $sod_gde = $it_dept_jonoshoktir_dokkhota['sod_gde'] ?>
                                </td>
                                <td class="tg-0pky  type_7">
                                 <?php echo $sod_web = $it_dept_jonoshoktir_dokkhota['sod_web'] ?>
                                </td>
                                <td class="tg-0pky  type_8">
                                <?php echo $sod_app = $it_dept_jonoshoktir_dokkhota['sod_app'] ?>
                                </td>
                                <td class="tg-0pky  type_9">
                                 <?php echo $sod_it = $it_dept_jonoshoktir_dokkhota['sod_it'] ?>
                                </td>
                            ...
                            <tr>
                                <td class="tg-y698">সাথী </td>
                                <td class="tg-0pky">
                                 <?php echo $sat_mio = $it_dept_jonoshoktir_dokkhota['sat_mio'] ?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $sat_miax = $it_dept_jonoshoktir_dokkhota['sat_miax'] ?>
                                </td>
                                <td class="tg-0pky">
                               <?php echo $sat_mipp = $it_dept_jonoshoktir_dokkhota['sat_mipp'] ?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $sat_vdoe = $it_dept_jonoshoktir_dokkhota['sat_vdoe'] ?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $sat_gdp = $it_dept_jonoshoktir_dokkhota['sat_gdp'] ?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $sat_gde = $it_dept_jonoshoktir_dokkhota['sat_gde'] ?>
                                </td>
                                <td class="tg-0pky">
                                 <?php echo $sat_web = $it_dept_jonoshoktir_dokkhota['sat_web'] ?>
                                </td>
                                <td class="tg-0pky">
                                 <?php echo $sat_app = $it_dept_jonoshoktir_dokkhota['sat_app'] ?>
                                </td>
                                <td class="tg-0pky  type_9">
                                <?php echo $sat_it = $it_dept_jonoshoktir_dokkhota['sat_it'] ?>
                                </td>
                            ...
                            <tr>
                                <td class="tg-y698">কর্মী </td>
                                <td class="tg-0pky">
                                  <?php echo $kor_mio = $it_dept_jonoshoktir_dokkhota['kor_mio'] ?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $kor_miax = $it_dept_jonoshoktir_dokkhota['kor_miax'] ?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $kor_mipp = $it_dept_jonoshoktir_dokkhota['kor_mipp'] ?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $kor_vdoe = $it_dept_jonoshoktir_dokkhota['kor_vdoe'] ?>
                                </td>
                                <td class="tg-0pky">
                                 <?php echo $kor_gdp = $it_dept_jonoshoktir_dokkhota['kor_gdp'] ?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $kor_gde = $it_dept_jonoshoktir_dokkhota['kor_gde'] ?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $kor_web = $it_dept_jonoshoktir_dokkhota['kor_web'] ?>
                                </td>
                                <td class="tg-0pky">
                                <?php echo $kor_app = $it_dept_jonoshoktir_dokkhota['kor_app'] ?>
                                </td>
                                <td class="tg-0pky  type_9">
                                <?php echo $kor_it = $it_dept_jonoshoktir_dokkhota['kor_it'] ?>
                                </td>
                        ...
                        <table class="tg table table-header-rotated" id="testTable3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $s_ose_bm = $it_dept_shakhar_online_risors['s_ose_bm'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $s_ose_br = $it_dept_shakhar_online_risors['s_ose_br'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                                <?php echo $s_fbpj_bm = $it_dept_shakhar_online_risors['s_fbpj_bm'] ?>
                                </td>
                                <td class="tg-0pky  type_4">
                                <?php echo $s_fbpj_br = $it_dept_shakhar_online_risors['s_fbpj_br'] ?>
                                </td>
                                <td class="tg-0pky  type_5">
                                  <?php echo $s_tuta_bm = $it_dept_shakhar_online_risors['s_tuta_bm'] ?>
                                </td>
                                <td class="tg-0pky  type_6">
                                  <?php echo $s_tuta_br = $it_dept_shakhar_online_risors['s_tuta_br'] ?>
                                </td>
                                <td class="tg-0pky  type_7">
                                 <?php echo $s_youtub_bm = $it_dept_shakhar_online_risors['s_youtub_bm'] ?>
                                </td>
                                <td class="tg-0pky  type_8">
                                  <?php echo $s_youtub_br = $it_dept_shakhar_online_risors['s_youtub_br'] ?>
                                </td>
                                </td>
                                <td class="tg-0pky  type_9">
                                <?php echo $s_onnoannososhal = $it_dept_shakhar_online_risors['s_onnoannososhal'] ?>
                                </td>
                ...
                <table class="tg table table-header-rotated" id="testTable4">
                   ...
                   <tr>
                       ...
                       <td class="tg-0pky  type_9">
                            ...
                            <?php echo $bscmput_s =  (isset( $it_proshikkhon['bscmput_s']))? $it_proshikkhon['bscmput_s']:0; $s=$s+$bscmput_s ; ?>
                        
                        </td>
                       <td class="tg-0pky  type_9">
                           
                            <?php echo $bscmput_upthi =  (isset( $it_proshikkhon['bscmput_upthi']))? $it_proshikkhon['bscmput_upthi']:0; $upthi=$upthi+$bscmput_upthi ; ?>
                       ...
                       <td class="tg-y698 type_1"> ফটোশপ	</td>
                        <td class="tg-0pky  type_1">
                            <?php echo $msford_s =  (isset( $it_proshikkhon['msford_s']))? $it_proshikkhon['msford_s']:0; $s=$s+ $msford_s; ?>
                       
                        </td>
                       <td class="tg-0pky  type_9">
                          
                            <?php echo $msford_upthi =  (isset( $it_proshikkhon['msford_upthi']))? $it_proshikkhon['msford_upthi']:0; $upthi=$upthi+ $msford_upthi; ?>
                   ...
                   <tr>
                       ...
                       <td class="tg-0pky  type_9">
                            ...
                            <?php echo $bsmobile_s =  (isset( $it_proshikkhon['bsmobile_s']))? $it_proshikkhon['bsmobile_s']:0; $s=$s+ $bsmobile_s; ?>
                        
                        </td>
                       <td class="tg-0pky  type_9">
                          
                            <?php echo $bsmobile_upthi =  (isset( $it_proshikkhon['bsmobile_upthi']))? $it_proshikkhon['bsmobile_upthi']:0; $upthi=$upthi+$bsmobile_upthi; ?>
                       ...
                       <td class="tg-0pky  type_9">
                            ...
                            <?php echo $eltt_s =  (isset( $it_proshikkhon['eltt_s']))? $it_proshikkhon['eltt_s']:0; $s=$s+ $eltt_s ; ?>
                        
                        </td>
                       <td class="tg-0pky  type_9">
                           
                            <?php echo $eltt_upthi =  (isset( $it_proshikkhon['eltt_upthi']))? $it_proshikkhon['eltt_upthi']:0; $upthi=$upthi+ $eltt_upthi ; ?>
                   ...
                   <tr>
                       ...
                       <td class="tg-0pky  type_9">
                            ...
                            <?php echo $msword_s =  (isset( $it_proshikkhon['msword_s']))? $it_proshikkhon['msword_s']:0; $s=$s+$msword_s ; ?>
                        
                        </td>
                       <td class="tg-0pky  type_9">
                         
                            <?php echo $msword_upthi =  (isset( $it_proshikkhon['msword_upthi']))? $it_proshikkhon['msword_upthi']:0; $upthi=$upthi+$msword_upthi ; ?>
                       ...
                       <td class="tg-0pky  type_9">
                            ...
                            <?php echo $video_s =  (isset( $it_proshikkhon['video_s']))? $it_proshikkhon['video_s']:0; $s=$s+ $video_s; ?>
                        
                        </td>
                       <td class="tg-0pky  type_9">
                          
                            <?php echo $video_upthi =  (isset( $it_proshikkhon['video_upthi']))? $it_proshikkhon['video_upthi']:0; $upthi=$upthi+$video_upthi ; ?>
                   ...
                   <tr>
                       ...
                       <td class="tg-0pky  type_9">
                            ...
                            <?php echo $msfexl_s =  (isset( $it_proshikkhon['msfexl_s']))? $it_proshikkhon['msfexl_s']:0; $s=$s+  $msfexl_s; ?>
                        
                        </td>
                       <td class="tg-0pky  type_9">
                        
                            <?php echo $msfexl_upthi =  (isset( $it_proshikkhon['msfexl_upthi']))? $it_proshikkhon['msfexl_upthi']:0; $upthi=$upthi+ $msfexl_upthi ; ?>
                       ...
                       <td class="tg-0pky  type_9">
                            ...
                            <?php echo $web_s =  (isset( $it_proshikkhon['web_s']))? $it_proshikkhon['web_s']:0; $s=$s+$web_s ; ?>
                        
                        </td>
                       <td class="tg-0pky  type_9">
                         
                            <?php echo $web_upthi =  (isset( $it_proshikkhon['web_upthi']))? $it_proshikkhon['web_upthi']:0; $upthi=$upthi+$web_upthi ; ?>
                   ...
                   <tr>
                       ...
                       <td class="tg-0pky  type_9">
                            ...
                            <?php echo $pwrp_s =  (isset( $it_proshikkhon['pwrp_s']))? $it_proshikkhon['pwrp_s']:0; $s=$s+ $pwrp_s; ?>
                        
                        </td>
                       <td class="tg-0pky  type_9">
                           
                            <?php echo $pwrp_upthi =  (isset( $it_proshikkhon['pwrp_upthi']))? $it_proshikkhon['pwrp_upthi']:0; $upthi=$upthi+ $pwrp_upthi; ?>
                       ...
                       <td class="tg-0pky  type_9">
                            ...
                            <?php echo $apsdpm_s =  (isset( $it_proshikkhon['apsdpm_s']))? $it_proshikkhon['apsdpm_s']:0; $s=$s+$apsdpm_s ; ?>
                        
                        </td>
                       <td class="tg-0pky  type_9">
                         
                            <?php echo $apsdpm_upthi =  (isset( $it_proshikkhon['apsdpm_upthi']))? $it_proshikkhon['apsdpm_upthi']:0; $upthi=$upthi+$apsdpm_upthi ; ?>
                   ...
                   <tr>
                       ...
                       <td class="tg-0pky  type_9">
                            ...
                            <?php echo $fb_s =  (isset( $it_proshikkhon['fb_s']))? $it_proshikkhon['fb_s']:0; $s=$s+ $fb_s; ?>
                        
                        </td>
                       <td class="tg-0pky  type_9">
                         
                            <?php echo $fb_upthi =  (isset( $it_proshikkhon['fb_upthi']))? $it_proshikkhon['fb_upthi']:0; $upthi=$upthi+$fb_upthi ; ?>
                       ...
                       <td class="tg-0pky  type_9">
                            ...
                            <?php echo $bsicint_s =  (isset( $it_proshikkhon['bsicint_s']))? $it_proshikkhon['bsicint_s']:0; $s=$s+$bsicint_s ; ?>
                        
                        </td>
                       <td class="tg-0pky  type_9">
                      
                            <?php echo $bsicint_upthi =  (isset( $it_proshikkhon['bsicint_upthi']))? $it_proshikkhon['bsicint_upthi']:0; $upthi=$upthi+ $bsicint_upthi; ?>
                   ...
                   <tr>
                       ...
                       <td class="tg-0pky  type_9">
                            ...
                            <?php echo $tutr_s =  (isset( $it_proshikkhon['tutr_s']))? $it_proshikkhon['tutr_s']:0; $s=$s+ $tutr_s; ?>
                        
                        </td>
                       <td class="tg-0pky  type_9">
                            
                            <?php echo $tutr_upthi =  (isset( $it_proshikkhon['tutr_upthi']))? $it_proshikkhon['tutr_upthi']:0; $upthi=$upthi+ $tutr_upthi; ?>
                       ...
                       <td class="tg-0pky  type_9">
                            ...
                            <?php echo $onlinept_s =  (isset( $it_proshikkhon['onlinept_s']))? $it_proshikkhon['onlinept_s']:0; $s=$s+$onlinept_s ; ?>
                        
                        </td>
                       <td class="tg-0pky  type_9">
                          
                            <?php echo $onlinept_upthi =  (isset( $it_proshikkhon['onlinept_upthi']))? $it_proshikkhon['onlinept_upthi']:0; $upthi=$upthi+ $onlinept_upthi; ?>
                   ...
                   <tr>
                       ...
                       <td class="tg-0pky  type_9">
                            ...
                            <?php echo $bgbe_s =  (isset( $it_proshikkhon['bgbe_s']))? $it_proshikkhon['bgbe_s']:0; $s=$s+$bgbe_s ; ?>
                        
                        </td>
                       <td class="tg-0pky  type_9">
                         
                            <?php echo $bgbe_upthi =  (isset( $it_proshikkhon['bgbe_upthi']))? $it_proshikkhon['bgbe_upthi']:0; $upthi=$upthi+$bgbe_upthi ; ?>
                       ...
                       <td class="tg-0pky  type_9">
                            ...
                            <?php echo $onlineni_s =  (isset( $it_proshikkhon['onlineni_s']))? $it_proshikkhon['onlineni_s']:0; $s=$s+ $onlineni_s; ?>
                        
                        </td>
                       <td class="tg-0pky  type_9">
                           
                            <?php echo $onlineni_upthi =  (isset( $it_proshikkhon['onlineni_upthi']))? $it_proshikkhon['onlineni_upthi']:0; $upthi=$upthi+ $onlineni_upthi; ?>
                   ...
                   <tr>
                       ...
                       <td class="tg-0pky  type_9">
                            ...
                            <?php echo $ukp_s =  (isset( $it_proshikkhon['ukp_s']))? $it_proshikkhon['ukp_s']:0; $s=$s+ $ukp_s; ?>
                        
                        </td>
                       <td class="tg-0pky  type_9">
                           
                            <?php echo $ukp_upthi =  (isset( $it_proshikkhon['ukp_upthi']))? $it_proshikkhon['ukp_upthi']:0; $upthi=$upthi+$ukp_upthi ; ?>
                       ...
                       <td class="tg-0pky  type_1">
                        <?php echo ($upthi!=0 && $s!=0)?round(($upthi/$s),2):0?>
                       </td>
