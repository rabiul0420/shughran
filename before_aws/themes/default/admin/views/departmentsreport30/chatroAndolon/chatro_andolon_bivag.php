...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-barcode"></i><?= 'ছাত্র আন্দোলন বিভাগ' . ' (' . ($branch_id ? $branch->name : 'সকল শাখা') . ')'; ?>
...
if ($report_info['is_current'] || $report_info['year'] == date('Y')) {
    if ($report_info['type'] == 'annual') {
        echo anchor('admin/departmentsreport/chatro-andolon-bivag' . ($branch_id ? '/' . $branch_id : '') . ('?type=half_yearly&year=' . $report_info['year']), 'ষান্মাসিক ' . $report_info['year']);
        echo  "&nbsp;|&nbsp;" . anchor('admin/departmentsreport/chatro-andolon-bivag' . ($branch_id ? '/' . $branch_id : ''), 'জুলাই-নভেম্বর\'' . $report_info['year']);
        echo "&nbsp;|&nbsp;";
        ...
        echo anchor('admin/departmentsreport/chatro-andolon-bivag' . ($branch_id ? '/' . $branch_id : ''), 'ষান্মাসিক ' . $report_info['year']);
...
<span class="dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="archive">
        ...
        for ($i = date('Y') - 1; $i >= 2019; $i--) {
            ...
            echo   ' <li>' . anchor('admin/departmentsreport/chatro-andolon-bivag' . ($branch_id ? '/' . $branch_id : '') . '?type=half_yearly&year=' . $i, 'ষান্মাসিক ' . $i) . ' </li>';
        }
        ?>
	...
	border: 1px solid #ccc;
                    ...
                    <table class="tg table table-header-rotated" id="testTable5">
                            ...
                            <tr>
                                ...
                                <?php echo $shikkha_central_s=$total_chatroandolon_training_program['shikkha_central_s'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $shikkha_central_p=$total_chatroandolon_training_program['shikkha_central_p'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky type_1">
                                <?php echo $shikkha_shakha_s=$total_chatroandolon_training_program['shikkha_shakha_s'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $shikkha_shakha_p=$total_chatroandolon_training_program['shikkha_shakha_p'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky type_1">
                                <?php echo $kormoshala_central_s=$total_chatroandolon_training_program['kormoshala_central_s'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $kormoshala_central_p=$total_chatroandolon_training_program['kormoshala_central_p'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky type_1">
                                <?php echo $kormoshala_shakha_s=$total_chatroandolon_training_program['kormoshala_shakha_s'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $kormoshala_shakha_p=$total_chatroandolon_training_program['kormoshala_shakha_p'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                        ...
                        <table class="tg table table-header-rotated" id="testTable1">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                <?php echo $side_ss = $total_chatroandolon_songothon['side_ss'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                   <?php echo $side_reg = $total_chatroandolon_songothon['side_reg'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                                   <?php echo $side_n_reg = $total_chatroandolon_songothon['side_n_reg'] ?>
                                </td>
                                <td class="tg-0pky  type_4">
                                   <?php echo $side_inc = $total_chatroandolon_songothon['side_inc'] ?>
                                </td>
                                <td class="tg-0pky  type_5">
                                   <?php echo $side_dec = $total_chatroandolon_songothon['side_dec'] ?>
                                </td>
                                <td class="tg-0pky  type_5">
                                   <?php echo $side_act = $total_chatroandolon_songothon['side_act'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                <?php echo $social_ss = $total_chatroandolon_songothon['social_ss'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                   <?php echo $social_reg = $total_chatroandolon_songothon['social_reg'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                                   <?php echo $social_n_reg = $total_chatroandolon_songothon['social_n_reg'] ?>
                                </td>
                                <td class="tg-0pky  type_4">
                                   <?php echo $social_inc = $total_chatroandolon_songothon['social_inc'] ?>
                                </td>
                                <td class="tg-0pky  type_5">
                                   <?php echo $social_dec = $total_chatroandolon_songothon['social_dec'] ?>
                                </td>
                                <td class="tg-0pky  type_5">
                                   <?php echo $social_act = $total_chatroandolon_songothon['social_act'] ?>
                                </td>
                   ...
                   <table class="tg table table-header-rotated" id="testTable4">	 	
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                <?php echo $kj_shi = $total_chatroandolon_bivag_jogajog['kj_shi'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                   <?php echo $kj_kmkt = $total_chatroandolon_bivag_jogajog['kj_kmkt'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                                   <?php echo $kj_koca = $total_chatroandolon_bivag_jogajog['kj_koca'] ?>
                                </td>
                                <td class="tg-0pky  type_4">
                                   <?php echo $kj_assu = $total_chatroandolon_bivag_jogajog['kj_assu'] ?>
                                </td>
                                <td class="tg-0pky  type_5">
                                   <?php echo $kj_bnsgsa = $total_chatroandolon_bivag_jogajog['kj_bnsgsa'] ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                   <?php echo $kb_shi = $total_chatroandolon_bivag_jogajog['kb_shi'] ?>
                                </td>
                                <td class="tg-0pky">
                                   <?php echo $kb_kmkt = $total_chatroandolon_bivag_jogajog['kb_kmkt'] ?>
                                </td>
                                <td class="tg-0pky">
                                  <?php echo $kb_koca = $total_chatroandolon_bivag_jogajog['kb_koca'] ?>
                                </td>
                                <td class="tg-0pky">
                                   <?php echo $kb_assu = $total_chatroandolon_bivag_jogajog['kb_assu'] ?>
                                </td>
                                <td class="tg-0pky">
                                   <?php echo $kb_bnsgsa = $total_chatroandolon_bivag_jogajog['kb_bnsgsa'] ?>
                                </td>
