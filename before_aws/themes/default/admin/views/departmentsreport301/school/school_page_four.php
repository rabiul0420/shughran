...
if ($report_info['is_current'] || $report_info['year'] == date('Y')) {
    if ($report_info['type'] == 'annual') {
        echo anchor('admin/departmentsreport/school-page-four' . ($branch_id ? '/' . $branch_id : '') . ('?type=half_yearly&year=' . $report_info['year']), 'ষান্মাসিক ' . $report_info['year']);
        echo  "&nbsp;|&nbsp;" . anchor('admin/departmentsreport/school-page-four' . ($branch_id ? '/' . $branch_id : ''), 'জুলাই-নভেম্বর\'' . $report_info['year']);
        echo "&nbsp;|&nbsp;";
        ...
        echo anchor('admin/departmentsreport/school-page-four' . ($branch_id ? '/' . $branch_id : ''), 'ষান্মাসিক ' . $report_info['year']);
...
<span class="dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="archive">
        ...
        for ($i = date('Y') - 1; $i >= 2019; $i--) {
            ...
            echo   ' <li>' . anchor('admin/departmentsreport/school-page-four' . ($branch_id ? '/' . $branch_id : '') . '?type=half_yearly&year=' . $i, 'ষান্মাসিক ' . $i) . ' </li>';
        }
        ?>
				...
				<style type="text/css">
                    ...
                    <table class="tg table table-header-rotated" id="testTable1">
                        ...
                        <table class="tg table table-header-rotated" id="testTable4">
                            <tr>
                                <td class="tg-pwj7" colspan="7"><b>জেএসসি ফলাফল পরিসংখ্যান </b></td>
                                <td class="tg-pwj7" colspan="3">
                                    <a href="#" id='table_4' onclick="doit('xlsx','testTable4','<?php echo 'School_জেএসসি ফলাফল পরিসংখ্যান.xlsx' ?>');  return false;"><i class="icon fa fa-file-excel-o"></i> <?= lang('export_to_excel') ?> 	</a>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $mem_mot_examine = $school_jsc_result['mem_mot_examine'] ; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $mem_gpa_5 = $school_jsc_result['mem_gpa_5'] ;
                                        $total_sodosso += $mem_gpa_5;
                                        $total_mem_gpa_5 += $mem_gpa_5; 
                                    ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php 
                                        echo $mem_a_grade = $school_jsc_result['mem_a_grade'] ; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $mem_a_minus = $school_jsc_result['mem_a_minus'] ; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $mem_b_grade = $school_jsc_result['mem_b_grade'] ; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $mem_c_grade = $school_jsc_result['mem_c_grade'] ; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $mem_d_grade = $school_jsc_result['mem_d_grade'] ; 
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php $total_sathi = 0; ?>
                                    <?php 
                                        echo $sathi_mot_examine = $school_jsc_result['sathi_mot_examine'] ; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $sathi_gpa_5 = $school_jsc_result['sathi_gpa_5'] ; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $sathi_a_grade = $school_jsc_result['sathi_a_grade'] ; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $sathi_a_minus = $school_jsc_result['sathi_a_minus']; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $sathi_b_grade = $school_jsc_result['sathi_b_grade'] ; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $sathi_c_grade = $school_jsc_result['sathi_c_grade'] ; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $sathi_d_grade = $school_jsc_result['sathi_d_grade'] ; 
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php $total_kormi = 0; ?>
                                    <?php 
                                        echo $kormi_mot_examine = $school_jsc_result['kormi_mot_examine'] ; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $kormi_gpa_5 = $school_jsc_result['kormi_gpa_5'] ; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $kormi_a_grade = $school_jsc_result['kormi_a_grade'] ; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $kormi_a_minus = $school_jsc_result['kormi_a_minus'] ; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $kormi_b_grade = $school_jsc_result['kormi_b_grade'] ; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $kormi_c_grade = $school_jsc_result['kormi_c_grade'] ; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $kormi_d_grade = $school_jsc_result['kormi_d_grade'] ; 
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    ...
                                    <?php 
                                        echo $shomorthok_mot_examine = $school_jsc_result['shomorthok_mot_examine'] ; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $shomorthok_gpa_5 = $school_jsc_result['shomorthok_gpa_5'] ; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $shomorthok_a_grade = $school_jsc_result['shomorthok_a_grade'] ; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $shomorthok_a_minus = $school_jsc_result['shomorthok_a_minus']; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $shomorthok_b_grade = $school_jsc_result['shomorthok_b_grade'] ; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $shomorthok_c_grade = $school_jsc_result['shomorthok_c_grade'] ; 
                                ...
                                <td class="tg-0pky">
                                    <?php 
                                        echo $shomorthok_d_grade = $school_jsc_result['shomorthok_d_grade'] ; 
