...
<table class="tg table table-header-rotated" id="testTable1" data-branch="<?php echo isset($branch_id) ? $branch_id.'_centraltraing_1_' : 'central_centraltraing_1'?>">
                        ...
                        <table class="tg table table-header-rotated" id="testTable2">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                <?php echo $ssc_coaching = $education_coaching['4to10_coaching'] ?>
                                </td>
                                <td class="tg-0pky  type_1">
                                <?php echo $ssc_batch = $education_coaching['4to10_batch'] ?>
                                </td>
                                <td class="tg-0pky  type_1">
                                <?php echo $ssc_student = $education_coaching['4to10_student'] ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                <?php echo $hsc_coaching = $education_coaching['11_12_coaching'] ?>
                                </td>
                                <td class="tg-0pky  type_1">
                                <?php echo $hsc_batch = $education_coaching['11_12_batch'] ?>
                                </td>
                                <td class="tg-0pky  type_1">
                                <?php echo $hsc_student = $education_coaching['11_12_student'] ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                <?php echo $university_coaching = $education_coaching['university_coaching'] ?>
                                </td>
                                <td class="tg-0pky  type_1">
                                <?php echo $university_batch = $education_coaching['university_batch'] ?>
                                </td>
                                <td class="tg-0pky  type_1">
                                <?php echo $university_student = $education_coaching['university_student'] ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                <?php echo $medical_coaching = $education_coaching['medical_coaching'] ?>
                                </td>
                                <td class="tg-0pky  type_1">
                                <?php echo $medical_batch = $education_coaching['medical_batch'] ?>
                                </td>
                                <td class="tg-0pky  type_1">
                                <?php echo $medical_student = $education_coaching['medical_student'] ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                <?php echo $eng_coaching = $education_coaching['eng_coaching'] ?>
                                </td>
                                <td class="tg-0pky  type_1">
                                <?php echo $eng_batch = $education_coaching['eng_batch'] ?>
                                </td>
                                <td class="tg-0pky  type_1">
                                <?php echo $eng_student = $education_coaching['eng_student'] ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                <?php echo $job_coaching = $education_coaching['job_coaching'] ?>
                                </td>
                                <td class="tg-0pky  type_1">
                                <?php echo $job_batch = $education_coaching['job_batch'] ?>
                                </td>
                                <td class="tg-0pky  type_1">
                                <?php echo $job_student = $education_coaching['job_student'] ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="tg-y698">অন্যান্য </td>
                                <td class="tg-0pky  type_1">
                                <?php echo $other_coaching = $education_coaching['other_coaching'] ?>
                                </td>
                                <td class="tg-0pky  type_1">
                                <?php echo $other_batch = $education_coaching['other_batch'] ?>
                                </td>
                                <td class="tg-0pky  type_1">
                                <?php echo $other_student = $education_coaching['other_student'] ?>
                                </td>
                            </tr>
