                    ...
                    <div class="tg-wrap">
                        ...
                        <table class="tg table table-header-rotated" id="testTable3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $hons_number = $education_scholarship['hons_number'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $hons_taka = $education_scholarship['hons_taka'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $masters_number = $education_scholarship['masters_number'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $masters_taka = $education_scholarship['masters_taka'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $landing_number = $education_scholarship['landing_number'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $landing_taka = $education_scholarship['landing_taka'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $free_number = $education_scholarship['free_number'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $free_taka = $education_scholarship['free_taka'] ?>
                                </td>
