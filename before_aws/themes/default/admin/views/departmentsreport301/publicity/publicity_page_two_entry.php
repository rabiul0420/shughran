                ...
                <div class="table-responsive">
                    ...
                    <table class="tg table table-header-rotated" id="testTable4">
                            ...
                            <tr>
                                ...
                                <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number"
                                    data-table="publicity_training_program" data-pk="<?php echo $pk ?>"
                    ...
                    <table class="tg table table-header-rotated" id="testTable1">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="potrikar_shompadok_shovapoti" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="potrikar_shompadok_prochar" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="midea_bekti_shovapoti" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="midea_bekti_prochar" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="tv_satelite_jela_shovapoti" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="tv_satelite_jela_prochar" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="tv_satelite_stuff_shovapoti" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="tv_satelite_stuff_prochar" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="tv_satelite_thana_shovapoti" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="tv_satelite_thana_prochar" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="tv_online_jela_shovapoti" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="tv_online_jela_prochar" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="tv_online_stuff_shovapoti" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="tv_online_stuff_prochar" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="tv_online_thana_shovapoti" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="tv_online_thana_prochar" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="jatio_printing_jela_shovapoti" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="jatio_printing_jela_prochar" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="jatio_printing_stuff_shovapoti" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="jatio_printing_stuff_prochar" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="jatio_printing_thana_shovapoti" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="jatio_printing_thana_prochar" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="jatio_online_jela_shovapoti" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="jatio_online_jela_prochar" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="jatio_online_stuff_shovapoti" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="jatio_online_stuff_prochar" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="jatio_online_thana_shovapoti" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="jatio_online_thana_prochar" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="ancholik_printing_jela_shovapoti" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="ancholik_printing_jela_prochar" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="ancholik_printing_stuff_shovapoti" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="ancholik_printing_stuff_prochar" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="ancholik_printing_thana_shovapoti" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="ancholik_printing_thana_prochar" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="ancholik_online_jela_shovapoti" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="ancholik_online_jela_prochar" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="ancholik_online_stuff_shovapoti" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="ancholik_online_stuff_prochar" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="ancholik_online_thana_shovapoti" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_contact" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="ancholik_online_thana_prochar" data-title="Enter">
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="text" 
                                        data-table="publicity_amader_collection" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="video_shakhar_bishoy" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_amader_collection" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="video_shakar_total" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="text" 
                                        data-table="publicity_amader_collection" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="video_kendrer_bishoy" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_amader_collection" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="video_kendrer_total" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="text" 
                                        data-table="publicity_amader_collection" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="photo_shakhar_bishoy" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_amader_collection" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="photo_shakar_total" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="text" 
                                        data-table="publicity_amader_collection" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="photo_kendrer_bishoy" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_amader_collection" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="photo_kendrer_total" data-title="Enter">
                            ...
                            <tr>
                                    ...
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="text" 
                                        data-table="publicity_amader_collection" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="news_shakhar_bishoy" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_amader_collection" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="news_shakar_total" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="text" 
                                        data-table="publicity_amader_collection" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="news_kendrer_bishoy" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_amader_collection" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="news_kendrer_total" data-title="Enter">
                        ...
                        <table class="tg table table-header-rotated" id="testTable3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_shoujonno" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="shompadok_num" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="text" 
                                        data-table="publicity_shoujonno" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="shompadok_upolokkho" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_shoujonno" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="shompadok_bar" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_shoujonno" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="shangbadik_num" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="text" 
                                        data-table="publicity_shoujonno" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="shangbadik_upolokkho" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_shoujonno" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="collamist_num" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="text" 
                                        data-table="publicity_shoujonno" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="collamist_upolokkho" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_shoujonno" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="collamist_bar" data-title="Enter">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_shoujonno" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="media_bektitto_num" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="text" 
                                        data-table="publicity_shoujonno" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="media_bektitto_upolokkho" data-title="Enter">
                                ...
                                <td class="tg-0pky  type_1">
                                    <a href="#"  class="editable editable-click"  data-id="" data-idname=""   data-type="number" 
                                        data-table="publicity_shoujonno" data-pk="<?php echo $pk ?>" 
                                        data-url="<?php echo admin_url('departmentsreport/detailupdate');?>"
                                        data-name="media_bektitto_bar" data-title="Enter">
