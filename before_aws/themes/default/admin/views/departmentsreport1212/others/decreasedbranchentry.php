...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo 'ঘাটতিকৃত থানা/সাথী শাখা' .  ': Entry'; ?></h4>
        </div>
        
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form', 'id'=>'add_institute');
        echo admin_form_open_multipart("departmentsreport/adddecreasedbranch/" .$branch_id, $attrib); ?>
            ...
            <div class="row">
				 ...
				 <div class="col-md-6 col-sm-6">
                     ...
                     <div class="form-group">
									...
									<label for="decrease_branch_name">থানা/ সাথী শাখার  নাম </label>
                    <?php echo form_input('decrease_branch_name', '', 'class="form-control" required="required" id="decrease_branch_name"'); ?>                  
                </div>
...
<div class="col-md-12">
        ...
        <div class="modal-footer">
            <?php echo form_submit('decreasedbranch', 'Submit', 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
