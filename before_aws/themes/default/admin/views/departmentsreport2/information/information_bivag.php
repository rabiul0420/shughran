...
if ($report_info['is_current'] || $report_info['year'] == date('Y')) {
    if ($report_info['type'] == 'annual') {
        echo anchor('admin/departmentsreport/information-bivag' . ($branch_id ? '/' . $branch_id : '') . ('?type=half_yearly&year=' . $report_info['year']), 'ষান্মাসিক ' . $report_info['year']);
        echo  "&nbsp;|&nbsp;" . anchor('admin/departmentsreport/information-bivag' . ($branch_id ? '/' . $branch_id : ''), 'জুলাই-নভেম্বর\'' . $report_info['year']);
        echo "&nbsp;|&nbsp;";
        ...
        echo anchor('admin/departmentsreport/information-bivag' . ($branch_id ? '/' . $branch_id : ''), 'ষান্মাসিক ' . $report_info['year']);
...
<span class="dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="archive">
        ...
        for ($i = date('Y') - 1; $i >= 2019; $i--) {
            ...
            echo   ' <li>' . anchor('admin/departmentsreport/information-bivag' . ($branch_id ? '/' . $branch_id : '') . '?type=half_yearly&year=' . $i, 'ষান্মাসিক ' . $i) . ' </li>';
        }
        ?>
	...
	border: 1px solid #ccc;
                    ...
                    <table class="tg table table-header-rotated" id="testTable1" style="text align: start;">
                            ...
                            <tr>
                                ...
                                <?php echo $pk_sts = $total_information_nij_shakha_theke_prokashito_prokashona['pk_bn'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $pk_sts = $total_information_nij_shakha_theke_prokashito_prokashona['pk_sts'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                <?php echo $pk_sts = $total_information_nij_shakha_theke_prokashito_prokashona['kdr_bn'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $kdr_sts = $total_information_nij_shakha_theke_prokashito_prokashona['kdr_sts'] ?>
                                </td>
                              ...
                              <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                <?php echo $pk_sts = $total_information_nij_shakha_theke_prokashito_prokashona['bul_bn'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                 <?php echo $bul_sts = $total_information_nij_shakha_theke_prokashito_prokashona['bul_sts'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                <?php echo $pk_sts = $total_information_nij_shakha_theke_prokashito_prokashona['pt_bn'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                 <?php echo $pt_sts = $total_information_nij_shakha_theke_prokashito_prokashona['pt_sts'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                <?php echo $pk_sts = $total_information_nij_shakha_theke_prokashito_prokashona['onnoanno_bn'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                 <?php echo $onnoanno_sts = $total_information_nij_shakha_theke_prokashito_prokashona['onnoanno_sts'] ?>
                                </td>
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $shkh_bps = $total_information_chobi_songroho['shkh_bps'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                   <?php echo $shkh_kpchshho = $total_information_chobi_songroho['shkh_kpchshho'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                                   <?php echo $shkh_shichs = $total_information_chobi_songroho['shkh_shichs'] ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                   <?php echo $thnord_bps = $total_information_chobi_songroho['thnord_bps'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                   <?php echo $thnord_kpchshho = $total_information_chobi_songroho['thnord_kpchshho'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                                   <?php echo $thnord_shichs = $total_information_chobi_songroho['thnord_shichs'] ?>
                                </td>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="tg-pwj7 type_1">  শাখা	</td>
                                <td class="tg-0pky  type_1">
                                    <?php echo $br_p_s = $total_information_vedio_sonrokkhon['br_p_s'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                   <?php echo $br_p_v_s = $total_information_vedio_sonrokkhon['br_p_v_s'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                                   <?php echo $br_v_s = $total_information_vedio_sonrokkhon['br_v_s'] ?>
                                </td>
                            ...
                            <tr>
                                <td class="tg-pwj7">থানা/ ওয়ার্ড </td>
                                <td class="tg-0pky  type_1">
                                   <?php echo $th_p_s = $total_information_vedio_sonrokkhon['th_p_s'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                   <?php echo $th_p_v_s = $total_information_vedio_sonrokkhon['th_p_v_s'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                                   <?php echo $th_v_s = $total_information_vedio_sonrokkhon['th_v_s'] ?>
                                </td>
                   ...
                   <tr>
                       ...
                       <td class="tg-0pky  type_1">
                       <?php echo $pk_potvs = $total_information_potrika_online_tv_kating_songroho['pk_potvs'] ?>
                       </td>
                       <td class="tg-0pky  type_2">
                           <?php echo $pk_ns = $total_information_potrika_online_tv_kating_songroho['pk_ns'] ?>
                       </td>
                       <td class="tg-0pky  type_2">
                           <?php echo $pk_arc = $total_information_potrika_online_tv_kating_songroho['pk_arc'] ?>
                       </td>
                   </tr>
                   ...
                   <tr>
                       ...
                       <td class="tg-0pky  type_1">
                       <?php echo $onlinepk_potvs = $total_information_potrika_online_tv_kating_songroho['onlinepk_potvs'] ?>
                       </td>
                       <td class="tg-0pky  type_2">
                       <?php echo $onlinepk_ns = $total_information_potrika_online_tv_kating_songroho['onlinepk_ns'] ?>
                       </td>
                       <td class="tg-0pky  type_2">
                           <?php echo $onlinepk_arc = $total_information_potrika_online_tv_kating_songroho['onlinepk_arc'] ?>
                       </td>
                   ...
                   <tr>
                       ...
                       <td class="tg-0pky  type_1">
                       <?php echo $tv_potvs = $total_information_potrika_online_tv_kating_songroho['tv_potvs'] ?>
                       </td>
                       <td class="tg-0pky  type_2">
                         <?php echo $tv_ns = $total_information_potrika_online_tv_kating_songroho['tv_ns'] ?>
                       </td>
                       <td class="tg-0pky  type_2">
                           <?php echo $tv_arc = $total_information_potrika_online_tv_kating_songroho['tv_arc'] ?>
                       </td>                   
                   </tr>
