...
if ($report_info['is_current'] || $report_info['year'] == date('Y')) {
    if ($report_info['type'] == 'annual') {
        echo anchor('admin/departmentsreport/law-page-one' . ($branch_id ? '/' . $branch_id : '') . ('?type=half_yearly&year=' . $report_info['year']), 'ষান্মাসিক ' . $report_info['year']);
        echo  "&nbsp;|&nbsp;" . anchor('admin/departmentsreport/law-page-one' . ($branch_id ? '/' . $branch_id : ''), 'জুলাই-নভেম্বর\'' . $report_info['year']);
        echo "&nbsp;|&nbsp;";
        ...
        echo anchor('admin/departmentsreport/law-page-one' . ($branch_id ? '/' . $branch_id : ''), 'ষান্মাসিক ' . $report_info['year']);
...
<span class="dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="archive">
        ...
        for ($i = date('Y') - 1; $i >= 2019; $i--) {
            ...
            echo   ' <li>' . anchor('admin/departmentsreport/law-page-one' . ($branch_id ? '/' . $branch_id : '') . '?type=half_yearly&year=' . $i, 'ষান্মাসিক ' . $i) . ' </li>';
        }
        ?>
	...
	border: 1px solid #ccc;
                    ...
                    <table class="tg table table-header-rotated" id="testTable10">
                        ...
                        <tr>
                            ...
                            <?php echo $shikkha_central_s=$total_law_training_program['shikkha_central_s'] ?>
                            </td>
                            <td class="tg-0pky  type_2">
                            <?php echo $shikkha_central_p=$total_law_training_program['shikkha_central_p'] ?>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="tg-0pky type_1">
                            <?php echo $shikkha_shakha_s=$total_law_training_program['shikkha_shakha_s'] ?>
                            </td>
                            <td class="tg-0pky  type_2">
                            <?php echo $shikkha_shakha_p=$total_law_training_program['shikkha_shakha_p'] ?>
                            </td>
                            <td class="tg-0pky  type_3">
                        ...
                        <tr>
                            ...
                            <td class="tg-0pky type_1">
                            <?php echo $kormoshala_central_s=$total_law_training_program['kormoshala_central_s'] ?>
                            </td>
                            <td class="tg-0pky  type_2">
                            <?php echo $kormoshala_central_p=$total_law_training_program['kormoshala_central_p'] ?>
                            </td>
                            <td class="tg-0pky  type_3">
                        ...
                        <tr>
                            ...
                            <td class="tg-0pky type_1">
                            <?php echo $kormoshala_shakha_s=$total_law_training_program['kormoshala_shakha_s'] ?>
                            </td>
                            <td class="tg-0pky  type_2">
                            <?php echo $kormoshala_shakha_p=$total_law_training_program['kormoshala_shakha_p'] ?>
                            </td>
                            <td class="tg-0pky  type_3">
                        ...
                        <table class="tg table table-header-rotated" id="testTable1">
                            ...
                            <tr>
                                <td class="tg-y698 type_1"> ২০২০ পর্যন্ত</td>
                                <td class="tg-0pky  type_1">
                                <?php echo $t1_total_mamla = $total_law_amader_bipokkhe_mamla['t1_total_css']+$total_law_amader_bipokkhe_mamla['t1_total_todontadhin_mamla']; ?>
                                </td>
                                <td class="tg-0pky  type_1">
                                <?php echo $t1_total_ashami = $total_law_amader_bipokkhe_mamla['t1_total_ashami'] ?>
                                </td>
                                <td class="tg-0pky  type_1">
                                <?php echo $t1_total_todontadhin_mamla = $total_law_amader_bipokkhe_mamla['t1_total_todontadhin_mamla'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $t1_total_css = $total_law_amader_bipokkhe_mamla['t1_total_css'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $t1_total_css_gotohon = $total_law_amader_bipokkhe_mamla['t1_total_css_gotohon'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                                <?php echo $t1_total_obbahoti = $total_law_amader_bipokkhe_mamla['t1_total_obbahoti'] ?>
                                </td>
                                <td class="tg-0pky  type_4">
                                <?php echo $t1_total_shakkhi = $total_law_amader_bipokkhe_mamla['t1_total_shakkhi'] ?>
                                </td>
                                <td class="tg-0pky  type_5">
                                <?php echo $t1_total_jukti_torko = $total_law_amader_bipokkhe_mamla['t1_total_jukti_torko'] ?>
                                </td>
                                <td class="tg-0pky  type_6">
                                <?php echo $t1_total_stay = $total_law_amader_bipokkhe_mamla['t1_total_stay'] ?>
                                </td>
                                <td class="tg-0pky  type_7">
                                <?php echo $t1_total_kowashment = $total_law_amader_bipokkhe_mamla['t1_total_kowashment'] ?>
                                </td>
                                <td class="tg-0pky  type_8">
                                <?php echo $t1_rayer_jonno_opekkha = $total_law_amader_bipokkhe_mamla['t1_rayer_jonno_opekkha'] ?>
                                </td>
                                </td>
                                <td class="tg-0pky  type_9">
                                <?php echo $t1_rayer_remand_ti = $total_law_amader_bipokkhe_mamla['t1_rayer_remand_ti'] ?>
                                </td>
                                <td class="tg-0pky  type_10">
                                <?php echo $t1_rayer_remand_jon = $total_law_amader_bipokkhe_mamla['t1_rayer_remand_jon'] ?>
                                </td>
                            ...
                            <tr>
                                <td class="tg-y698">শুধু ২০২১</td>
                                <td class="tg-0pky  type_1">
                                <?php echo $t2_total_mamla = $total_law_amader_bipokkhe_mamla['t2_total_css']+$total_law_amader_bipokkhe_mamla['t2_total_todontadhin_mamla']; ?>                                
                                </td>
                                <td class="tg-0pky  type_1">
                                <?php echo $t2_total_ashami = $total_law_amader_bipokkhe_mamla['t2_total_ashami'] ?>
                                </td>
                                <td class="tg-0pky  type_1">
                                <?php echo $t2_total_todontadhin_mamla = $total_law_amader_bipokkhe_mamla['t2_total_todontadhin_mamla'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $t2_total_css = $total_law_amader_bipokkhe_mamla['t2_total_css'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                <?php echo $t2_total_css_gotohon = $total_law_amader_bipokkhe_mamla['t2_total_css_gotohon'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                                <?php echo $t2_total_obbahoti = $total_law_amader_bipokkhe_mamla['t2_total_obbahoti'] ?>
                                </td>
                                <td class="tg-0pky  type_4">
                                <?php echo $t2_total_shakkhi = $total_law_amader_bipokkhe_mamla['t2_total_shakkhi'] ?>
                                </td>
                                <td class="tg-0pky  type_5">
                                <?php echo $t2_total_jukti_torko = $total_law_amader_bipokkhe_mamla['t2_total_jukti_torko'] ?>
                                </td>
                                <td class="tg-0pky  type_6">
                                <?php echo $t2_total_stay = $total_law_amader_bipokkhe_mamla['t2_total_stay'] ?>
                                </td>
                                <td class="tg-0pky  type_7">
                                <?php echo $t2_total_kowashment = $total_law_amader_bipokkhe_mamla['t2_total_kowashment'] ?>
                                </td>
                                <td class="tg-0pky  type_8">
                                <?php echo $t2_rayer_jonno_opekkha = $total_law_amader_bipokkhe_mamla['t2_rayer_jonno_opekkha'] ?>
                                </td>
                                </td>
                                <td class="tg-0pky  type_9">
                                <?php echo $t2_rayer_remand_ti = $total_law_amader_bipokkhe_mamla['t2_rayer_remand_ti'] ?>
                                </td>
                                <td class="tg-0pky  type_10">
                                <?php echo $t2_rayer_remand_jon = $total_law_amader_bipokkhe_mamla['t2_rayer_remand_jon'] ?>
                                </td>
                        ...
                        <tr>
                            ...
                            <?php 
                                $i=0;
                            foreach($total_law_shaja_shongkranto_mamla->result_array() as $row) 
                                    {
                                    $i++;
                                ?>
                        ...
                        <tr>
                            <td class="tg-pwj7" colspan="5"><b>খালাস-সংক্রান্ত তথ্য (২০০৯-২০২১) :  মোট খালাসপ্রাপ্ত মামলা সংখ্যা= </b></td>
                            <td class="tg-pwj7" colspan="2">
                            ...
                            <?php 
                                $i=0;
                            foreach($total_law_khalash_inffo->result_array() as $row) 
                                    {
                                    $i++;
                                ?>
