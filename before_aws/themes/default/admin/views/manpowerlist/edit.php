        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <input type="radio" class="checkbox" name="studentlife" value="2"
                    ...
                    <?php   if($manpower->orgstatus_id==1) { if( strtotime($manpower->member_oath_date) <=strtotime('2019-12-20')) {?>
                    <div class="form-group all">
                    ...
                    <?php } } elseif($manpower->orgstatus_id==2) { if( strtotime($manpower->associate_oath_date) <=strtotime('2019-12-20')) { ?>
                    ...
                    <?php } } elseif($manpower->orgstatus_id==12) { if( strtotime($manpower->associate_oath_date) <=strtotime('2019-12-20')) { ?>
