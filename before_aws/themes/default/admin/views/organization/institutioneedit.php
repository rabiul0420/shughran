		...
		<div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                     ...
                     <div class="form-group">
                                        ...
                                        <?php echo form_input('supporter', $institution->supporter, 'class="form-control" required="required" id="supporter"'); ?>                  
                                     ...
                                     <div class="form-group">
                                        ...
                                        <?php echo form_input('other_org_worker', $institution->other_org_worker, 'class="form-control" required="required" id="other_org_worker"'); ?>                  
                                     ...
                                     <div class="form-group">
                                        ...
                                        <?php echo form_input('total_female_student', $institution->total_female_student, 'class="form-control" required="required" id="total_female_student"'); ?>                  
                                     ...
                                     <div class="form-group">
                                        ...
                                        <?php echo form_input('female_student_supporter', $institution->female_student_supporter, 'class="form-control" required="required" id="female_student_supporter"'); ?>                  
                                     ...
                                     <div class="form-group">
                                        ...
                                        <?php echo form_input('non_muslim_student', $institution->non_muslim_student, 'class="form-control" required="required" id="non_muslim_student"'); ?>                  
                                     ...
                                     <div class="form-group">
                                        ...
                                        <?php echo form_input('total_student_number',  $institution->total_student_number, 'class="form-control" required="required" id="total_student_number"'); ?>                  
