...
<td  ><input name="member_jsc_jdc" value="1" type="checkbox"/></td>
<td  ><input name="member_ssc_dhakil" value="1" type="checkbox"/></td>
<td ><input name="member_hsc_alim" value="1" type="checkbox"/></td>
<td  ><input name="member_department_position" value="1" type="checkbox"/></td>
<td  ><input name="member_department_position_private" value="1" type="checkbox"/></td>
<td  ><input name="member_influential" value="1" type="checkbox"/></td>
<td  ><input name="member_hc_science" value="1" type="checkbox"/></td>
<td  ><input name="member_madrasha" value="1" type="checkbox"/></td>
<td  ><input name="member_medical_college" value="1" type="checkbox"/></td>
<td  ><input name="member_ideal_college" value="1" type="checkbox"/></td>
<td  ><input name="member_engineeering" value="1" type="checkbox"/></td>
<td  ><input name="member_agri" value="1" type="checkbox"/></td>
<td ><input name="member_science" value="1" type="checkbox"/></td>
<td  ><input name="member_business" value="1" type="checkbox"/></td>
<td  ><input name="member_arts" value="1" type="checkbox"/></td>
</tr>
</tbody>
</table>
