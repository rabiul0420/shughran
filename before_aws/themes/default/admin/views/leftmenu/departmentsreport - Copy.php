					   ...
					   <li class="mm_it">
						...
						<li class="mm_sports">
                            <a class="dropmenu" href="#">
                             ...
                             <ul>
                                <li id="mm_manpower_index" class="<?php echo ($this->uri->segment(3)=='sports_page_one')?'active':'' ?>" >
                                    <a href="<?= admin_url('departmentsreport/sports_page_one') ?>">
                                        <i class="fa fa-cogs"></i><span class="text">পেইজ ০১</span>
                                    </a>
                                </li>
                                <li id="mm_manpower_index" class="<?php echo ($this->uri->segment(3)=='sports_page_two')?'active':'' ?>" >
                                    <a href="<?= admin_url('departmentsreport/sports_page_two') ?>">
                                        <i class="fa fa-cogs"></i><span class="text">পেইজ ০২</span>
                                    </a>
                                </li>
