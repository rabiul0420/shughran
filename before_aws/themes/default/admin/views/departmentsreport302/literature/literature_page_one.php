        ...
        <h2 class="blue">
			...
			if ($report_info['is_current'] || $report_info['year'] == date('Y')) {
				if ($report_info['type'] == 'annual') {
					echo anchor('admin/departmentsreport/literature-page-one' . ($branch_id ? '/' . $branch_id : '') . ('?type=half_yearly&year=' . $report_info['year']), 'ষান্মাসিক ' . $report_info['year']);
					...
					echo anchor('admin/departmentsreport/literature-page-one' . ($branch_id ? '/' . $branch_id : ''), 'ষান্মাসিক ' . $report_info['year']);
			...
			<span class="dropdown">
				...
				<ul class="dropdown-menu" aria-labelledby="archive">
					...
					for ($i = date('Y') - 1; $i >= 2019; $i--) {
						...
						echo   ' <li>' . anchor('admin/departmentsreport/literature-page-one' . ($branch_id ? '/' . $branch_id : '') . '?type=half_yearly&year=' . $i, 'ষান্মাসিক ' . $i) . ' </li>';
					}
					?>
                    ...
                    <div class="tg-wrap">
                        ...
                        <table class="tg table table-header-rotated" id="testTable3">
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky  type_1">
                                    <?php echo $total_sahitto_somporkito_dawati_program['ssdu_sonkha'] ?>
                                </td>

                                <td class="tg-0pky  type_2">
                                    <?php echo $total_sahitto_somporkito_dawati_program['ssdu_ta'] ?>
                                </td>

                                <td class="tg-0pky  type_3">
                                    <?php echo (isset($total_sahitto_somporkito_dawati_program['ssdu_sonkha']) && isset($total_sahitto_somporkito_dawati_program['ssdu_ta']) && (int)$total_sahitto_somporkito_dawati_program['ssdu_ta'] > 0) ?
                                        ($total_sahitto_somporkito_dawati_program['ssdu_ta'] / $total_sahitto_somporkito_dawati_program['ssdu_sonkha']) : '' ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky">
                                    <?php echo $total_sahitto_somporkito_dawati_program['ls_sonkha'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo $total_sahitto_somporkito_dawati_program['ls_ta'] ?>
                                </td>
                                <td class="tg-0pky">
                                    <?php echo (isset($total_sahitto_somporkito_dawati_program['ls_sonkha']) && isset($total_sahitto_somporkito_dawati_program['ls_ta']) && (int)$total_sahitto_somporkito_dawati_program['ls_ta'] > 0) ?
                                        ($total_sahitto_somporkito_dawati_program['ls_ta'] / $total_sahitto_somporkito_dawati_program['ls_sonkha']) : '' ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky type_1">
                                    <?php echo $total_sahitto_somporkito_dawati_program['gs_sonkha'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $total_sahitto_somporkito_dawati_program['gs_ta'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                                    <?php echo (isset($total_sahitto_somporkito_dawati_program['gs_sonkha']) && isset($total_sahitto_somporkito_dawati_program['gs_ta']) && (int)$total_sahitto_somporkito_dawati_program['gs_ta'] > 0) ?
                                        ($total_sahitto_somporkito_dawati_program['gs_ta'] / $total_sahitto_somporkito_dawati_program['gs_sonkha']) : '' ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky type_1">
                                    <?php echo $total_sahitto_somporkito_dawati_program['im_sonkha'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $total_sahitto_somporkito_dawati_program['im_ta'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                                    <?php echo (isset($total_sahitto_somporkito_dawati_program['im_sonkha']) && isset($total_sahitto_somporkito_dawati_program['im_ta']) && (int)$total_sahitto_somporkito_dawati_program['im_ta'] > 0) ?
                                        ($total_sahitto_somporkito_dawati_program['im_ta'] / $total_sahitto_somporkito_dawati_program['im_sonkha']) : '' ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky type_1">
                                    <?php echo $total_sahitto_somporkito_dawati_program['sp_sonkha'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $total_sahitto_somporkito_dawati_program['sp_ta'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                                    <?php echo (isset($total_sahitto_somporkito_dawati_program['sp_sonkha']) && isset($total_sahitto_somporkito_dawati_program['sp_ta']) && (int)$total_sahitto_somporkito_dawati_program['sp_ta'] > 0) ?
                                        ($total_sahitto_somporkito_dawati_program['sp_ta'] / $total_sahitto_somporkito_dawati_program['sp_sonkha']) : '' ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="tg-0pky type_1">
                                    <?php echo $total_sahitto_somporkito_dawati_program['nlp_sonkha'] ?>
                                </td>
                                <td class="tg-0pky  type_2">
                                    <?php echo $total_sahitto_somporkito_dawati_program['nlp_ta'] ?>
                                </td>
                                <td class="tg-0pky  type_3">
                                    <?php echo (isset($total_sahitto_somporkito_dawati_program['nlp_sonkha']) && isset($total_sahitto_somporkito_dawati_program['nlp_ta']) && (int)$total_sahitto_somporkito_dawati_program['nlp_ta'] > 0) ?
                                        ($total_sahitto_somporkito_dawati_program['nlp_ta'] / $total_sahitto_somporkito_dawati_program['nlp_sonkha']) : '' ?>
                                </td>
