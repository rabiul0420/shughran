...
class Dawah extends MY_Controller
{
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_dawah_moktob'] = $this->db->get('dawah_moktob')->first_row('array');
        ...
        $this->data['total_dawah_jonoshokti_byktigoto_procheshta'] = $this->db->get('dawah_jonoshokti_byktigoto_procheshta')->first_row('array');
        ...
        $this->data['total_dawah_shovashomuho'] = $this->db->get('dawah_shovashomuho')->first_row('array');
    ...
    function dawah_page_two($branch_id = NULL)
    {
        ...
        if ((!$branch_id)  || ($branch_id && $report_type['is_current'] == false)) {
            ...
            $this->data['total_dawah_dayi_training'] = $this->db->get('dawah_dayi_training')->first_row('array');
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_dawah_contact'] = $this->db->get('dawah_contact')->first_row('array');
            ...
            $this->data['total_dawah_quran_bitoron'] = $this->db->get('dawah_quran_bitoron')->first_row('array');
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_dawah_online'] = $this->db->get('dawah_online')->first_row('array');
            ...
            $this->data['total_dawah_dawat_bar'] = $this->db->get('dawah_dawat_bar')->first_row('array');
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_dawah_vinnordhormo'] = $this->db->get('dawah_vinnordhormo')->first_row('array');
            ...
            $this->data['total_dawah_training_program'] = $this->db->get('dawah_training_program')->first_row('array');
