...
class Literature extends MY_Controller
{
    ...
    function literature_page_one($branch_id = NULL)
    {
        ...
        if ((!$branch_id)  || ($branch_id && $report_type['is_current'] == false)) {
            ...
            $this->data['Total_potrikar_grahok_briddhi'] = $this->db->get('literature_potrikar_grahok_briddhi')->first_row('array');
            ...
            $this->data['total_sahitto_somporkito_dawati_program'] = $this->db->get('literature_sahitto_somporkito_dawati_program')->first_row('array');
        } else {
    ...
    function literature_page_two($branch_id = NULL)
    {
        ...
        if ((!$branch_id)  || ($branch_id && $report_type['is_current'] == false)) {
            ...
            if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            $this->data['total_literature_songothon_two'] = $this->db->get('literature_songothon_two')->first_row('array');
            ...
            if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            $this->data['total_literature_program'] = $this->db->get('literature_program')->first_row('array');
            ...
            if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            $this->data['total_literature_training_program'] = $this->db->get('literature_training_program')->first_row('array');
            ...
            $this->data['total_literature_gogajok_output'] = $this->db->get('literature_gogajok_output')->first_row('array');
        } else {
            $this->db->select('*');
            $this->db->where('branch_id', $branch_id);
