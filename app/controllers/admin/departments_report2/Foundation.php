...
$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
    ...
    $this->data['total_foundation_foundation_info'] = $this->db->get('foundation_foundation_info')->first_row('array');
...
$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
    ...
    $this->data['total_foundation_jomi_shongkranto'] = $this->db->get('foundation_jomi_shongkranto');
...
$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
    ...
    $this->db->order_by('branch_id');
    $this->data['total_foundation_flat_shongkranto'] = $this->db->get('foundation_flat_shongkranto');
...
$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
    ...
    $this->db->order_by('branch_id');
    $this->data['total_foundation_others'] = $this->db->get('foundation_others');
...
$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
    ...
    $this->data['total_foundation_training_program'] = $this->db->get('foundation_training_program')->first_row('array');
