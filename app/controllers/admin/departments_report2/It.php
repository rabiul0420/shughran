...
class It extends MY_Controller
{
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_it_jonoshoktiorisors'] = $this->db->get('it_jonoshoktiorisors')->first_row('array');
        ...
        if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_it_dept_jonoshoktir_dokkhota'] = $this->db->get('it_dept_jonoshoktir_dokkhota')->first_row('array');
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_it_dept_shakhar_online_risors'] = $this->db->get('it_dept_shakhar_online_risors')->first_row('array');
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_it_proshikkhon'] = $this->db->get('it_proshikkhon')->first_row('array');
        ...
        $this->db->where('branch_id', $branch_id);
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        $this->data['total_it_training_program'] = $this->db->get('it_training_program')->first_row('array');
    ...
    function it_page_two($branch_id = NULL)
    {
        ...
        $this->data['total_dept_jonoshoktir_dokkhota'] = $this->db->get('dept_jonoshoktir_dokkhota')->first_row('array');
    ...
    function shakhar_online_resource($branch_id = NULL)
    {
        ...
        $this->data['total_it_dept_shakhar_online_risors'] = $this->db->get('dept_shakhar_online_risors')->first_row('array');
    ...
    function it_proshikkhon($branch_id = NULL)
    {
        ...
        $this->data['total_proshikkhon'] = $this->db->get('proshikkhon')->first_row('array');
