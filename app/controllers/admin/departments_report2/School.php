...
class School extends MY_Controller
{
	...
	function __construct()
	{
		...
		if ($this->session->userdata('group_id') == 8 && $this->session->userdata('department_id') == 23) {  //literature
	...
	$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
		...
		$this->data['total_school_manpower'] = $this->db->get('school_manpower')->first_row('array');
	...
	$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
		...
		$this->data['total_school_dawat'] = $this->db->get('school_dawat')->first_row('array');
	...
	$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
		...
		$this->data['total_school_shongothon'] = $this->db->get('school_shongothon')->first_row('array');
	...
	$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
		...
		$this->data['total_school_proshikkhon'] = $this->db->get('school_proshikkhon')->first_row('array');
	...
	$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
		...
		$this->data['total_school_dawat_program'] = $this->db->get('school_dawat_program')->first_row('array');
	...
	$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
		...
		$this->data['total_school_dowati_asor'] = $this->db->get('school_dowati_asor')->first_row('array');
	...
	$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
		...
		$this->data['total_school_creative_search'] = $this->db->get('school_creative_search')->first_row('array');
	...
	$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
		...
		$this->data['total_school_reception'] = $this->db->get('school_reception')->first_row('array');
	...
	$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
		...
		$this->data['total_school_compition_dawati_program'] = $this->db->get('school_compition_dawati_program')->first_row('array');
	...
	$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
		...
		$this->data['total_school_olympiad_camp'] = $this->db->get('school_olympiad_camp')->first_row('array');
	...
	$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
		...
		$this->data['total_school_sports'] = $this->db->get('school_sports')->first_row('array');
	...
	$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
		...
		$this->data['total_school_career_design'] = $this->db->get('school_career_design')->first_row('array');
	...
	$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
		...
		$this->data['total_school_samajik_kaj'] = $this->db->get('school_samajik_kaj')->first_row('array');
	...
	$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
		...
		$this->data['total_school_boithok'] = $this->db->get('school_boithok')->first_row('array');
	...
	$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
		...
		$this->data['total_school_workshop'] = $this->db->get('school_workshop')->first_row('array');
	...
	$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
		...
		$this->data['total_school_summit'] = $this->db->get('school_summit')->first_row('array');	
        ...
        $this->data['total_school_training_program'] = $this->db->get('school_training_program')->first_row('array');
	...
	function school_page_four($branch_id = NULL)
	{
		...
		$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
			...
			$this->data['total_school_bitoron'] = $this->db->get('school_bitoron')->first_row('array');
		...
		$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
			...
			$this->data['total_school_contact'] = $this->db->get('school_contact')->first_row('array');
		...
		$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
			...
			$this->data['total_school_sofor'] = $this->db->get('school_sofor')->first_row('array');
	...
	$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
		...
		$this->data['total_school_jsc_result'] = $this->db->get('school_jsc_result')->first_row('array');
	...
	$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
		...
		$this->data['total_school_ssc_result'] = $this->db->get('school_ssc_result')->first_row('array');
