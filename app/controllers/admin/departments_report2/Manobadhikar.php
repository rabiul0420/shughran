...
class Manobadhikar extends MY_Controller
{
    ...
    {  
        ...
        if ((!$branch_id)  || ($branch_id && $report_type['is_current'] == false)) { 
            ...
            $this->data['total_human_rights_branch_info'] = $this->db->get('human_rights_branch_info')->first_row('array');
           
            if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            $this->data['total_human_rights_branch_info_row'] = $this->db->get('human_rights_branch_info')->num_rows();
            ...
            if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            $this->data['total_human_rights_branch_committee'] = $this->db->get('human_rights_branch_committee')->first_row('array');
            ...
            if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            $this->data['total_human_rights_program'] = $this->db->get('human_rights_program')->first_row('array');
            ...
            if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            $this->data['total_human_rights_violation'] = $this->db->get('human_rights_violation')->first_row('array');
            ...
            $this->db->where('branch_id', $branch_id);
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            $this->data['total_human_rights_contact'] = $this->db->get('human_rights_contact')->first_row('array');
            ...
            if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            $this->data['total_human_rights_miscellaneous'] = $this->db->get('human_rights_miscellaneous')->first_row('array');
            ...
            $this->db->where('branch_id', $branch_id);
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            $this->data['total_human_rights_output'] = $this->db->get('human_rights_output')->first_row('array');
            ...
            if ($branch_id)
                $this->db->where('branch_id', $branch_id);
            $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            $this->data['total_human_rights_training_program'] = $this->db->get('human_rights_training_program')->first_row('array');
