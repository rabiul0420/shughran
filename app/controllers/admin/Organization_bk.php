...
class Organization extends MY_Controller
{
    ...
    function current_calculation_institution()
    {
        ...
        $record = $this->site->query("SELECT id,v2_v3_organization_institution_current(id, '2021-12-23' , '2022-12-17',".$branch->id.",2021) current_number from `sma_institution`");
    ...
    function current_calculation_organization()
    {
        ...
        foreach($branches as $branch) {
        $record = $this->site->query("SELECT id,v2_v3_organization_minimum_one_unit_current(id, '2021-12-23' , '2022-12-17',".$branch->id.",2021) current_number from `sma_institution`");
    ...
    function index($branch_id = NULL)
    {
        ...
        if ($branch_id) {
            ...
            $this->data['institution_number'] = $this->site->query("SELECT institution_type_child,  v2_v3_prev_institution(institution_type_child, " . $prev . ", " . $branch_id . ") v3_prev_institution, SUM(increase_institution) increase,  SUM(decrease_institution) decrease FROM   ( SELECT     
...
SELECT `id` institution_type_child, 0 increase_institution,0 decrease_institution FROM `sma_institution` WHERE  `type` = 1 GROUP BY id 
     ...
     institution_type_child ,  SUM( v2_v3_organization_prev( sma_institutionlist.id, '" . $prev . "', 2," . $branch_id . ")) unit_prev, SUM(current_unit) current_unit, 
    SUM( v2_v3_latest_unit_status( sma_institutionlist.id, '" . $start . "', '" . $end . "', 1, " . $branch_id . ")) unit_increase, 
    SUM( v2_v3_latest_unit_status( sma_institutionlist.id, '" . $start . "', '" . $end . "', 2, " . $branch_id . ")) unit_decrease ,
   ...
   GROUP BY institution_type_child ");
            ...
            $this->data['supporter_org_but_org_info'] = $this->site->query("SELECT a.institution_type_child, v2_v3_prev_support_but_org(a.institution_type_child,'" . $prev . "', " . $branch_id . ") prev_, SUM(a.support_increase_but_org) support_increase_but_org, SUM(a.support_decrease_but_org) support_decrease_but_org
   FROM
   ...
   GROUP BY a.institution_type_child ");
            ...
            $this->data['institution_number'] = $this->site->query("SELECT institution_type_child,  v2_v3_prev_institution(institution_type_child, " . $prev . ", -1) v3_prev_institution, SUM(increase_institution) increase,  SUM(decrease_institution) decrease FROM   ( SELECT     
        institution_type_child,  COUNT(`id`) increase_institution, 0 decrease_institution
       FROM `sma_institutionlist`
...
SELECT `id` institution_type_child, 0 increase_institution,0 decrease_institution FROM `sma_institution` WHERE  `type` = 1 GROUP BY id 
            ...
            $this->data['institution_info'] = $this->site->query("SELECT     
       institution_type_child,  SUM( v2_v3_organization_prev( sma_institutionlist.id, '" . $prev . "', 2,-1)) unit_prev, SUM(current_unit) current_unit, 
      SUM( v2_v3_latest_unit_status( sma_institutionlist.id, '" . $start . "', '" . $end . "', 1, -1)) unit_increase, 
      SUM( v2_v3_latest_unit_status( sma_institutionlist.id, '" . $start . "', '" . $end . "', 2, -1)) unit_decrease ,
      SUM( total_student_number ) total_student_number, SUM( supporter) supporter, 
      SUM(other_org_worker) other_org_worker, 
      SUM(total_female_student) total_female_student, 
      SUM(female_student_supporter) female_student_supporter, 
     ...
     GROUP BY institution_type_child ");
            ...
            $this->data['supporter_org_but_org_info'] = $this->site->query("SELECT a.institution_type_child, v2_v3_prev_support_but_org(a.institution_type_child,'" . $prev . "', -1) prev_, SUM(a.support_increase_but_org) support_increase_but_org, SUM(a.support_decrease_but_org) support_decrease_but_org
     FROM
     (SELECT `institution_type_child`, COUNT(`sma_institution_supporter_organization`.id) support_increase_but_org, 
     0  support_decrease_but_org
     FROM  `sma_institution_supporter_organization` 
...
WHERE date BETWEEN ? AND ?  GROUP BY `institution_type_id` ", array($start, $end));
    ...
    function getInstitutionWithOrg($branch_id = NULL) //with with organization
    {
        ...
        if ($branch_id) {
            ...
            $this->datatables
                ->select($this->db->dbprefix('institutionlist') . ".id as id,  {$this->db->dbprefix('institutionlist')}.code as code,  institution_name,  {$this->db->dbprefix('institutionlist')}.org_type as org_type,t1.institution_type as plname, t2.institution_type as rcname,   {$this->db->dbprefix('branches')}.name as branch_name,    v2_v3_organization_prev( {$this->db->dbprefix('institutionlist')}.id,'" . $prev . "',2," . $branch_id . ") prev, current_unit, v2_v3_latest_unit_status( {$this->db->dbprefix('institutionlist')}.id,'" . $start . "','" . $end . "',1,-1) increase, v2_v3_latest_unit_status( {$this->db->dbprefix('institutionlist')}.id,'" . $start . "','" . $end . "',2, -1) decrease", FALSE)
                ->from('institutionlist');
            $this->datatables->join('institution t1', 'institutionlist.institution_type=t1.id', 'left');
            $this->datatables->join('institution t2', 'institutionlist.institution_type_child=t2.id', 'left');
...
<li>' . $unit . '</li>
    ...
    <li>' . $view_link . '</li>
        ...
        if ($branch_id) {
            ...
            $this->datatables
                ->select($this->db->dbprefix('institutionlist') . ".id as id,  {$this->db->dbprefix('institutionlist')}.code as code,  institution_name, t1.institution_type as plname, t2.institution_type as rcname,   {$this->db->dbprefix('branches')}.name as branch_name,  thana_code, v2_v3_organization_prev( {$this->db->dbprefix('institutionlist')}.id,'" . $prev . "',1," . $branch_id . ") prev, current_supporter_organization, v2_v3_latest_organization_status( {$this->db->dbprefix('institutionlist')}.id,'" . $start . "', '" . $end . "',1) increase, v2_v3_latest_organization_status({$this->db->dbprefix('institutionlist')}.id,'" . $start . "','" . $end . "',2) decrease, `supporter`,`other_org_worker`,`total_female_student`,`female_student_supporter`,`non_muslim_student`,`total_student_number`,   is_organization", FALSE)
                ->from('institutionlist');
            $this->datatables->join('institution t1', 'institutionlist.institution_type=t1.id', 'left');
            $this->datatables->join('institution t2', 'institutionlist.institution_type_child=t2.id', 'left');
            ...
            $this->datatables
                ->select($this->db->dbprefix('institutionlist') . ".id as id,  {$this->db->dbprefix('institutionlist')}.code as code, institution_name,  t1.institution_type as plname, t2.institution_type as rcname,   {$this->db->dbprefix('branches')}.name as branch_name, thana_code,  v2_v3_organization_prev( {$this->db->dbprefix('institutionlist')}.id,'" . $prev . "',1,-1) prev, current_supporter_organization, v2_v3_latest_organization_status( {$this->db->dbprefix('institutionlist')}.id,'" . $start . "','" . $end . "',1) increase, v2_v3_latest_organization_status( {$this->db->dbprefix('institutionlist')}.id,'" . $start . "','" . $end . "',2) decrease ,`supporter`,`other_org_worker`,`total_female_student`,`female_student_supporter`,`non_muslim_student`,`total_student_number`,is_organization", FALSE)
                ->from('institutionlist');
            $this->datatables->join('institution t1', 'institutionlist.institution_type=t1.id', 'left');
            $this->datatables->join('institution t2', 'institutionlist.institution_type_child=t2.id', 'left');
    ...
    function institutionexport($branch_id = NULL)
    {
        ...
        if ($branch_id) {
            ...
            $this->db
                ->select($this->db->dbprefix('institutionlist') . ".id as id,  {$this->db->dbprefix('institutionlist')}.code as code,  institution_name, t1.institution_type as plname, t2.institution_type as rcname,   {$this->db->dbprefix('branches')}.name as branch_name, v2_v3_organization_prev( {$this->db->dbprefix('institutionlist')}.id,'" . $prev . "',1," . $branch_id . ") prev, current_supporter_organization, v2_v3_latest_organization_status( {$this->db->dbprefix('institutionlist')}.id,'" . $start . "', '" . $end . "',1) increase, v2_v3_latest_organization_status({$this->db->dbprefix('institutionlist')}.id,'" . $start . "','" . $end . "',2) decrease, `supporter`,`other_org_worker`,`total_female_student`,`female_student_supporter`,`non_muslim_student`,`total_student_number`,   is_organization, org_type, v2_v3_org_current_session( {$this->db->dbprefix('institutionlist')}.id, '" . $start . "' , '" . $end . "' ) in_current_session , notes, date,current_unit,  
                v2_v3_organization_prev( {$this->db->dbprefix('institutionlist')}.id,'" . $prev . "',2," . $branch_id . ") prev_unit,
                v2_v3_latest_unit_status( {$this->db->dbprefix('institutionlist')}.id,'" . $start . "','" . $end . "',1, " . $branch_id . ") increase, 
                v2_v3_latest_unit_status( {$this->db->dbprefix('institutionlist')}.id,'" . $start . "','" . $end . "',2, " . $branch_id . ") decrease
         ", FALSE)
                ->from('institutionlist');
            $this->db->join('institution t1', 'institutionlist.institution_type=t1.id', 'left');
            $this->db->join('institution t2', 'institutionlist.institution_type_child=t2.id', 'left');
            ...
            $this->db
                ...
                v2_v3_organization_prev( {$this->db->dbprefix('institutionlist')}.id,'" . $prev . "',2," . $branch_id . ") prev_unit,
                v2_v3_latest_unit_status( {$this->db->dbprefix('institutionlist')}.id,'" . $start . "','" . $end . "',1, " . $branch_id . ") increase, 
                v2_v3_latest_unit_status( {$this->db->dbprefix('institutionlist')}.id,'" . $start . "','" . $end . "',2, " . $branch_id . ") decrease ", FALSE)
                ->from('institutionlist');
            $this->db->join('institution t1', 'institutionlist.institution_type=t1.id', 'left');
            $this->db->join('institution t2', 'institutionlist.institution_type_child=t2.id', 'left');
    ...
    function instituition_detail($id = NULL)
    {
        ...
        $this->db
            ->select($this->db->dbprefix('institutionlist') . ".id as id,  {$this->db->dbprefix('institutionlist')}.code as code, institution_name,  t1.institution_type as plname, t2.institution_type as rcname,   {$this->db->dbprefix('branches')}.name as branch_name,  v2_v3_organization_prev( {$this->db->dbprefix('institutionlist')}.id,'" . $prev . "',1, -1) prev, current_supporter_organization, v2_v3_latest_organization_status( {$this->db->dbprefix('institutionlist')}.id,'" . $start . "','" . $end . "',1) increase, v2_v3_latest_organization_status( {$this->db->dbprefix('institutionlist')}.id,'" . $start . "','" . $end . "',2) decrease ,current_unit,is_organization", FALSE);
        $this->db->join('institution t1', 'institutionlist.institution_type=t1.id', 'left');
        $this->db->join('institution t2', 'institutionlist.institution_type_child=t2.id', 'left');
