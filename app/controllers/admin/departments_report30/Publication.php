...
class Publication extends MY_Controller
{
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_publication_kendro_hote_prokashona'] = $this->db->get('publication_kendro_hote_prokashona')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_publication_bibidh'] = $this->db->get('publication_bibidh');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_publication_ay_bey'] = $this->db->get('publication_ay_bey')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_publication_training_program'] = $this->db->get('publication_training_program')->first_row('array');
  }
        else{
            $this->db->select('*');
            $this->db->where('branch_id',$branch_id);
