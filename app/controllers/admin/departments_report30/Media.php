...
class Media extends MY_Controller
{
    ...
    public function media_page_one($branch_id = null)
    {
        ...
        $this->data['total_media'] = $this->db->get('media');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_media_manpower'] = $this->db->get('media_manpower')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_media_contact'] = $this->db->get('media_contact')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_media_shova'] = $this->db->get('media_shova')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_media_training_course'] = $this->db->get('media_training_course')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_media_training_workshop'] = $this->db->get('media_training_workshop')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_media_training_program'] = $this->db->get('media_training_program')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_media_int_media'] = $this->db->get('media_int_media')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_media_nation_media_electronic'] = $this->db->get('media_nation_media_electronic')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_media_nation_media_print'] = $this->db->get('media_nation_media_print')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_media_nation_media_online'] = $this->db->get('media_nation_media_online')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_media_mofosshol_media'] = $this->db->get('media_mofosshol_media')->first_row('array');
        ...
        $this->data['total_media_eknojore'] = $this->db->get('media_eknojore')->first_row('array');
