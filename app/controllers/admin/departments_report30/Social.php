...
class Social extends MY_Controller
{
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_social_welfare_brikkho_ropon'] = $this->db->get('social_welfare_brikkho_ropon')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_social_welfare_roktodata'] = $this->db->get('social_welfare_roktodata')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_social_welfare_shakhorota_ovijan'] = $this->db->get('social_welfare_shakhorota_ovijan')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_social_welfare_shebamulok_program'] = $this->db->get('social_welfare_shebamulok_program')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_social_welfare_shikkha_upokoron'] = $this->db->get('social_welfare_shikkha_upokoron')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_social_welfare_arthik_shohayota'] = $this->db->get('social_welfare_arthik_shohayota')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_social_welfare_upohar'] = $this->db->get('social_welfare_upohar')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_social_welfare_training_program'] = $this->db->get('social_welfare_training_program')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_social_welfare_summit'] = $this->db->get('social_welfare_summit')->first_row('array');	
    }
    else{
        $this->db->select('*');
        $this->db->where('branch_id',$branch_id);
