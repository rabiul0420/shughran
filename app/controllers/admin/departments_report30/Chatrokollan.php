...
class Chatrokollan extends MY_Controller
{
    ...
    function __construct()
    {
		...
		if(   $this->session->userdata('group_id')== 8 && $this->session->userdata('department_id')!=15) {
		 ...
		 if(  $this->session->userdata('group_id')== 8 && $this->session->userdata('department_id') ==15) {  //literature
...
$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
    ...
    $this->data['total_stu_wellfare_shikkha_shohojogita'] = $this->db->get('stu_wellfare_shikkha_shohojogita')->first_row('array');
...
$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
    ...
    $this->data['total_stu_wellfare_shohid'] = $this->db->get('stu_wellfare_shohid')->first_row('array');
...
$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
    ...
    $this->data['total_stu_wellfare_shohid_list'] = $this->db->get('stu_wellfare_shohid_list');
...
$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
    ...
    $this->data['total_stu_wellfare_shohojogita'] = $this->db->get('stu_wellfare_shohojogita')->first_row('array');
...
$this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
    ...
    $this->data['total_stu_wellfare_training_program'] = $this->db->get('stu_wellfare_training_program')->first_row('array');
    ...
    function chatrokollan_sahajjo($branch_id = NULL)
    {
        ...
        $this->data['total_chatrokollan_sahajjo'] = $this->db->get('chatrokollan_sahajjo')->first_row('array');
