...
class Debate extends MY_Controller
{
    ...
    public function bitorko_page_one($branch_id = null)
    {
        ...
        $this->data['total_debate_niojito_sangothonik_jonoshokti'] = $this->db->get('debate_niojito_sangothonik_jonoshokti')->first_row('array');
        ...
        $this->db->where('report_type',$report_type['type']);
        $this->db->where('report_year',$report_type['year']);  
        $this->data['total_debate_bitarkik_jonoshokti'] = $this->db->get('debate_bitarkik_jonoshokti')->first_row('array');
        ...
        $this->db->where('report_type',$report_type['type']);
        $this->db->where('report_year',$report_type['year']);  
        $this->data['total_debate_bitorko_club_biboron'] = $this->db->get('debate_bitorko_club_biboron')->first_row('array');
        ...
        $this->db->where('report_type',$report_type['type']);
        $this->db->where('report_year',$report_type['year']);  
        $this->data['total_debate_contact'] = $this->db->get('debate_contact')->first_row('array');
    ...
    $this->db->where('report_type',$report_type['type']);
    $this->db->where('report_year',$report_type['year']);  
    $this->data['total_debate_program'] = $this->db->get('debate_program')->first_row('array');
    ...
    $this->db->where('report_type',$report_type['type']);
    $this->db->where('report_year',$report_type['year']);  
    $this->data['total_debate_protijogita'] = $this->db->get('debate_protijogita')->first_row('array');
    ...
    $this->db->where('report_type',$report_type['type']);
    $this->db->where('report_year',$report_type['year']);
    $this->data['total_debate_training_program'] = $this->db->get('debate_training_program')->first_row('array');
