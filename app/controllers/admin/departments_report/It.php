...
class It extends MY_Controller
{
    function __construct()
    {
        ...
        $this->data['serial_info'] = $this->site->getOneRecord('serial_reports', '*', ['report_year' => date('Y'), 'report_type' => $report_type['type'], 'branch_id' => $branch_id, 'dept_id' => 29], 'id desc', 1, 0);
    ...
    function it_bivag($branch_id = null)
    {
       // $this->sma->print_arrays(1111);
        ...
        } elseif ($branch_id == null && !($this->Owner || $this->Admin || $this->departmentuser)) {
            admin_redirect('departmentsreport/it-bivag/' . $this->session->userdata('branch_id'));
        }
        ...
        if (!$branch_id || ($branch_id && $report_type['is_current'] == false)) {
            ...
            $this->db->select_sum('m_datamanagementAnalysis'); // Added new field for data management analysis
            ...
            $this->db->select_sum('m_deviceSecurity'); // Added new field for device security
            ...
            $this->db->select_sum('a_datamanagementAnalysis'); // Added new field for data management analysis
            ...
            $this->db->select_sum('a_deviceSecurity'); // Added new field for device security
            ...
            $this->db->select_sum('w_datamanagementAnalysis'); // Added new field for data management analysis
            ...
            $this->db->select_sum('w_game');
              $this->db->select_sum('w_deviceSecurity'); // Added new field for device security
        ...
        $this->data['m'] = 'it';
        $bc = [['link' => base_url(), 'page' => lang('home')], ['link' => '#', 'page' => lang('departmentsreport')]];
        $meta = ['page_title' => lang('manpower'), 'bc' => $bc];
    ...
    function it_bivag_sm($branch_id = null)
    {
        ...
        if (!$branch_id || ($branch_id && $report_type['is_current'] == false)) {
           ...
           // Debug output
            ...
            $this->db->select_sum('video_s');
            $this->db->select_sum('web_s');
            $this->db->select_sum('servicing_s'); // Added new field for device security
            $this->db->select_sum('onlineForm_s'); // Added new field for device security
            $this->db->select_sum('techMaterial_s'); // Added new field for device security
            $this->db->select_sum('security_s'); // Added new field for device security
            ...
            $this->db->select_sum('deviceSecurity_ps'); // Added new field for device security
            $this->db->select_sum('deviceSecurity_ms'); // Added new field for device security
            $this->db->select_sum('deviceSecurity_cs'); // Added new field for device security
            $this->db->select_sum('deviceSecurity_mont'); // Added new field for device security
            $this->db->select_sum('cyberSecurity_ps'); // Added new field for data management analysis
            $this->db->select_sum('cyberSecurity_ms'); // Added new field for data management analysis
            $this->db->select_sum('cyberSecurity_cs'); // Added new field for data management analysis
            $this->db->select_sum('cyberSecurity_mont'); // Added new field for data management analysis
            $this->db->select_sum('uiuxDesign_ps'); // Added new field for data management analysis
            $this->db->select_sum('uiuxDesign_ms'); // Added new field for data management analysis
            $this->db->select_sum('uiuxDesign_cs'); // Added new field for data management analysis
            $this->db->select_sum('uiuxDesign_mont'); // Added new field for data management analysis
            $this->db->select_sum('animation_ps'); // Added new field for data management analysis
            $this->db->select_sum('animation_ms'); // Added new field for data management analysis
            $this->db->select_sum('animation_cs'); // Added new field for data management analysis
            $this->db->select_sum('animation_mont'); // Added new field for data management analysis
            $this->db->select_sum('artifacialIntelligence_ps'); // Added new field for data management analysis
            $this->db->select_sum('artifacialIntelligence_ms'); // Added new field for data management analysis
            $this->db->select_sum('artifacialIntelligence_cs'); // Added new field for data management analysis
            $this->db->select_sum('artifacialIntelligence_mont'); // Added new field for data management analysis
            $this->db->select_sum('digitalMarketing_ps'); // Added new field for data management analysis
            $this->db->select_sum('digitalMarketing_ms'); // Added new field for data management analysis
            $this->db->select_sum('digitalMarketing_cs'); // Added new field for data management analysis
            $this->db->select_sum('digitalMarketing_mont'); // Added new field for data management analysis
            $this->db->select_sum('dataManagementAnalysis_ps'); // Added new field for data management analysis
            $this->db->select_sum('dataManagementAnalysis_ms'); // Added new field for data management analysis
            $this->db->select_sum('dataManagementAnalysis_cs'); // Added new field for data management analysis
            $this->db->select_sum('dataManagementAnalysis_mont'); // Added new field for data management analysis
            $this->db->select_sum('gameDevelopment_ps'); // Added new field for data management analysis
            $this->db->select_sum('gameDevelopment_ms'); // Added new field for data management analysis
            $this->db->select_sum('gameDevelopment_cs'); // Added new field for data management analysis
            $this->db->select_sum('gameDevelopment_mont'); // Added new field for data management analysis
    ...
    {
        $entrytimeinfo = $this->site->getOneRecord('entry_settings', '*', ['year' => date('Y')], 'id desc', 1, 0);
        ...
        if ($type == 'half_yearly') {
            return ['type' => 'half_yearly', 'start' => $entrytimeinfo->startdate_half, 'end' => $entrytimeinfo->enddate_half, 'year' => $entrytimeinfo->year];
        } else {
            return ['type' => 'annual', 'start' => $entrytimeinfo->startdate_annual, 'end' => $entrytimeinfo->enddate_annual, 'year' => $entrytimeinfo->year];
        }
    }
    ...
    function detailupdate()
    {
        ...
        if ($is_changeable) {
            if ($this->input->get_post('pk') && $this->input->get_post('pk') > 0) {
                $this->site->updateData($this->input->get_post('table'), [$this->input->get_post('name') => $this->input->get_post('value')], ['id' => $this->input->get_post('pk')]);
                $flag = 2; //update
            } elseif ($this->input->get_post('branch_id')) {
                $this->site->insertData($this->input->get_post('table'), [
        ...
        echo json_encode(['flag' => $flag, 'msg' => $msg]);
        exit();
    }
}
