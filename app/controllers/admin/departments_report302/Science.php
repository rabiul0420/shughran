...
class Science extends MY_Controller
{
    ...
    function science_page_one($branch_id = NULL)
    {
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_science_only_science_manpower'] = $this->db->get('science_only_science_manpower')->first_row('array');
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_science_biggan_shompadok'] = $this->db->get('science_biggan_shompadok')->first_row('array');
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_science_manpower_protibedon'] = $this->db->get('science_manpower_protibedon')->first_row('array');
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_science_high_study_protibedon'] = $this->db->get('science_high_study_protibedon')->first_row('array');
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_science_biggan_magazine_circulation'] = $this->db->get('science_biggan_magazine_circulation')->first_row('array');
        ...
        $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
            ...
            $this->data['total_science_training_program'] = $this->db->get('science_training_program')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_science_biggan_school_magazine_circulation'] = $this->db->get('science_biggan_school_magazine_circulation');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_science_pathok_forum_report'] = $this->db->get('science_pathok_forum_report')->first_row('array'); 
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_science_club_protibedon'] = $this->db->get('science_club_protibedon')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_science_program_protibedon'] = $this->db->get('science_program_protibedon')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_science_aca_help_protibedon'] = $this->db->get('science_aca_help_protibedon')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_science_sofor_protibedon'] = $this->db->get('science_sofor_protibedon')->first_row('array');
}
else{
    $this->db->select('*');
    $this->db->where('branch_id', $branch_id);
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_science_bitoron'] = $this->db->get('science_bitoron')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_science_output_contact'] = $this->db->get('science_output_contact')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_science_output_report'] = $this->db->get('science_output_report')->first_row('array');
    ...
    $this->db->where('date between "' . $report_type['start'] . '" and "' . $report_type['end'] . '"');
        ...
        $this->data['total_science_summit'] = $this->db->get('science_summit')->first_row('array');
    }
