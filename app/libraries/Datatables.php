    ...
    private function get_total_results($filtering = FALSE)
    {
        ...
        foreach ($this->like as $val)
            ...
            if (strlen($this->distinct) > 0) {
                ...
                if(in_array($this->table , array('thana_ideal_log','thana','institution_organization','institutionlist','confirmreport','users','manpower_transfer_assoworker','manpower_transfer','administration_without_org','associate',  'postpone' ,'associatelog','memberlog','membercandidatelog','institution_without_org')))
